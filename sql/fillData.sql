...
INSERT INTO Person (person_id, discriminator, anrede, nachname, vorname, geburtsdatum, festnetz, natel, email, adresse_id) VALUES 
    ...
    (28, 'Angehoeriger', 'HERR', 'Glatt', 'Raoul', NULL, '044 382 25 33', '079 269 62 69', 'familie_glatt@bluewin.ch', 27),
...
INSERT INTO Maercheneinteilung (
    ...
    (8, 3, 'B', 'Schulkind 6', '2, 3', 'Waldtier Hase 2', '4', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 'Elternmithilfe bei Lilly Juchli erfasst');
