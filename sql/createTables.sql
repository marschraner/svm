...
CREATE TABLE IF NOT EXISTS Semesterrechnung (
    ...
    ermaessigung_vorrechnung         DECIMAL(8,2),
    ermaessigungsgrund_vorrechnung   VARCHAR(50),
    zuschlag_vorrechnung             DECIMAL(8,2),
    zuschlagsgrund_vorrechnung       VARCHAR(50),
    anzahl_wochen_vorrechnung        INT,
    wochenbetrag_vorrechnung         DECIMAL(7,2),
    rechnungsdatum_nachrechnung      DATE,
    ermaessigung_nachrechnung        DECIMAL(8,2),
    ermaessigungsgrund_nachrechnung  VARCHAR(50),
    zuschlag_nachrechnung            DECIMAL(8,2),
    zuschlagsgrund_nachrechnung      VARCHAR(50),
    anzahl_wochen_nachrechnung       INT,
    wochenbetrag_nachrechnung        DECIMAL(7,2),
