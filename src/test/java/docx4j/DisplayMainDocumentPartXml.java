...
/**
 * Simple example showing how to see the document's XML (MainDocumentPart).
 *
 * <p>If you want to see all the parts as a Flat OPC XML document, see the ExportInPackageFormat
 * sample.
 *
 * @author jharrop
 */
public class DisplayMainDocumentPartXml extends AbstractSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      inputfilepath = "/home/hans/Projects/svm/target/Test.docx";
    }
