...
public class DeleteSemesterrechnungCodeCommandTest {
  ...
  public void testExecute() {
    ...
    DeleteSemesterrechnungCodeCommand deleteSemesterrechnungCodeCommand =
        new DeleteSemesterrechnungCodeCommand(codesSaved, 1);
    commandInvoker.executeCommandAsTransaction(deleteSemesterrechnungCodeCommand);
    assertEquals(
        DeleteSemesterrechnungCodeCommand.Result.LOESCHEN_ERFOLGREICH,
        deleteSemesterrechnungCodeCommand.getResult());
