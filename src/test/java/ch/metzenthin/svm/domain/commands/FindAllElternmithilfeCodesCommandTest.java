...
public class FindAllElternmithilfeCodesCommandTest {
  ...
  public void testExecute() {
    ...
    List<ElternmithilfeCode> codesFound =
  ...
  private void createTestdata() {
    ...
    ElternmithilfeCode elternmithilfeCodeSaved =
        elternmithilfeCodeDao.save(new ElternmithilfeCode("k", "KuchenTest", true));
    codesTestdata.add(elternmithilfeCodeSaved);

    elternmithilfeCodeSaved =
        elternmithilfeCodeDao.save(new ElternmithilfeCode("f", "FrisierenTest", true));
    codesTestdata.add(elternmithilfeCodeSaved);
  ...
  private void deleteTestdata() {
    ...
    for (ElternmithilfeCode elternmithilfeCode : codesTestdata) {
      ElternmithilfeCode elternmithilfeCodeToBeRemoved =
