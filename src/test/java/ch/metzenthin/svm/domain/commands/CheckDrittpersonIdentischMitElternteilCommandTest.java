...
public class CheckDrittpersonIdentischMitElternteilCommandTest {
  ...
  public void testExecute_NICHT_IDENTISCH() {
    ...
    CheckDrittpersonIdentischMitElternteilCommand checkDrittpersonIdentischMitElternteilCommand =
        new CheckDrittpersonIdentischMitElternteilCommand(mutter1, vater1, rechnungsempfaenger);
  ...
  public void testExecute_IDENTISCH_MIT_MUTTER() {
    ...
    assertEquals(
        CheckDrittpersonIdentischMitElternteilCommand.ERROR_IDENTISCH_MIT_MUTTER, errorMessage);
  }
  ...
  public void testExecute_SCHEINT_IDENTISCH_MIT_MUTTER_ZU_SEIN() {
    ...
    rechnungsempfaenger.setAdresse(adresseRechnungsempfaenger);
    CheckDrittpersonIdentischMitElternteilCommand checkDrittpersonIdentischMitElternteilCommand =
        new CheckDrittpersonIdentischMitElternteilCommand(mutter2, vater2, rechnungsempfaenger);
    commandInvoker.executeCommand(checkDrittpersonIdentischMitElternteilCommand);
    assertTrue(checkDrittpersonIdentischMitElternteilCommand.isIdentical());
    String errorMessage = checkDrittpersonIdentischMitElternteilCommand.getErrorMessage();
    assertTrue(
        errorMessage.contains(
            CheckDrittpersonIdentischMitElternteilCommand
                .ERROR_WAHRSCHEINLICH_IDENTISCH_MIT_MUTTER));
  }
  ...
  public void testExecute_IDENTISCH_MIT_VATER() {
    ...
    String errorMessage = checkDrittpersonIdentischMitElternteilCommand.getErrorMessage();
    assertEquals(
        CheckDrittpersonIdentischMitElternteilCommand.ERROR_IDENTISCH_MIT_VATER, errorMessage);
  }
  ...
  public void testExecute_SCHEINT_IDENTISCH_MIT_VATER_ZU_SEIN() {
    ...
    assertTrue(
        errorMessage.contains(
            CheckDrittpersonIdentischMitElternteilCommand
                .ERROR_WAHRSCHEINLICH_IDENTISCH_MIT_VATER));
  }
}
