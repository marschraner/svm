 ...
 */
class CheckIfAngehoerigerVerwaistAndDeleteCommandTest {
  ...
  @Test
  void testExecute_VerwaisteAngehoerige() {
    ...
    Angehoeriger rechnungsempfaenger =
        new Angehoeriger(Anrede.FRAU, "Katharina", "Schraner", null, null, null, false);
    ...
    CheckIfAngehoerigerVerwaistAndDeleteCommand checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(angehoerigereSaved.get(0));
    ...
    checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(angehoerigereSaved.get(1));
    commandInvoker.executeCommandAsTransaction(checkIfAngehoerigerVerwaistAndDeleteCommand);
    assertTrue(checkIfAngehoerigerVerwaistAndDeleteCommand.isDeleted());
    checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(angehoerigereSaved.get(2));
    commandInvoker.executeCommandAsTransaction(checkIfAngehoerigerVerwaistAndDeleteCommand);
    assertTrue(checkIfAngehoerigerVerwaistAndDeleteCommand.isDeleted());
    ...
    checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(schuelerSaved.getVater());
    commandInvoker.executeCommandAsTransaction(checkIfAngehoerigerVerwaistAndDeleteCommand);
    assertFalse(checkIfAngehoerigerVerwaistAndDeleteCommand.isDeleted());
    checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(schuelerSaved.getMutter());
    commandInvoker.executeCommandAsTransaction(checkIfAngehoerigerVerwaistAndDeleteCommand);
    assertFalse(checkIfAngehoerigerVerwaistAndDeleteCommand.isDeleted());
    checkIfAngehoerigerVerwaistAndDeleteCommand =
        new CheckIfAngehoerigerVerwaistAndDeleteCommand(schuelerSaved.getRechnungsempfaenger());
    commandInvoker.executeCommandAsTransaction(checkIfAngehoerigerVerwaistAndDeleteCommand);
    assertFalse(checkIfAngehoerigerVerwaistAndDeleteCommand.isDeleted());
    ...
    assertEquals(
        DeleteSchuelerCommand.Result.LOESCHEN_ERFOLGREICH, deleteSchuelerCommand.getResult());
