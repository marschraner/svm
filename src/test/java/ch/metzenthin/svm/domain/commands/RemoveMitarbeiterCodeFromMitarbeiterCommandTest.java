 ...
 */
class RemoveMitarbeiterCodeFromMitarbeiterCommandTest {
  ...
  void testExecute() {
    ...
    addMitarbeiterCodeToMitarbeiterAndSaveCommand =
        new AddMitarbeiterCodeToMitarbeiterAndSaveCommand(mitarbeiterCode2, mitarbeiter);
    commandInvoker.executeCommandAsTransaction(addMitarbeiterCodeToMitarbeiterAndSaveCommand);
    ...
    RemoveMitarbeiterCodeFromMitarbeiterCommand removeMitarbeiterCodeFromMitarbeiterCommand =
        new RemoveMitarbeiterCodeFromMitarbeiterCommand(
            mitarbeiterUpdated.getSortedMitarbeiterCodes().get(1), mitarbeiterUpdated);
    ...
    removeMitarbeiterCodeFromMitarbeiterCommand =
        new RemoveMitarbeiterCodeFromMitarbeiterCommand(
            mitarbeiterUpdated.getSortedMitarbeiterCodes().get(0), mitarbeiterUpdated);
    commandInvoker.executeCommandAsTransaction(removeMitarbeiterCodeFromMitarbeiterCommand);
