...
public class CheckGeschwisterSchuelerRechnungsempfaengerCommandTest {
  ...
  public void testExecute() {
    ...
    Angehoeriger angehoeriger2 =
        new Angehoeriger(Anrede.HERR, "Kurt", "Juchli", null, null, null, true);
    Angehoeriger angehoeriger3 =
        new Angehoeriger(Anrede.FRAU, "Käthi", "Schraner", null, null, null, true);
    Angehoeriger angehoeriger4 =
        new Angehoeriger(Anrede.FRAU, "Regula", "Rösle", null, null, null, false);
    Angehoeriger angehoeriger5 =
        new Angehoeriger(Anrede.HERR, "Eugen", "Rösle", null, null, null, false);
    ...
    Schueler schueler1 =
        new Schueler(
            "Lilly",
            "Juchli",
            new GregorianCalendar(2008, Calendar.JANUARY, 13),
            null,
            null,
            null,
            Geschlecht.W,
    ...
    CheckGeschwisterSchuelerRechnungempfaengerCommand
        checkGeschwisterSchuelerRechnungempfaengerCommand =
            new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler1, true);
    ...
    List<Schueler> angemeldeteGeschwisterList =
        checkGeschwisterSchuelerRechnungempfaengerCommand.getAngemeldeteGeschwisterList();
    ...
    printGeschwisterUndSchuelerRechnungsempfaenger(
        schueler1,
    ...
    checkGeschwisterSchuelerRechnungempfaengerCommand =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler2);
    commandInvoker.executeCommand(checkGeschwisterSchuelerRechnungempfaengerCommand);
    ...
    checkGeschwisterSchuelerRechnungempfaengerCommand =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler3, true);
    commandInvoker.executeCommand(checkGeschwisterSchuelerRechnungempfaengerCommand);
    geschwisterList = checkGeschwisterSchuelerRechnungempfaengerCommand.getGeschwisterList();
    angemeldeteGeschwisterList =
        checkGeschwisterSchuelerRechnungempfaengerCommand.getAngemeldeteGeschwisterList();
    ...
    assertEquals(
        schueler1, andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList.get(0));
    printGeschwisterUndSchuelerRechnungsempfaenger(
        schueler3,
        angemeldeteGeschwisterList,
        andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList);
    ...
    Schueler schueler4 =
        new Schueler(
            "Valentin Dan",
            "Rösle",
            new GregorianCalendar(2014, Calendar.SEPTEMBER, 15),
            null,
            null,
            null,
            Geschlecht.W,
    ...
    checkGeschwisterSchuelerRechnungempfaengerCommand =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler4);
    commandInvoker.executeCommand(checkGeschwisterSchuelerRechnungempfaengerCommand);
    geschwisterList = checkGeschwisterSchuelerRechnungempfaengerCommand.getGeschwisterList();
    angemeldeteGeschwisterList =
        checkGeschwisterSchuelerRechnungempfaengerCommand.getAngemeldeteGeschwisterList();
    ...
    // Weiteres Geschwister von Schueler 1 und 2 mit Mutter von Schüler 3 und 4 als
    // Rechnungsempfänger erfassen
    Schueler schueler5 =
        new Schueler(
            "Felicitas",
            "Juchli",
            new GregorianCalendar(2012, Calendar.MAY, 5),
            null,
            null,
            null,
            Geschlecht.W,
    ...
    checkGeschwisterSchuelerRechnungempfaengerCommand =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler5, true);
    commandInvoker.executeCommand(checkGeschwisterSchuelerRechnungempfaengerCommand);
    geschwisterList = checkGeschwisterSchuelerRechnungempfaengerCommand.getGeschwisterList();
    angemeldeteGeschwisterList =
        checkGeschwisterSchuelerRechnungempfaengerCommand.getAngemeldeteGeschwisterList();
    ...
    assertEquals(1, andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList.size());
    assertEquals(
        schueler4, andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList.get(0));
    printGeschwisterUndSchuelerRechnungsempfaenger(
        schueler5,
        angemeldeteGeschwisterList,
        andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList);
    ...
    schueler2
        .getAnmeldungen()
        .get(0)
        .setAbmeldedatum(new GregorianCalendar(2015, Calendar.JUNE, 1));
    schueler4
        .getAnmeldungen()
        .get(0)
        .setAbmeldedatum(new GregorianCalendar(2015, Calendar.JUNE, 1));
    ...
    checkGeschwisterSchuelerRechnungempfaengerCommand =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler5);
    commandInvoker.executeCommand(checkGeschwisterSchuelerRechnungempfaengerCommand);
    geschwisterList = checkGeschwisterSchuelerRechnungempfaengerCommand.getGeschwisterList();
    angemeldeteGeschwisterList =
        checkGeschwisterSchuelerRechnungempfaengerCommand.getAngemeldeteGeschwisterList();
  ...
  private void printGeschwisterUndSchuelerRechnungsempfaenger(
      Schueler schueler,
      List<Schueler> geschwister,
      List<Schueler> andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaenger) {
    ...
    if (!geschwister.isEmpty()) {
      ...
      System.out.println(
          schueler.getVorname()
              + " "
              + schueler.getNachname()
              + " hat keine angemeldeten Geschwister.");
    }

    if (!andereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaenger.isEmpty()) {
      System.out.println(
          "Andere Schüler, welche den Vater, die Mutter oder den Rechnungsempfänger von "
              + schueler.getVorname()
              + " "
              + schueler.getNachname()
              + " als Rechnungsempfänger haben:");
