...
public class CheckIdentischeAdressenCommandTest {
  ...
  public void setUp() {
    ...
    mutter2 = new Angehoeriger(Anrede.FRAU, "Susanne", "Müller", "044 724 11 20", null, null, true);
    Adresse adresseMutter2 = new Adresse("Weidstrasse", "55", "8803", "Rüschlikon");
    mutter2.setAdresse(adresseMutter2);
    mutter3 = new Angehoeriger(Anrede.FRAU, "Susanne", "Müller", "044 720 12 17", null, null, true);
    Adresse adresseMutter3 = new Adresse("Tödistrasse", "4", "8800", "Thalwil");
    mutter3.setAdresse(adresseMutter3);
    mutter4 = new Angehoeriger(Anrede.FRAU, "Susanne", "Müller", null, null, null, true);
    ...
    vater2 =
        new Angehoeriger(Anrede.HERR, "Andreas", "Bruggisser", "044 724 11 20", null, null, false);
    Adresse adresseVater2 = new Adresse("Weidstrasse", "55", "8803", "Rüschlikon");
    vater2.setAdresse(adresseVater2);
    vater3 =
        new Angehoeriger(Anrede.HERR, "Andreas", "Bruggisser", "044 720 12 19", null, null, false);
    Adresse adresseVater3 = new Adresse("Tödistrasse", "6", "8800", "Thalwil");
    vater3.setAdresse(adresseVater3);
    vater4 = new Angehoeriger(Anrede.HERR, "Andreas", "Bruggisser", null, null, null, false);

    rechnungsempfaengerDrittperson1 =
        new Angehoeriger(Anrede.FRAU, "Hanny", "Bruggisser", "056 426 69 15", null, null, true);
    Adresse adresseRechnungsempfaengerDrittperson1 =
        new Adresse("Wiesenstrasse", "5", "5430", "Wettingen");
    rechnungsempfaengerDrittperson1.setAdresse(adresseRechnungsempfaengerDrittperson1);
    rechnungsempfaengerDrittperson2 =
        new Angehoeriger(Anrede.FRAU, "Hanny", "Bruggisser", "044 724 11 20", null, null, true);
    Adresse adresseRechnungsempfaengerDrittperson2 =
        new Adresse("Weidstrasse", "55", "8803", "Rüschlikon");
    rechnungsempfaengerDrittperson2.setAdresse(adresseRechnungsempfaengerDrittperson2);
    rechnungsempfaengerDrittperson3 =
        new Angehoeriger(Anrede.FRAU, "Hanny", "Bruggisser", "044 720 12 21", null, null, true);
    Adresse adresseRechnungsempfaengerDrittperson3 =
        new Adresse("Tödistrasse", "8", "8800", "Thalwil");
  ...
  public void testExecute_SCHUELER_MUTTER_VATER_DRITTPERSON_IDENTISCH() {
    ...
    CheckIdentischeAdressenCommand checkIdentischeAdressenCommand =
        new CheckIdentischeAdressenCommand(schueler, true);
    commandInvoker.executeCommand(checkIdentischeAdressenCommand);
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Schülerin, Mutter, Vater und Rechnungsempfänger Drittperson"));
  ...
  public void testExecute_SCHUELER_MUTTER_VATER_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Schülerin, Mutter und Vater"));
    assertTrue(
        checkIdentischeAdressenCommand.getAbweichendeAdressen().contains("Rechnungsempfänger"));
  ...
  public void testExecute_SCHUELER_MUTTER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Schülerin, Mutter und Rechnungsempfänger"));
  ...
  public void testExecute_SCHUELER_VATER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Schülerin, Vater und Rechnungsempfänger"));
  ...
  public void testExecute_MUTTER_VATER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Mutter, Vater und Rechnungsempfänger"));
  ...
  public void testExecute_SCHUELER_MUTTER_IDENTISCH_VATER_DRITTPERSON_IDENTISCH() {
    ...
    commandInvoker.executeCommand(checkIdentischeAdressenCommand);
    assertTrue(
        checkIdentischeAdressenCommand.getIdentischeAdressen().contains("Schülerin und Mutter"));
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Vater und Rechnungsempfänger"));
    assertTrue(checkIdentischeAdressenCommand.getAbweichendeAdressen().isEmpty());
  }
  ...
  public void testExecute_SCHUELER_VATER_IDENTISCH_MUTTER_DRITTPERSON_IDENTISCH() {
    ...
    commandInvoker.executeCommand(checkIdentischeAdressenCommand);
    assertTrue(
        checkIdentischeAdressenCommand.getIdentischeAdressen().contains("Schülerin und Vater"));
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Mutter und Rechnungsempfänger"));
    assertTrue(checkIdentischeAdressenCommand.getAbweichendeAdressen().isEmpty());
  }
  ...
  public void testExecute_SCHUELER_DRITTPERSON_IDENTISCH_MUTTER_VATER_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getIdentischeAdressen()
            .contains("Schülerin und Rechnungsempfänger"));
  ...
  public void testExecute_SCHUELER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            ...
            .contains("Schülerin und Rechnungsempfänger"));
    assertTrue(
        checkIdentischeAdressenCommand.getAbweichendeAdressen().contains("Mutter und Vater"));
  ...
  public void testExecute_MUTTER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            ...
            .contains("Mutter und Rechnungsempfänger"));
    assertTrue(
        checkIdentischeAdressenCommand.getAbweichendeAdressen().contains("Schülerin und Vater"));
  ...
  public void testExecute_VATER_DRITTPERSON_IDENTISCH() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            ...
            .contains("Vater und Rechnungsempfänger"));
    assertTrue(
        checkIdentischeAdressenCommand.getAbweichendeAdressen().contains("Schülerin und Mutter"));
  ...
  public void testExecute_SCHUELER_MUTTER_VATER_DRITTPERSON_VERSCHIEDEN() {
    ...
    assertTrue(
        checkIdentischeAdressenCommand
            .getAbweichendeAdressen()
            .contains("Schülerin, Mutter, Vater und Rechnungsempfänger"));
  }
  ...
  public void testExecute_SCHUELER_MUTTER_VATER_VERSCHIEDEN() {
    ...
    CheckIdentischeAdressenCommand checkIdentischeAdressenCommand =
        new CheckIdentischeAdressenCommand(schueler);
    commandInvoker.executeCommand(checkIdentischeAdressenCommand);
    assertTrue(checkIdentischeAdressenCommand.getIdentischeAdressen().isEmpty());
    assertTrue(
        checkIdentischeAdressenCommand
