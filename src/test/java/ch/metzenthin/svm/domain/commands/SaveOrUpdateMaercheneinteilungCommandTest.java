...
public class SaveOrUpdateMaercheneinteilungCommandTest {
  ...
  public void testExecute() {
    ...
    Maercheneinteilung maercheneinteilung2Modif =
        new Maercheneinteilung(
            schueler2,
            maerchen2,
            Gruppe.A,
  ...
  private boolean checkIfMaercheneinteilungAvailable(
    ...
    for (Maercheneinteilung maercheneinteilung : maercheneinteilungenSchueler) {
      if (maercheneinteilung.getMaerchen().equals(maerchen)
          ...
          && ((maercheneinteilung.getElternmithilfeDrittperson() == null
                  && elternmithilfeDrittperson == null)
              || (maercheneinteilung.getElternmithilfeDrittperson() != null
                  && elternmithilfeDrittperson != null
                  && maercheneinteilung
                      .getElternmithilfeDrittperson()
                      .isIdenticalWith(elternmithilfeDrittperson)))) {
        return true;
      }
    }
    return false;
