...
public class CalculateAnzWochenCommandTest {
    ...
    public void testCalculateAnzWochenKursanmeldung_MittwochKurs() {
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 18), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(22, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 22), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Anmeldung Sonntag erste Woche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 23), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Anmeldung Montag zweite Woche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 24), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 26), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // letzter Schultag vor Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 3), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 4), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(15, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // während Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 10), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(15, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag letzte Herbstferienwoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 18), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(15, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Erster Schultag nach Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 19), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(15, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // erster Kurstag nach Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.OCTOBER, 21), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(15, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.DECEMBER, 19), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag vor Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.DECEMBER, 20), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // während Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.DECEMBER, 29), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag letzte Weihnachtsferienwoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2016, Calendar.JANUARY, 3), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Erster Schultag nach Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2016, Calendar.JANUARY, 4), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // erster Kurstag nach Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2016, Calendar.JANUARY, 6), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(6, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(22, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Abmeldung einen Tag nach letztem Kurstag
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 11), null);
        assertEquals(22, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 8), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Abmeldung am Sonntag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 7), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Abmeldung am Samstag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 6), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Abmeldung am Freitag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 5), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Abmeldung am Kurstag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 3), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        // erster Kurstag nach Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.JANUARY, 6), null);
        assertEquals(17, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Erster Schultag nach Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.JANUARY, 4), null);
        assertEquals(16, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag letzte Weihnachtsferienwoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.JANUARY, 3), null);
        assertEquals(16, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // während Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.DECEMBER, 29), null);
        assertEquals(16, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag vor Weihnachtsferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.DECEMBER, 20), null);
        assertEquals(16, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.DECEMBER, 16), null);
        assertEquals(16, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // erster Kurstag nach Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 21), null);
        assertEquals(8, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Erster Schultag nach Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 19), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag letzte Herbstferienwoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 18), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // während Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 8), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // Sonntag vor Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 4), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // letzter Schultag vor Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.OCTOBER, 3), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));

        // letzter Kurstag vor Herbstferien
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2015, Calendar.SEPTEMBER, 30), null);
        assertEquals(7, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
    ...
    public void testCalculateAnzWochenKursanmeldung_MontagKurs() {
        ...
        // Abmeldung am Kurstag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 1), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
    }
    ...
    public void testCalculateAnzWochenKursanmeldung_SamstagKurs() {
        ...
        // Anmeldung einen Tag vor erstem Kurstag
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 21), new GregorianCalendar(2016, Calendar.FEBRUARY, 13), null);
        assertEquals(22, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        // Abmeldung einen Tag vor letztem Kurstag
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 12), null);
        assertEquals(21, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
        ...
        // Abmeldung am Freitag vorletzte Kurswoche
        kursanmeldung = new Kursanmeldung(null, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 17), new GregorianCalendar(2016, Calendar.FEBRUARY, 5), null);
        assertEquals(20, calculateAnzWochenCommandErstesSemester.calculateAnzWochenKursanmeldung(kursanmeldung));
    }
