 ...
 */
public class AddKursToSchuelerAndSaveCommandTest {
    ...
    public void testExecute() throws Exception {
        ...
        addKursToSchuelerAndSaveCommand = new AddKursToSchuelerAndSaveCommand(semester2, Wochentag.FREITAG, Time.valueOf("10:00:00"), lehrkraft2, schuelerSaved);
        commandInvoker.executeCommandAsTransaction(addKursToSchuelerAndSaveCommand);
        assertEquals(AddKursToSchuelerAndSaveCommand.Result.KURS_BEREITS_ERFASST, addKursToSchuelerAndSaveCommand.getResult());

        // Versuchen, einen nicht existierenden Kurs hinzuzufügen
        addKursToSchuelerAndSaveCommand = new AddKursToSchuelerAndSaveCommand(semester2, Wochentag.FREITAG, Time.valueOf("23:00:00"), lehrkraft2, schuelerSaved);
        commandInvoker.executeCommandAsTransaction(addKursToSchuelerAndSaveCommand);
        assertEquals(AddKursToSchuelerAndSaveCommand.Result.KURS_EXISTIERT_NICHT, addKursToSchuelerAndSaveCommand.getResult());
