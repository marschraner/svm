 ...
 */
class RemoveSchuelerCodeFromSchuelerCommandTest {
  ...
  void testExecute() {
    ...
    SaveOrUpdateSchuelerCodeCommand saveOrUpdateSchuelerCodeCommand =
        new SaveOrUpdateSchuelerCodeCommand(schuelerCode1, null, erfassteSchuelerCodes);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateSchuelerCodeCommand);
    saveOrUpdateSchuelerCodeCommand =
        new SaveOrUpdateSchuelerCodeCommand(schuelerCode2, null, erfassteSchuelerCodes);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateSchuelerCodeCommand);
    ...
    AddSchuelerCodeToSchuelerAndSaveCommand addSchuelerCodeToSchuelerAndSaveCommand =
        new AddSchuelerCodeToSchuelerAndSaveCommand(schuelerCode1, schuelerSaved);
    commandInvoker.executeCommandAsTransaction(addSchuelerCodeToSchuelerAndSaveCommand);
    addSchuelerCodeToSchuelerAndSaveCommand =
        new AddSchuelerCodeToSchuelerAndSaveCommand(schuelerCode2, schuelerSaved);
    commandInvoker.executeCommandAsTransaction(addSchuelerCodeToSchuelerAndSaveCommand);
    ...
    RemoveSchuelerCodeFromSchuelerCommand removeSchuelerCodeFromSchuelerCommand =
        new RemoveSchuelerCodeFromSchuelerCommand(
            schuelerSaved.getSortedSchuelerCodes().get(1), schuelerSaved);
    ...
    removeSchuelerCodeFromSchuelerCommand =
        new RemoveSchuelerCodeFromSchuelerCommand(
            schuelerUpdated.getSortedSchuelerCodes().get(0), schuelerSaved);
    commandInvoker.executeCommandAsTransaction(removeSchuelerCodeFromSchuelerCommand);
