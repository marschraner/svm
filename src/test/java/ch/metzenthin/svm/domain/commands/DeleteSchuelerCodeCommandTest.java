...
public class DeleteSchuelerCodeCommandTest {
  ...
  public void testExecute() {
    ...
    SaveOrUpdateSchuelerCodeCommand saveOrUpdateSchuelerCodeCommand =
        new SaveOrUpdateSchuelerCodeCommand(schuelerCode1, null, codesSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateSchuelerCodeCommand);

    saveOrUpdateSchuelerCodeCommand =
        new SaveOrUpdateSchuelerCodeCommand(schuelerCode2, null, codesSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateSchuelerCodeCommand);
    ...
    DeleteSchuelerCodeCommand deleteSchuelerCodeCommand =
        new DeleteSchuelerCodeCommand(codesSaved, 1);
    commandInvoker.executeCommandAsTransaction(deleteSchuelerCodeCommand);
    assertEquals(
        DeleteSchuelerCodeCommand.Result.LOESCHEN_ERFOLGREICH,
        deleteSchuelerCodeCommand.getResult());
    ...
    commandInvoker.executeCommandAsTransaction(deleteSchuelerCodeCommand);
    assertEquals(
        DeleteSchuelerCodeCommand.Result.CODE_VON_SCHUELER_REFERENZIERT,
        deleteSchuelerCodeCommand.getResult());
    assertEquals(1, codesSaved.size());
    ...
    RemoveSchuelerCodeFromSchuelerCommand removeSchuelerCodeFromSchuelerCommand =
        new RemoveSchuelerCodeFromSchuelerCommand(codesSaved.get(0), savedSchueler);
