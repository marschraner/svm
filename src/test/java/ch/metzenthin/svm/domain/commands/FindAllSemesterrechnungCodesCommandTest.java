...
public class FindAllSemesterrechnungCodesCommandTest {
  ...
  public void testExecute() {
    ...
    List<SemesterrechnungCode> codesFound =
  ...
  private void createTestdata() {
    ...
    SemesterrechnungCode semesterrechnungCodeSaved =
        semesterrechnungCodeDao.save(new SemesterrechnungCode("2t", "Handrechnung Test", true));
    codesTestdata.add(semesterrechnungCodeSaved);

    semesterrechnungCodeSaved =
        semesterrechnungCodeDao.save(new SemesterrechnungCode("1t", "Stipendium Test", true));
    codesTestdata.add(semesterrechnungCodeSaved);
  ...
  private void deleteTestdata() {
    ...
    for (SemesterrechnungCode semesterrechnungCode : codesTestdata) {
      SemesterrechnungCode semesterrechnungCodeToBeRemoved =
