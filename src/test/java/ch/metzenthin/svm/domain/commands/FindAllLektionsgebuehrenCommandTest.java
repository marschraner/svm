...
public class FindAllLektionsgebuehrenCommandTest {
  ...
  public void testExecute_getList() {
    ...
    List<Lektionsgebuehren> lektionsgebuehrenListFound =
  ...
  public void testExecute_getMap() {
    ...
    Map<Integer, BigDecimal[]> lektionsgebuehrenMapFound =
  ...
  private void createTestdata() {
    ...
    Lektionsgebuehren lektionsgebuehrenSaved =
        lektionsgebuehrenDao.save(
