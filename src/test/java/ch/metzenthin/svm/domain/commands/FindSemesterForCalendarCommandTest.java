...
public class FindSemesterForCalendarCommandTest {
  ...
  public void testExecute_CalendarWaehrendErstemSemester() {
    ...
    assertEquals(
        new GregorianCalendar(2011, Calendar.AUGUST, 20),
        findSemesterForCalendarCommand.getCurrentSemester().getSemesterbeginn());
    assertEquals(
        new GregorianCalendar(2012, Calendar.FEBRUARY, 20),
        findSemesterForCalendarCommand.getNextSemester().getSemesterbeginn());
  }
  ...
  public void testExecute_CalendarWaehrendMittleremSemester() {
    ...
    assertEquals(
        new GregorianCalendar(2011, Calendar.AUGUST, 20),
        findSemesterForCalendarCommand.getPreviousSemester().getSemesterbeginn());
    assertEquals(
        new GregorianCalendar(2012, Calendar.FEBRUARY, 20),
        findSemesterForCalendarCommand.getCurrentSemester().getSemesterbeginn());
    assertEquals(
  ...
  public void testExecute_ErfassteSemesterNurEinSemester_WaehrendSemester() {
    ...
    FindSemesterForCalendarCommand findSemesterForCalendarCommand =
        new FindSemesterForCalendarCommand(
            new GregorianCalendar(2011, Calendar.AUGUST, 21), erfassteSemester1);
    commandInvoker.executeCommand(findSemesterForCalendarCommand);
    assertNull(findSemesterForCalendarCommand.getPreviousSemester());
    assertEquals(
        new GregorianCalendar(2011, Calendar.AUGUST, 20),
  ...
  public void testExecute_ErfassteSemesterNurEinSemester_VorSemester() {
    ...
    FindSemesterForCalendarCommand findSemesterForCalendarCommand =
        new FindSemesterForCalendarCommand(
            new GregorianCalendar(2011, Calendar.AUGUST, 19), erfassteSemester1);
    commandInvoker.executeCommand(findSemesterForCalendarCommand);
    assertNull(findSemesterForCalendarCommand.getPreviousSemester());
    assertNull(findSemesterForCalendarCommand.getCurrentSemester());
    assertEquals(
  ...
  public void testExecute_ErfassteSemesterNurEinSemester_NachSemester() {
    ...
    FindSemesterForCalendarCommand findSemesterForCalendarCommand =
        new FindSemesterForCalendarCommand(
            new GregorianCalendar(2012, Calendar.FEBRUARY, 11), erfassteSemester1);
    commandInvoker.executeCommand(findSemesterForCalendarCommand);
    assertEquals(
        new GregorianCalendar(2011, Calendar.AUGUST, 20),
        findSemesterForCalendarCommand.getPreviousSemester().getSemesterbeginn());
