...
public class FindSemesterForSchuljahrSemesterbezeichnungCommandTest {
  ...
  public void setUp() {
    ...
    erfassteSemesters.add(
        new Semester(
            ...
            new GregorianCalendar(2011, Calendar.APRIL, 25),
            new GregorianCalendar(2011, Calendar.MAY, 7),
            null,
            null));
  }
    ...
    FindSemesterForSchuljahrSemesterbezeichnungCommand
        findSemesterForSchuljahrSemesterbezeichnungCommand =
            new FindSemesterForSchuljahrSemesterbezeichnungCommand(
                "2011/2012", Semesterbezeichnung.ERSTES_SEMESTER, erfassteSemesters);
    commandInvoker.executeCommand(findSemesterForSchuljahrSemesterbezeichnungCommand);
    assertEquals(
        erfassteSemesters.get(0),
        findSemesterForSchuljahrSemesterbezeichnungCommand.getSemesterFound());
    findSemesterForSchuljahrSemesterbezeichnungCommand =
        new FindSemesterForSchuljahrSemesterbezeichnungCommand(
            "2011/2012", Semesterbezeichnung.ZWEITES_SEMESTER, erfassteSemesters);
    commandInvoker.executeCommand(findSemesterForSchuljahrSemesterbezeichnungCommand);
    assertEquals(
        erfassteSemesters.get(1),
        findSemesterForSchuljahrSemesterbezeichnungCommand.getSemesterFound());
  }
  ...
  public void testExecute_NoSemesterFound() {
    FindSemesterForSchuljahrSemesterbezeichnungCommand
        findSemesterForSchuljahrSemesterbezeichnungCommand =
            new FindSemesterForSchuljahrSemesterbezeichnungCommand(
                "2012/2013", Semesterbezeichnung.ERSTES_SEMESTER, erfassteSemesters);
    commandInvoker.executeCommand(findSemesterForSchuljahrSemesterbezeichnungCommand);
