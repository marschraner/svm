 ...
 */
class ImportKurseFromPreviousSemesterCommandTest {
  ...
  void testExecute() {
    ...
    saveOrUpdateSemesterCommand =
        new SaveOrUpdateSemesterCommand(semester3, null, erfassteSemester);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateSemesterCommand);
    ...
    SaveOrUpdateMitarbeiterCommand saveOrUpdateMitarbeiterCommand =
        new SaveOrUpdateMitarbeiterCommand(mitarbeiter1, adresse1, null, null, erfassteLehrkraefte);
    ...
    saveOrUpdateKursCommand =
        new SaveOrUpdateKursCommand(
            kurs2, semester1, kurstyp1, kursort1, mitarbeiter1, null, null, erfassteKurse);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateKursCommand);
    ...
    ImportKurseFromPreviousSemesterCommand importKurseFromPreviousSemesterCommand =
        new ImportKurseFromPreviousSemesterCommand(kurseSemester3, semester3);
    ...
    List<Mitarbeiter> lehrkraefte =
        kursDao.findLehrkraefteByKursId(kurseSemester3.get(0).getKursId());
    assertEquals("Roostest", lehrkraefte.get(0).getNachname());
    ...
    importKurseFromPreviousSemesterCommand =
        new ImportKurseFromPreviousSemesterCommand(kurseSemester2, semester2);
    commandInvoker.executeCommandAsTransaction(importKurseFromPreviousSemesterCommand);
    ...
    lehrkraefte = kursDao.findLehrkraefteByKursId(kurseSemester2.get(0).getKursId());
    assertEquals("Roostest", lehrkraefte.get(0).getNachname());
    ...
    importKurseFromPreviousSemesterCommand =
        new ImportKurseFromPreviousSemesterCommand(kurseSemester1, semester1);
    commandInvoker.executeCommandAsTransaction(importKurseFromPreviousSemesterCommand);
