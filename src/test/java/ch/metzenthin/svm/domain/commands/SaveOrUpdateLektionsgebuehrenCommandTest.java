...
public class SaveOrUpdateLektionsgebuehrenCommandTest {
  ...
  public void testExecute() {
    ...
    SaveOrUpdateLektionsgebuehrenCommand saveOrUpdateLektionsgebuehrenCommand =
        new SaveOrUpdateLektionsgebuehrenCommand(lektionsgebuehren1, null, lektionsgebuehrenSaved);
    ...
    saveOrUpdateLektionsgebuehrenCommand =
        new SaveOrUpdateLektionsgebuehrenCommand(lektionsgebuehren2, null, lektionsgebuehrenSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateLektionsgebuehrenCommand);
    ...
    Lektionsgebuehren lektionsgebuehren2Modif =
        new Lektionsgebuehren(
            57,
            new BigDecimal("23.00"),
            new BigDecimal("21.00"),
    ...
    saveOrUpdateLektionsgebuehrenCommand =
        new SaveOrUpdateLektionsgebuehrenCommand(
            lektionsgebuehren2Modif, lektionsgebuehren2, lektionsgebuehrenSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateLektionsgebuehrenCommand);
    assertEquals(2, lektionsgebuehrenSaved.size());
    assertTrue(checkIfLektionsgebuehrenAvailable(67, new BigDecimal("24.50")));
    assertFalse(checkIfLektionsgebuehrenAvailable(57, new BigDecimal("22.50")));
  ...
  private boolean checkIfLektionsgebuehrenAvailable(
      Integer lektionslaenge, BigDecimal betrag1Kind) {
