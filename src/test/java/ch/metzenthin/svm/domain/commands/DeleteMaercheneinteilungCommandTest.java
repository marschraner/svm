 ...
 */
class DeleteMaercheneinteilungCommandTest {
  ...
  void testExecute() {
    ...
    SaveOrUpdateMaerchenCommand saveOrUpdateMaerchenCommand =
        new SaveOrUpdateMaerchenCommand(maerchen1, null, erfassteMaerchen);
    ...
    saveOrUpdateMaerchenCommand =
        new SaveOrUpdateMaerchenCommand(maerchen2, null, erfassteMaerchen);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateMaerchenCommand);
    ...
    SaveOrUpdateElternmithilfeCodeCommand saveOrUpdateElternmithilfeCodeCommand =
        new SaveOrUpdateElternmithilfeCodeCommand(
            elternmithilfeCode1, null, erfassteElternmithilfeCodes);
    ...
    saveOrUpdateElternmithilfeCodeCommand =
        new SaveOrUpdateElternmithilfeCodeCommand(
            elternmithilfeCode2, null, erfassteElternmithilfeCodes);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateElternmithilfeCodeCommand);

    ElternmithilfeDrittperson elternmithilfeDrittperson =
        new ElternmithilfeDrittperson(
            Anrede.HERR, "Hans", "Schraner", "044 720 85 51", null, "hschraner@bluewin.ch");
    Adresse adresseElternmithilfeDrittperson =
        new Adresse("Hintere Bergstrasse", "15", "8942", "Oberrieden");
    elternmithilfeDrittperson.setAdresse(adresseElternmithilfeDrittperson);

    assertFalse(
        checkIfMaercheneinteilungAvailable(
            schueler1,
            maerchen1,
            Gruppe.A,
            Elternmithilfe.VATER,
            elternmithilfeCode1,
            "Komödiant 1",
            "1, 2"));
    assertFalse(
        checkIfMaercheneinteilungAvailable(
            ...
            maerchen2,
            Gruppe.B,
            Elternmithilfe.MUTTER,
            elternmithilfeCode2,
            "Komödiant 2",
            "1, 3"));

    // 2 Maercheneinteilungen erfassen
    Maercheneinteilung maercheneinteilung1 =
        new Maercheneinteilung(
            schueler1,
            maerchen1,
            Gruppe.A,
            "Komödiant 1",
    ...
    SaveOrUpdateMaercheneinteilungCommand saveOrUpdateMaercheneinteilungCommand =
        new SaveOrUpdateMaercheneinteilungCommand(
            ...
            adresseElternmithilfeDrittperson,
            null,
            erfassteMaercheneinteilungen);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateMaercheneinteilungCommand);
    Maercheneinteilung maercheneinteilung2 =
        new Maercheneinteilung(
            schueler2,
            maerchen2,
            Gruppe.B,
            ...
            null,
            null);
    saveOrUpdateMaercheneinteilungCommand =
        new SaveOrUpdateMaercheneinteilungCommand(
            maercheneinteilung2,
            elternmithilfeCode2,
            null,
    ...
    DeleteMaercheneinteilungCommand deleteMaercheneinteilungCommand =
        new DeleteMaercheneinteilungCommand(erfassteMaercheneinteilungen, 1);
    ...
    deleteMaercheneinteilungCommand =
        new DeleteMaercheneinteilungCommand(erfassteMaercheneinteilungen, 0);
    commandInvoker.executeCommandAsTransaction(deleteMaercheneinteilungCommand);
    ...
    for (Maercheneinteilung maercheneinteilung : erfassteMaercheneinteilungen) {
      Maercheneinteilung maercheneinteilungToBeDeleted =
          maercheneinteilungDao.findById(
              new MaercheneinteilungId(
                  maercheneinteilung.getSchueler().getPersonId(),
                  maercheneinteilung.getMaerchen().getMaerchenId()));
  ...
  private boolean checkIfMaercheneinteilungAvailable(
      Schueler schueler,
      Maerchen maerchen,
      Gruppe gruppe,
      ...
      String rolle1,
      String bilderRolle1) {
    FindMaercheneinteilungenSchuelerCommand findMaercheneinteilungenSchuelerCommand =
        new FindMaercheneinteilungenSchuelerCommand(schueler);
    ...
    List<Maercheneinteilung> maercheneinteilungenSchueler =
        findMaercheneinteilungenSchuelerCommand.getMaercheneinteilungenFound();
