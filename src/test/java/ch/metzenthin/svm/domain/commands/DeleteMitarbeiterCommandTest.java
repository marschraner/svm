 ...
 */
class DeleteMitarbeiterCommandTest {
  ...
  void testExecute() {
    ...
    SaveOrUpdateMitarbeiterCommand saveOrUpdateMitarbeiterCommand =
        new SaveOrUpdateMitarbeiterCommand(mitarbeiter1, adresse1, null, null, lehrkraefteSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateMitarbeiterCommand);

    saveOrUpdateMitarbeiterCommand =
        new SaveOrUpdateMitarbeiterCommand(mitarbeiter2, adresse2, null, null, lehrkraefteSaved);
    commandInvoker.executeCommandAsTransaction(saveOrUpdateMitarbeiterCommand);

    // Lehrkraefte löschen
    DeleteMitarbeiterCommand deleteMitarbeiterCommand =
        new DeleteMitarbeiterCommand(lehrkraefteSaved, 1);
    commandInvoker.executeCommandAsTransaction(deleteMitarbeiterCommand);
    assertEquals(
        DeleteMitarbeiterCommand.Result.LOESCHEN_ERFOLGREICH, deleteMitarbeiterCommand.getResult());
