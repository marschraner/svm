...
public class SchuelerSuchenTableDataTest {
  ...
  public void setUp() {
    ...
    Schueler schueler1 =
        new Schueler(
            "V1",
            "N1",
            new GregorianCalendar(2001, Calendar.APRIL, 11),
            "Festnetz1",
            "Natel1",
            "Email1",
            Geschlecht.W,
    ...
    Angehoeriger angehoeriger1 =
        new Angehoeriger(Anrede.FRAU, "V1A", "N1A", "Festnetz1A", "Natel1A", "Email1A", true);
    ...
    Schueler schueler2 =
        new Schueler(
            "V2",
            "N2",
            new GregorianCalendar(2002, Calendar.APRIL, 12),
            "Festnetz2",
            "Natel2",
            "Email2",
            Geschlecht.M,
    ...
    Angehoeriger angehoeriger2 =
        new Angehoeriger(Anrede.HERR, "V2A", "N2A", "Festnetz2A", "Natel2A", "Email2A", false);
    ...
    Angehoeriger angehoeriger3 =
        new Angehoeriger(Anrede.FRAU, "V3A", "N3A", "Festnetz3A", "Natel3A", "Email3A", true);
    ...
    schuelerSuchenTableData =
        new SchuelerSuchenTableData(
            schuelerList,
            new HashMap<>(),
            semester,
            null,
  ...
  public void testGetValueAt() {
    ...
    assertEquals(
        "N2", schuelerSuchenTableData.getValueAt(1, getColumnIndex(Field.NACHNAME.toString())));
    assertEquals(
        new GregorianCalendar(2002, Calendar.APRIL, 12),
        schuelerSuchenTableData.getValueAt(1, getColumnIndex(Field.GEBURTSDATUM_SHORT.toString())));
    assertEquals(
        "Str.2 99",
        schuelerSuchenTableData.getValueAt(1, getColumnIndex(Field.STRASSE_HAUSNUMMER.toString())));
    assertEquals(
        "8000", schuelerSuchenTableData.getValueAt(1, getColumnIndex(Field.PLZ.toString())));
    assertEquals(
        "Ort2", schuelerSuchenTableData.getValueAt(1, getColumnIndex(Field.ORT.toString())));
  }
  ...
  public void testGetValueAt_Mutter() {
    ...
    assertEquals(
        ...
        schuelerSuchenTableData.getValueAt(
            0, getColumnIndex(Field.RECHNUNGSEMPFAENGER.toString())));
  }
  ...
  public void testGetValueAt_Vater() {
    ...
    assertEquals(
        "Vater",
        schuelerSuchenTableData.getValueAt(
            1, getColumnIndex(Field.RECHNUNGSEMPFAENGER.toString())));
  }
  ...
  public void testGetValueAt_Rechnungsempfaenger() {
    assertEquals(
        "N3A V3A",
        schuelerSuchenTableData.getValueAt(
            2, getColumnIndex(Field.RECHNUNGSEMPFAENGER.toString())));
