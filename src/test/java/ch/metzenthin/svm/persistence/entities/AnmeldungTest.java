...
public class AnmeldungTest {
  ...
  public void testCompareTo() {
    ...
    anmeldungen.add(
        new Anmeldung(
            new GregorianCalendar(2013, Calendar.MAY, 1),
    ...
    // Neuste zuoberst
    assertEquals(
        new GregorianCalendar(2015, Calendar.JUNE, 1), anmeldungen.get(0).getAnmeldedatum());
    assertEquals(
        new GregorianCalendar(2014, Calendar.JULY, 1), anmeldungen.get(1).getAnmeldedatum());
    assertEquals(
        new GregorianCalendar(2013, Calendar.MAY, 1), anmeldungen.get(2).getAnmeldedatum());
  }
