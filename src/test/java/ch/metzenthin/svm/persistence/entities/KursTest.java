...
public class KursTest {
    ...
    public void testToString() throws Exception {
        ...
        Mitarbeiter mitarbeiter = new Mitarbeiter(Anrede.FRAU, "Vorname", "Lehrkraft1", toCalendar("11.11.95"), null, null, null, "111.11.111.1111.11", "CH31 8123 9000 0012 4568 9", true, null, null, true);
        Mitarbeiter mitarbeiter2 = new Mitarbeiter(Anrede.FRAU, "Vorname", "Lehrkraft2", toCalendar("11.11.95"), null, null, null, "222.22.222.2222.22", "CH31 8123 9000 0012 6666 9", true, null, null, true);
