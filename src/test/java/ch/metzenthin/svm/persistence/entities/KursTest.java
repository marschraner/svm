...
public class KursTest {
    ...
    public void testToString() throws Exception {
        ...
        Mitarbeiter mitarbeiter = new Mitarbeiter(Anrede.FRAU, "Vorname", "Lehrkraft1", toCalendar("11.11.95"), null, null, null, "111.11.111.1111.11", true, null, null, true);
        Mitarbeiter mitarbeiter2 = new Mitarbeiter(Anrede.FRAU, "Vorname", "Lehrkraft2", toCalendar("11.11.95"), null, null, null, "222.22.222.2222.22", true, null, null, true);
