...
public class DispensationTest {
  ...
  public void testCompareTo() {
    ...
    dispensationen.add(
        new Dispensation(
            new GregorianCalendar(2014, Calendar.JUNE, 2),
            new GregorianCalendar(2014, Calendar.AUGUST, 31),
            null,
            "Beinbruch"));
    dispensationen.add(
        new Dispensation(
            new GregorianCalendar(2014, Calendar.JULY, 1),
            new GregorianCalendar(2014, Calendar.JULY, 31),
            null,
            "Auslandaufenthalt Italien"));
    dispensationen.add(
        new Dispensation(
            new GregorianCalendar(2015, Calendar.APRIL, 8), null, null, "Arm gebrochen"));
    dispensationen.add(
        new Dispensation(
            new GregorianCalendar(2015, Calendar.APRIL, 8),
            new GregorianCalendar(2015, Calendar.JUNE, 20),
            null,
            "Auslandaufenthalt USA"));
    dispensationen.add(
        new Dispensation(
            new GregorianCalendar(2015, Calendar.APRIL, 8),
            new GregorianCalendar(2015, Calendar.APRIL, 15),
            null,
            "Impfung"));
