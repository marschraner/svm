...
public class SemesterrechnungDaoTest {
  ...
  public void testFindById() {
    ...
    try {
      ...
      Semesterrechnung semesterrechnungFound =
      ...
      assertEquals(
          new GregorianCalendar(1912, Calendar.FEBRUARY, 1),
          semesterrechnungFound.getRechnungsdatumVorrechnung());
      assertEquals(
          new GregorianCalendar(1912, Calendar.FEBRUARY, 29),
          semesterrechnungFound.getDatumZahlung1Vorrechnung());
      assertEquals(new BigDecimal("101.00"), semesterrechnungFound.getBetragZahlung1Vorrechnung());
      assertEquals(
          new GregorianCalendar(1912, Calendar.MARCH, 11),
          semesterrechnungFound.getDatumZahlung2Vorrechnung());
      assertEquals(new BigDecimal("151.00"), semesterrechnungFound.getBetragZahlung2Vorrechnung());
      assertEquals(
          new GregorianCalendar(1912, Calendar.APRIL, 21),
          semesterrechnungFound.getDatumZahlung3Vorrechnung());
      ...
      assertEquals(
          new GregorianCalendar(1912, Calendar.MARCH, 10),
          semesterrechnungFound.getDatumZahlung2Nachrechnung());
    ...
    try {
      ...
      Semester semester3 =
          new Semester(
              "1912/1913",
              Semesterbezeichnung.ERSTES_SEMESTER,
              new GregorianCalendar(1912, Calendar.AUGUST, 20),
              new GregorianCalendar(1913, Calendar.FEBRUARY, 10),
              new GregorianCalendar(1912, Calendar.OCTOBER, 5),
              new GregorianCalendar(1912, Calendar.OCTOBER, 17),
              new GregorianCalendar(1912, Calendar.DECEMBER, 21),
              new GregorianCalendar(1913, Calendar.JANUARY, 2));
      entityManager.persist(semester1);
      ...
      Semesterrechnung semesterrechnung3 =
          new Semesterrechnung(
              semester2,
              rechnungsempfaenger1,
              Stipendium.STIPENDIUM_70,
      ...
      List<Semesterrechnung> semesterrechnungList1 =
          semesterrechnungDao.findSemesterrechnungenSemester(semester1);
      assertEquals(2, semesterrechnungList1.size());
      assertEquals(
          "3 Wochen dispensiert", semesterrechnungList1.get(0).getErmaessigungsgrundVorrechnung());
      assertEquals(
          "2 Wochen dispensiert", semesterrechnungList1.get(1).getErmaessigungsgrundVorrechnung());

      // Nach Semesterrechnungen Semester 2 suchen
      List<Semesterrechnung> semesterrechnungList2 =
          semesterrechnungDao.findSemesterrechnungenSemester(semester2);
      assertEquals(1, semesterrechnungList2.size());
      assertEquals(
          "1 Woche dispensiert", semesterrechnungList2.get(0).getErmaessigungsgrundVorrechnung());

      // Nach Semesterrechnungen Semester 3 suchen
      List<Semesterrechnung> semesterrechnungList3 =
          semesterrechnungDao.findSemesterrechnungenSemester(semester3);
