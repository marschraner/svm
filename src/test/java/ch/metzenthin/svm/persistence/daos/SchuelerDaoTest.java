...
public class SchuelerDaoTest {
  ...
  public void testSave() {
    ...
    try {
      ...
      // Dispensationen
      Dispensation dispensation0 =
          new Dispensation(
              new GregorianCalendar(2015, Calendar.JUNE, 15),
      ...
      Dispensation dispensation1 =
          new Dispensation(
              ...
              new GregorianCalendar(2015, Calendar.JULY, 31),
              null,
              "Beinbruch");
    ...
    try {
      ...
      Schueler schueler1 =
          new Schueler(
              ...
              null,
              Geschlecht.W,
              "Schwester von Valentin Dan");
      Adresse adresse = new Adresse("Hohenklingenstrasse", "15", "8049", "Zürich");
      schueler1.setAdresse(adresse);
      Anmeldung anmeldungSchueler1 =
          new Anmeldung(new GregorianCalendar(2015, Calendar.JANUARY, 1), null);
      ...
      Adresse adresseRechnungsempfaenger =
          new Adresse("Hintere Bergstrassse", "15", "8942", "Oberrieden");
      Angehoeriger rechnungsempfaenger1 =
          new Angehoeriger(Anrede.FRAU, "Käthi", "Schraner", "044 720 85 51", null, null, true);
      ...
      Schueler schueler2 =
          new Schueler(
              "Valentin Dan",
              "Rösle",
              new GregorianCalendar(2014, Calendar.SEPTEMBER, 24),
              "044 491 69 33",
              null,
              null,
              Geschlecht.M,
      ...
      schueler2.addDispensation(
          new Dispensation(
              new GregorianCalendar(2015, Calendar.MAY, 15), null, null, "Viel zu klein"));
  ...
  public void testFindSchueler() {
    ...
    try {
      ...
      Angehoeriger rechnungsempfaenger2 =
          new Angehoeriger(Anrede.FRAU, "Käthi", "Schraner", "044 720 85 51", null, null, true);
      Adresse adresseRechnungsempfaenger2 =
          new Adresse("Hintere Bergstrassse", "15", "8942", "Oberrieden");
