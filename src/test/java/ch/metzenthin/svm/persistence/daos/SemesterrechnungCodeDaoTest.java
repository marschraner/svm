 ...
 */
class SemesterrechnungCodeDaoTest {
  ...
  void testFindById() {
    ...
    try {
      ...
      SemesterrechnungCode semesterrechnungCodeFound =
  ...
  void testSave() {
    ...
    try {
      ...
      SemesterrechnungCode semesterrechnungCode =
          new SemesterrechnungCode("2t", "Handrechnung Test", true);
      SemesterrechnungCode semesterrechnungCodeSaved =
          semesterrechnungCodeDao.save(semesterrechnungCode);

      entityManager.flush();

      SemesterrechnungCode semesterrechnungCodeFound =
          semesterrechnungCodeDao.findById(semesterrechnungCodeSaved.getCodeId());
  ...
  void testRemove() {
    ...
    try {
      ...
      SemesterrechnungCode semesterrechnungCode1 =
          new SemesterrechnungCode("2t", "Handrechnung Test", true);
      SemesterrechnungCode semesterrechnungCode1Saved =
      ...
      SemesterrechnungCode semesterrechnungCode2Saved =
