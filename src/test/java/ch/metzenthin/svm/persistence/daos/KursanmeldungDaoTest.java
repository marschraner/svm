...
public class KursanmeldungDaoTest {
  ...
  public void testFindById() {
    ...
    try {
      ...
      Kursanmeldung kursanmeldungFound =
      ...
      assertEquals(
          new GregorianCalendar(2015, Calendar.AUGUST, 30), kursanmeldungFound.getAnmeldedatum());
      assertEquals(
          new GregorianCalendar(2016, Calendar.FEBRUARY, 2), kursanmeldungFound.getAbmeldedatum());
  ...
  public void testRemove() {
    ...
    try {
      ...
      Kursanmeldung kursanmeldung =
          new Kursanmeldung(
              schueler, kurs, new GregorianCalendar(2015, Calendar.AUGUST, 30), null, null);
  ...
  public void testFindKurseinteilungenSchueler() {
    ...
    try {
      ...
      Angehoeriger mutter2 =
          new Angehoeriger(Anrede.FRAU, "Adriana", "Hasler", "044 422 69 33", null, null, false);
      ...
      Kursanmeldung kursanmeldung1 =
          new Kursanmeldung(
              schueler1, kurs1, new GregorianCalendar(2015, Calendar.AUGUST, 30), null, null);
      entityManager.persist(kursanmeldung1);
      Kursanmeldung kursanmeldung2 =
          new Kursanmeldung(
              schueler2, kurs1, new GregorianCalendar(2015, Calendar.AUGUST, 30), null, null);
      entityManager.persist(kursanmeldung2);
      Kursanmeldung kursanmeldung3 =
          new Kursanmeldung(
              schueler1, kurs2, new GregorianCalendar(2015, Calendar.AUGUST, 30), null, null);
      ...
      List<Kursanmeldung> kursanmeldungList1 =
          kursanmeldungDao.findKursanmeldungenSchueler(schueler1);
      ...
      List<Kursanmeldung> kursanmeldungList2 =
          kursanmeldungDao.findKursanmeldungenSchueler(schueler2);
      ...
      List<Kursanmeldung> kursanmeldungList3 =
          kursanmeldungDao.findKursanmeldungenSchueler(schueler3);
