...
class SchuelerCodeDaoTest {
  ...
  void testRemoveFromSchuelerAndUpdate() {
    ...
    try {
      ...
      Schueler schuelerUpdated =
          schuelerCodeDao.removeFromSchuelerAndUpdate(schuelerCode1Found, schuelerFound);
      entityManager.flush();
      ...
      schuelerUpdated =
          schuelerCodeDao.removeFromSchuelerAndUpdate(schuelerCode2Found, schuelerFound);
      entityManager.flush();
