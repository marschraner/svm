...
class KursDaoTest {
  ...
  @Test
  void testFindKurseSemester_and_testFindKurs() {
    EntityManager entityManager = db.getCurrentEntityManager();
    EntityTransaction tx = null;
    try {
      tx = entityManager.getTransaction();
      ...
      Semester semester3 =
          new Semester(
              "2012/2013",
              Semesterbezeichnung.ERSTES_SEMESTER,
              new GregorianCalendar(2012, Calendar.AUGUST, 20),
              new GregorianCalendar(2013, Calendar.FEBRUARY, 10),
      ...
      Semester semester4 =
          new Semester(
              "2013/2014",
              Semesterbezeichnung.ERSTES_SEMESTER,
              new GregorianCalendar(2013, Calendar.AUGUST, 20),
              new GregorianCalendar(2014, Calendar.FEBRUARY, 10),
              new GregorianCalendar(2013, Calendar.OCTOBER, 5),
              new GregorianCalendar(2013, Calendar.OCTOBER, 17),
              new GregorianCalendar(2013, Calendar.DECEMBER, 21),
      ...
      assertNull(
          kursDao.findKurs(
              semester3, Wochentag.DONNERSTAG, Time.valueOf("10:00:00"), mitarbeiter1));
      assertNull(
          kursDao.findKurs(semester1, Wochentag.MITTWOCH, Time.valueOf("10:00:00"), mitarbeiter1));
      assertNull(
          kursDao.findKurs(
              semester1, Wochentag.DONNERSTAG, Time.valueOf("10:10:00"), mitarbeiter1));
      assertNull(
          kursDao.findKurs(
              semester1, Wochentag.DONNERSTAG, Time.valueOf("10:00:00"), mitarbeiter2));
