...
public class KursDaoTest {
    ...
    public void testFindKurseSemester_and_testFindKurs() {
        ...
        try {
            ...
            Semester semester3 = new Semester("2012/2013", Semesterbezeichnung.ERSTES_SEMESTER, new GregorianCalendar(2012, Calendar.AUGUST, 20), new GregorianCalendar(2013, Calendar.FEBRUARY, 10), new GregorianCalendar(2012, Calendar.OCTOBER, 5), new GregorianCalendar(2012, Calendar.OCTOBER, 17), new GregorianCalendar(2012, Calendar.DECEMBER, 21), new GregorianCalendar(2012, Calendar.JANUARY, 2));
            semesterDao.save(semester3);
            Semester semester4 = new Semester("2013/2014", Semesterbezeichnung.ERSTES_SEMESTER, new GregorianCalendar(2013, Calendar.AUGUST, 20), new GregorianCalendar(2014, Calendar.FEBRUARY, 10), new GregorianCalendar(2013, Calendar.OCTOBER, 5), new GregorianCalendar(2013, Calendar.OCTOBER, 17), new GregorianCalendar(2013, Calendar.DECEMBER, 21), new GregorianCalendar(2014, Calendar.JANUARY, 2));
