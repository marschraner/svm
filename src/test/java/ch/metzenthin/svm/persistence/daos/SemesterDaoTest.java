...
public class SemesterDaoTest {
  ...
  public void testFindById() {
    ...
    try {
      ...
      assertEquals(
          new GregorianCalendar(2011, Calendar.AUGUST, 20), semesterFound.getSemesterbeginn());
      assertEquals(
          new GregorianCalendar(2012, Calendar.FEBRUARY, 10), semesterFound.getSemesterende());
      assertEquals(
          new GregorianCalendar(2011, Calendar.OCTOBER, 5), semesterFound.getFerienbeginn1());
      assertEquals(
          new GregorianCalendar(2011, Calendar.OCTOBER, 17), semesterFound.getFerienende1());
      assertEquals(
          new GregorianCalendar(2011, Calendar.DECEMBER, 21), semesterFound.getFerienbeginn2());
      assertEquals(
          new GregorianCalendar(2012, Calendar.JANUARY, 2), semesterFound.getFerienende2());
  ...
  public void testFindAll() {
    ...
    try {
      ...
      for (Semester semester : semestersFound) {
        if (semester
            .getSemesterbeginn()
            .equals(new GregorianCalendar(2012, Calendar.FEBRUARY, 20))) {
          found1 = true;
        }
