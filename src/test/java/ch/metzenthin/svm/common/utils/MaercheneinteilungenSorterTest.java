...
public class MaercheneinteilungenSorterTest {
    ...
    public void testSortMaercheneinteilungenByGruppeAndRolle() {
        ...
        Schueler schueler1 = new Schueler(vorname1, "Rösle", new GregorianCalendar(2012, Calendar.JULY, 24), null, null, null, Geschlecht.W, "Schwester von Valentin");
        Schueler schueler2 = new Schueler(vorname2, "Rösle", new GregorianCalendar(2014, Calendar.SEPTEMBER, 10), null, null, null, Geschlecht.M, null);
        Schueler schueler3 = new Schueler(vorname3, "Moser", new GregorianCalendar(2011, Calendar.JULY, 24), null, null, null, Geschlecht.W, null);
        Schueler schueler4 = new Schueler(vorname4, "Müller", new GregorianCalendar(2010, Calendar.JULY, 24), null, null, null, Geschlecht.M, null);
        ...
        Map<Schueler, Maercheneinteilung> sortedSchuelerMaercheneinteilungMap
                = maercheneinteilungenSorter.sortMaercheneinteilungenByGruppeAndRolle(schuelerMaercheneinteilungMap);
