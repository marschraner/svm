 ...
 */
public class MaercheneinteilungSortByElternmithilfeComparator
    implements Comparator<Maercheneinteilung> {

  @Override
  public int compare(
      Maercheneinteilung maercheneinteilung1, Maercheneinteilung maercheneinteilung2) {
    ...
    if (result == 0) {
      ...
      result =
          maercheneinteilung1.getGruppe().name().compareTo(maercheneinteilung2.getGruppe().name());
    }
    ...
    if (result == 0) {
      ...
      result =
          personComparator.compare(
              maercheneinteilung1.getSchueler(), maercheneinteilung2.getSchueler());
    }
