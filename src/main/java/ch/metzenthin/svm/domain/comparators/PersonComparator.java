    ...
    public int compare(Person person1, Person person2) {
        ...
        if (result == 0) {
            ...
            if (result == 0 && person1.getAdresse() != null && person2.getAdresse() != null) {
                ...
                if (result == 0 && person1.getAdresse().getStrasse() != null && person2.getAdresse().getStrasse() != null) {
                    result = collator.compare(person1.getAdresse().getStrasse(), person2.getAdresse().getStrasse());
                }
            }
        }
        return result;
