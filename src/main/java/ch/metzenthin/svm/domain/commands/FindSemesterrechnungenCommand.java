...
public class FindSemesterrechnungenCommand implements Command {
  ...
  private final SemesterrechnungenSuchenModel.SemesterrechnungCodeJaNeinSelected
      semesterrechnungCodeJaNeinSelected;
  ...
  private final SemesterrechnungenSuchenModel.RechnungsdatumGesetztVorrechnungSelected
      rechnungsdatumGesetztVorrechnungSelected;
  private final SemesterrechnungenSuchenModel.PraezisierungRechnungsdatumVorrechnungSelected
      praezisierungRechnungsdatumVorrechnungSelected;
  private final Calendar rechnungsdatumVorrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungErmaessigungVorrechnungSelected
      praezisierungErmaessigungVorrechnungSelected;
  private final BigDecimal ermaessigungVorrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungZuschlagVorrechnungSelected
      praezisierungZuschlagVorrechnungSelected;
  private final BigDecimal zuschlagVorrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungWochenbetragVorrechnungSelected
      praezisierungWochenbetragVorrechnungSelected;
  private final SemesterrechnungenSuchenModel.PraezisierungAnzahlWochenVorrechnungSelected
      praezisierungAnzahlWochenVorrechnungSelected;
  private final Integer anzahlWochenVorrechnung;
  private final BigDecimal wochenbetragVorrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungRechnungsbetragVorrechnungSelected
      praezisierungRechnungsbetragVorrechnungSelected;
  private final BigDecimal rechnungsbetragVorrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungRestbetragVorrechnungSelected
      praezisierungRestbetragVorrechnungSelected;
  private final BigDecimal restbetragVorrechnung;
  private final SemesterrechnungenSuchenModel.SechsJahresRabattJaNeinVorrechnungSelected
      sechsJahresRabattJaNeinVorrechnungSelected;
  private final SemesterrechnungenSuchenModel.RechnungsdatumGesetztNachrechnungSelected
      rechnungsdatumGesetztNachrechnungSelected;
  private final SemesterrechnungenSuchenModel.PraezisierungRechnungsdatumNachrechnungSelected
      praezisierungRechnungsdatumNachrechnungSelected;
  private final Calendar rechnungsdatumNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungErmaessigungNachrechnungSelected
      praezisierungErmaessigungNachrechnungSelected;
  private final BigDecimal ermaessigungNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungZuschlagNachrechnungSelected
      praezisierungZuschlagNachrechnungSelected;
  private final BigDecimal zuschlagNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungAnzahlWochenNachrechnungSelected
      praezisierungAnzahlWochenNachrechnungSelected;
  private final Integer anzahlWochenNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungWochenbetragNachrechnungSelected
      praezisierungWochenbetragNachrechnungSelected;
  private final BigDecimal wochenbetragNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungRechnungsbetragNachrechnungSelected
      praezisierungRechnungsbetragNachrechnungSelected;
  private final BigDecimal rechnungsbetragNachrechnung;
  private final SemesterrechnungenSuchenModel.PraezisierungRestbetragNachrechnungSelected
      praezisierungRestbetragNachrechnungSelected;
  private final BigDecimal restbetragNachrechnung;
  private final SemesterrechnungenSuchenModel.SechsJahresRabattJaNeinNachrechnungSelected
      sechsJahresRabattJaNeinNachrechnungSelected;
  private final SemesterrechnungenSuchenModel.PraezisierungDifferenzSchulgeldSelected
      praezisierungDifferenzSchulgeldSelected;
  ...
  public FindSemesterrechnungenCommand(
    ...
    this.semesterrechnungCodeJaNeinSelected =
    ...
    this.rechnungsdatumGesetztVorrechnungSelected =
        semesterrechnungenSuchenModel.getRechnungsdatumGesetztVorrechnungSelected();
    this.praezisierungRechnungsdatumVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRechnungsdatumVorrechnungSelected();
    this.rechnungsdatumVorrechnung = semesterrechnungenSuchenModel.getRechnungsdatumVorrechnung();
    this.praezisierungErmaessigungVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungErmaessigungVorrechnungSelected();
    this.ermaessigungVorrechnung = semesterrechnungenSuchenModel.getErmaessigungVorrechnung();
    this.praezisierungZuschlagVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungZuschlagVorrechnungSelected();
    this.zuschlagVorrechnung = semesterrechnungenSuchenModel.getZuschlagVorrechnung();
    this.praezisierungAnzahlWochenVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungAnzahlWochenVorrechnungSelected();
    this.anzahlWochenVorrechnung = semesterrechnungenSuchenModel.getAnzahlWochenVorrechnung();
    this.praezisierungWochenbetragVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungWochenbetragVorrechnungSelected();
    this.wochenbetragVorrechnung = semesterrechnungenSuchenModel.getWochenbetragVorrechnung();
    this.praezisierungRechnungsbetragVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRechnungsbetragVorrechnungSelected();
    this.rechnungsbetragVorrechnung = semesterrechnungenSuchenModel.getRechnungsbetragVorrechnung();
    this.praezisierungRestbetragVorrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRestbetragVorrechnungSelected();
    this.restbetragVorrechnung = semesterrechnungenSuchenModel.getRestbetragVorrechnung();
    this.sechsJahresRabattJaNeinVorrechnungSelected =
        semesterrechnungenSuchenModel.getSechsJahresRabattJaNeinVorrechnungSelected();
    this.rechnungsdatumGesetztNachrechnungSelected =
        semesterrechnungenSuchenModel.getRechnungsdatumGesetztNachrechnungSelected();
    this.praezisierungRechnungsdatumNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRechnungsdatumNachrechnungSelected();
    this.rechnungsdatumNachrechnung = semesterrechnungenSuchenModel.getRechnungsdatumNachrechnung();
    this.praezisierungErmaessigungNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungErmaessigungNachrechnungSelected();
    this.ermaessigungNachrechnung = semesterrechnungenSuchenModel.getErmaessigungNachrechnung();
    this.praezisierungZuschlagNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungZuschlagNachrechnungSelected();
    this.zuschlagNachrechnung = semesterrechnungenSuchenModel.getZuschlagNachrechnung();
    this.praezisierungAnzahlWochenNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungAnzahlWochenNachrechnungSelected();
    this.anzahlWochenNachrechnung = semesterrechnungenSuchenModel.getAnzahlWochenNachrechnung();
    this.praezisierungWochenbetragNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungWochenbetragNachrechnungSelected();
    this.wochenbetragNachrechnung = semesterrechnungenSuchenModel.getWochenbetragNachrechnung();
    this.praezisierungRechnungsbetragNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRechnungsbetragNachrechnungSelected();
    this.rechnungsbetragNachrechnung =
        semesterrechnungenSuchenModel.getRechnungsbetragNachrechnung();
    this.praezisierungRestbetragNachrechnungSelected =
        semesterrechnungenSuchenModel.getPraezisierungRestbetragNachrechnungSelected();
    this.restbetragNachrechnung = semesterrechnungenSuchenModel.getRestbetragNachrechnung();
    this.sechsJahresRabattJaNeinNachrechnungSelected =
        semesterrechnungenSuchenModel.getSechsJahresRabattJaNeinNachrechnungSelected();
    this.praezisierungDifferenzSchulgeldSelected =
        semesterrechnungenSuchenModel.getPraezisierungDifferenzSchulgeldSelected();
  ...
  public void execute() {
    ...
    selectStatementSb.append(
        " where semre.semester.semesterId = :semesterId and semre.deleted = :deleted and");
    ...
    typedQuery =
        db.getCurrentEntityManager()
            .createQuery(selectStatementSb.toString(), Semesterrechnung.class);
  ...
  private void createJoinSchueler() {
    if (rolle != SemesterrechnungenSuchenModel.RolleSelected.RECHNUNGSEMPFAENGER
        || wochentag != Wochentag.ALLE
        || zeitBeginn != null
        || mitarbeiter != SemesterrechnungenSuchenModel.MITARBEITER_ALLE) {
  ...
  private void createWhereSelections() {
    ...
    if (checkNotEmpty(vorname)) {
      ...
      String selectEltern =
          "(exists (select sch1 from Schueler sch1 where lower(sch1.mutter.vorname) like :vorname and sch1.personId = sch.personId) or exists (select sch2 from Schueler sch2 where lower(sch2.vater.vorname) like :vorname and sch2.personId = sch.personId))";
      switch (rolle) {
        ...
        case ALLE ->
            selectStatementSb
                .append("(")
                .append(selectRechnungsempfaenger)
                .append(" or ")
                .append(selectSchueler)
                .append(" or ")
                .append(selectEltern)
                .append(")")
                .append(" and");
    ...
    if (checkNotEmpty(nachname)) {
      String selectRechnungsempfaenger =
          " lower(semre.rechnungsempfaenger.nachname) like :nachname";
      String selectSchueler = " lower(sch.nachname) like :nachname";
      String selectEltern =
          "(exists (select sch1 from Schueler sch1 where lower(sch1.mutter.nachname) like :nachname and sch1.personId = sch.personId) or exists (select sch2 from Schueler sch2 where lower(sch2.vater.nachname) like :nachname and sch2.personId = sch.personId))";
      switch (rolle) {
        case SCHUELER -> selectStatementSb.append(selectSchueler).append(" and");
        case ELTERN -> selectStatementSb.append(selectEltern).append(" and");
        case RECHNUNGSEMPFAENGER ->
    ...
    switch (semesterrechnungCodeJaNeinSelected) {
      case JA -> {
        if (semesterrechnungCode != null
            && semesterrechnungCode != SemesterrechnungModel.SEMESTERRECHNUNG_CODE_ALLE) {
          selectStatementSb.append(
              " semre.semesterrechnungCode.codeId = :semesterrechnungCodeId and");
        } else {
      ...
      case GESETZT -> {
        if (rechnungsdatumVorrechnung != null) {
          switch (praezisierungRechnungsdatumVorrechnungSelected) {
            case AM ->
                selectStatementSb.append(
                    " semre.rechnungsdatumVorrechnung = :rechnungsdatumVorrechnung and");
            case VOR ->
                selectStatementSb.append(
                    " semre.rechnungsdatumVorrechnung < :rechnungsdatumVorrechnung and");
            case NACH ->
    ...
    if (ermaessigungVorrechnung != null) {
      switch (praezisierungErmaessigungVorrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.ermaessigungVorrechnung = :ermaessigungVorrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.ermaessigungVorrechnung < :ermaessigungVorrechnung and");
        case GROESSER ->
    ...
    if (anzahlWochenVorrechnung != null) {
      switch (praezisierungAnzahlWochenVorrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.anzahlWochenVorrechnung = :anzahlWochenVorrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.anzahlWochenVorrechnung < :anzahlWochenVorrechnung and");
        case GROESSER ->
    ...
    if (wochenbetragVorrechnung != null) {
      switch (praezisierungWochenbetragVorrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.wochenbetragVorrechnung = :wochenbetragVorrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.wochenbetragVorrechnung < :wochenbetragVorrechnung and");
        case GROESSER ->
      ...
      case GESETZT -> {
        if (rechnungsdatumNachrechnung != null) {
          switch (praezisierungRechnungsdatumNachrechnungSelected) {
            case AM ->
                selectStatementSb.append(
                    " semre.rechnungsdatumNachrechnung = :rechnungsdatumNachrechnung and");
            case VOR ->
                selectStatementSb.append(
                    " semre.rechnungsdatumNachrechnung < :rechnungsdatumNachrechnung and");
            case NACH ->
    ...
    if (ermaessigungNachrechnung != null) {
      switch (praezisierungErmaessigungNachrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.ermaessigungNachrechnung = :ermaessigungNachrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.ermaessigungNachrechnung < :ermaessigungNachrechnung and");
        case GROESSER ->
    ...
    if (anzahlWochenNachrechnung != null) {
      switch (praezisierungAnzahlWochenNachrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.anzahlWochenNachrechnung = :anzahlWochenNachrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.anzahlWochenNachrechnung < :anzahlWochenNachrechnung and");
        case GROESSER ->
    ...
    if (wochenbetragNachrechnung != null) {
      switch (praezisierungWochenbetragNachrechnungSelected) {
        case GLEICH ->
            selectStatementSb.append(
                " semre.wochenbetragNachrechnung = :wochenbetragNachrechnung and");
        case KLEINER ->
            selectStatementSb.append(
                " semre.wochenbetragNachrechnung < :wochenbetragNachrechnung and");
        case GROESSER ->
        ...
        case GLEICH -> {
          while (it.hasNext()) {
            ...
            if (semesterrechnungIt.getRechnungsbetragVorrechnung() == null
                || semesterrechnungIt
                        .getRechnungsbetragVorrechnung()
                        .compareTo(rechnungsbetragVorrechnung)
                    != 0) {
              it.remove();
            }
          }
        ...
        case GLEICH -> {
          while (it.hasNext()) {
            ...
            if (semesterrechnungIt.getRechnungsbetragNachrechnung() == null
                || semesterrechnungIt
                        .getRechnungsbetragNachrechnung()
                        .compareTo(rechnungsbetragNachrechnung)
                    != 0) {
              it.remove();
            }
          }
        ...
        case GLEICH -> {
          while (it.hasNext()) {
            ...
            if (semesterrechnungIt.getRestbetragVorrechnung() == null
                || semesterrechnungIt.getRestbetragVorrechnung().compareTo(restbetragVorrechnung)
                    != 0) {
              it.remove();
            }
          }
        ...
        case GLEICH -> {
          while (it.hasNext()) {
            ...
            if (semesterrechnungIt.getRestbetragNachrechnung() == null
                || semesterrechnungIt.getRestbetragNachrechnung().compareTo(restbetragNachrechnung)
                    != 0) {
              it.remove();
            }
          }
  ...
  private void filterSechsJahresRabatt() {
    if (sechsJahresRabattJaNeinVorrechnungSelected
      ...
      FindPreviousSemesterCommand findPreviousSemesterCommand =
          new FindPreviousSemesterCommand(semester);
      ...
      if (sechsJahresRabattJaNeinVorrechnungSelected
        ...
        while (it.hasNext()) {
          Semesterrechnung semesterrechnungIt = it.next();
          CheckIfSemesterrechnungContainsSechsJahresRabattCommand
              checkIfSemesterrechnungContainsSechsJahresRabattCommand =
                  new CheckIfSemesterrechnungContainsSechsJahresRabattCommand(
                      semesterrechnungIt, previousSemester, Rechnungstyp.VORRECHNUNG);
          checkIfSemesterrechnungContainsSechsJahresRabattCommand.execute();
          if (!checkIfSemesterrechnungContainsSechsJahresRabattCommand
              .isSemesterrechnungContainsSechsJahresRabatt()) {
            it.remove();
          }
        }
    ...
    if (sechsJahresRabattJaNeinNachrechnungSelected
      ...
      if (sechsJahresRabattJaNeinNachrechnungSelected
        ...
        while (it.hasNext()) {
          ...
          CheckIfSemesterrechnungContainsSechsJahresRabattCommand
              checkIfSemesterrechnungContainsSechsJahresRabattCommand =
                  new CheckIfSemesterrechnungContainsSechsJahresRabattCommand(
                      semesterrechnungIt, semester, Rechnungstyp.NACHRECHNUNG);
          checkIfSemesterrechnungContainsSechsJahresRabattCommand.execute();
          if (!checkIfSemesterrechnungContainsSechsJahresRabattCommand
              .isSemesterrechnungContainsSechsJahresRabatt()) {
            it.remove();
      ...
      } else if (sechsJahresRabattJaNeinNachrechnungSelected
