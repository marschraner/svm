...
public class CheckIfSemesterrechnungContainsSechsJahresRabattCommand implements Command {
  ...
  public CheckIfSemesterrechnungContainsSechsJahresRabattCommand(
      Semesterrechnung semesterrechnung, Semester previousSemester, Rechnungstyp rechnungstyp) {
  ...
  public void execute() {
    ...
    Semester relevantesSemester =
        (rechnungstyp == Rechnungstyp.NACHRECHNUNG
    ...
    for (Schueler schueler :
      ...
      if (anmeldung.getAbmeldedatum() != null
          && !anmeldung
              .getAbmeldedatum()
              .after(semesterrechnung.getSemester().getSemesterbeginn())) {
        continue;
      }
      ...
      for (Kursanmeldung kursanmeldung : schueler.getKursanmeldungen()) {
        if (kursanmeldung
                ...
                .getSemester()
                .getSemesterId()
                .equals(relevantesSemester.getSemesterId())
            && (rechnungstyp == Rechnungstyp.NACHRECHNUNG
      ...
      CheckIfAnmeldungsdauerErlaubtSechsJahresRabattCommand
          checkIfAnmeldungsdauerErlaubtSechsJahresRabattCommand =
              new CheckIfAnmeldungsdauerErlaubtSechsJahresRabattCommand(
                  schueler, semesterrechnung.getSemester().getSemesterbeginn());
      checkIfAnmeldungsdauerErlaubtSechsJahresRabattCommand.execute();
      if (checkIfAnmeldungsdauerErlaubtSechsJahresRabattCommand
          .isAnmeldungsdauerErlaubtSechsJahresRabatt()) {
