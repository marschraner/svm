...
public class SaveOrUpdateMaercheneinteilungCommand implements Command {
  ...
  public SaveOrUpdateMaercheneinteilungCommand(
      ...
      Adresse elternmithilfeDrittpersonAdresse,
      Maercheneinteilung maercheneinteilungOrigin,
      List<Maercheneinteilung> bereitsErfassteMaercheneinteilungen) {
  ...
  public void execute() {
    ...
    if (maercheneinteilungOrigin != null) {
      ...
      if (maercheneinteilungOrigin.getElternmithilfeDrittperson() != null
          && elternmithilfeDrittperson != null) {
        maercheneinteilungOrigin
            .getElternmithilfeDrittperson()
            .copyAttributesFrom(elternmithilfeDrittperson);
        maercheneinteilungOrigin
            .getElternmithilfeDrittperson()
            .getAdresse()
            .copyAttributesFrom(elternmithilfeDrittperson.getAdresse());
      } else {
        maercheneinteilungOrigin.setElternmithilfeDrittperson(elternmithilfeDrittperson);
      }
      // Reload zur Verhinderung von Lazy Loading-Problem
      Maercheneinteilung maercheneinteilungOriginReloaded =
          maercheneinteilungDao.findById(
              new MaercheneinteilungId(
                  maercheneinteilungOrigin.getSchueler().getPersonId(),
                  maercheneinteilungOrigin.getMaerchen().getMaerchenId()));
