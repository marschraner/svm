...
public class CheckMitarbeiterBereitsErfasstCommand implements Command {
  ...
  public CheckMitarbeiterBereitsErfasstCommand(
      Mitarbeiter mitarbeiter,
      Mitarbeiter mitarbeiterOrigin,
      List<Mitarbeiter> bereitsErfassteLehrkraefte) {
  ...
  public void execute() {
    for (Mitarbeiter bereitsErfassteMitarbeiter : bereitsErfassteLehrkraefte) {
      if (!bereitsErfassteMitarbeiter.isIdenticalWith(mitarbeiterOrigin)
          && bereitsErfassteMitarbeiter.isIdenticalWith(mitarbeiter)) {
        bereitsErfasst = true;
        return;
      }
    }
