...
public class SaveOrUpdateKursanmeldungCommand implements Command {
  ...
  public SaveOrUpdateKursanmeldungCommand(
      Kursanmeldung kursanmeldung,
      Kursanmeldung kursanmeldungOrigin,
      List<Kursanmeldung> bereitsErfassteKursanmeldungen) {
  ...
  public void execute() {
    if (kursanmeldungOrigin != null) {
      ...
      Kursanmeldung kursanmeldungOriginReloaded =
          kursanmeldungDao.findById(
              new KursanmeldungId(
                  kursanmeldungOrigin.getSchueler().getPersonId(),
                  kursanmeldungOrigin.getKurs().getKursId()));
