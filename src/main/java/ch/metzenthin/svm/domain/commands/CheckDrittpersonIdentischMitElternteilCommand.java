...
public class CheckDrittpersonIdentischMitElternteilCommand implements Command {
  ...
  static final String ERROR_IDENTISCH_MIT_MUTTER =
      "Rechnungsempfänger Drittperson ist identisch mit Mutter. Setze Mutter als Rechnungsempfängerin.";
  static final String ERROR_WAHRSCHEINLICH_IDENTISCH_MIT_MUTTER =
      "Rechnungsempfänger Drittperson und Mutter scheinen identisch zu sein. Setze Mutter als Rechnungsempfängerin und/oder korrigiere Mutter.";
  static final String ERROR_IDENTISCH_MIT_VATER =
      "Rechnungsempfänger Drittperson ist identisch mit Vater. Setze Vater als Rechnungsempfänger.";
  static final String ERROR_WAHRSCHEINLICH_IDENTISCH_MIT_VATER =
      "Rechnungsempfänger Drittperson und Vater scheinen identisch zu sein. Setze Vater als Rechnungsempfänger und/oder korrigiere Vater.";
  ...
  CheckDrittpersonIdentischMitElternteilCommand(
      Angehoeriger mutter, Angehoeriger vater, Angehoeriger rechnungsempfaengerDrittperson) {
    this.mutter = mutter;
    this.vater = vater;
