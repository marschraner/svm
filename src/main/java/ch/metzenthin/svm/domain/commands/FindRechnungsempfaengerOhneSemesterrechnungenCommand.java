    ...
    if (previousSemester != null) {
      ...
      typedQuery =
          entityManager.createQuery(
              "select distinct rech from Angehoeriger rech"
                  ...
                  + " not exists (select semre.rechnungsempfaenger from Semesterrechnung semre where semre.rechnungsempfaenger.personId = rech.personId and semre.semester.semesterId = :currentSemesterId)",
              Angehoeriger.class);
