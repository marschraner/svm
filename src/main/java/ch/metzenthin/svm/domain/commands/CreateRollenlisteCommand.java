...
public class CreateRollenlisteCommand extends CreateListeCommand {
  ...
  public CreateRollenlisteCommand(
      SchuelerSuchenTableModel schuelerSuchenTableModel, String titel, File outputFile) {
  ...
  public void execute() {
    ...
    if (schuelerSuchenTableModel.isNachRollenGesucht()) {
      ...
      maercheneinteilungen =
          maercheneinteilungenSorter.sortMaercheneinteilungenByGruppeAndRolle(maercheneinteilungen);
    ...
    for (Schueler schueler : keys) {
      ...
      if (maercheneinteilung.getRolle2() == null
          && maercheneinteilung.getBilderRolle2() == null
          && maercheneinteilung.getRolle3() == null
          && maercheneinteilung.getBilderRolle3() == null) {
        maxLines = 3;
      } else {
        maxLines = 1;
      }
      ...
      SplitStringIntoMultipleLinesCommand splitStringIntoMultipleLinesCommand =
          new SplitStringIntoMultipleLinesCommand(
              maercheneinteilung.getRolle1WithoutSorterCharacters(), 18, maxLines);
      ...
      if (maercheneinteilung.getBilderRolle1() != null) {
        splitStringIntoMultipleLinesCommand =
            new SplitStringIntoMultipleLinesCommand(
                maercheneinteilung.getBilderRolle1(), 18, maxLines);
        splitStringIntoMultipleLinesCommand.execute();
      ...
      if (maercheneinteilung.getRolle2() != null) {
        splitStringIntoMultipleLinesCommand =
            new SplitStringIntoMultipleLinesCommand(maercheneinteilung.getRolle2(), 18, maxLines);
        splitStringIntoMultipleLinesCommand.execute();
      ...
      if (maercheneinteilung.getBilderRolle2() != null) {
        splitStringIntoMultipleLinesCommand =
            new SplitStringIntoMultipleLinesCommand(
                maercheneinteilung.getBilderRolle2(), 18, maxLines);
        splitStringIntoMultipleLinesCommand.execute();
      ...
      cellsRow3.add("");
      String email = "";
      // Wenn vorhanden E-Mail des Schülers, sonst der Elternmithilfe (falls nicht Drittperson),
      // sonst der Mutter, sonst des Vaters, sonst Elternmithilfe Drittperson; andernfalls leer
    ...
    String maerchenspielSchuljahr =
        (semester == null) ? "" : "Märchenspiel " + semester.getSchuljahr();
    String titel1 =
        "Kinder- und Jugendtheater Metzenthin AG                                             "
            + maerchenspielSchuljahr;
    CreateWordTableCommand createWordTableCommand =
        new CreateWordTableCommand(
            header,
            datasets,
            columnWidths,
            boldCells,
