...
public class CreateVertretungslisteCommand extends CreateListeCommand {
  ...
  public CreateVertretungslisteCommand(
      MitarbeitersTableModel mitarbeitersTableModel, String titel, File outputFile) {
    ...
    for (Mitarbeiter mitarbeiter : mitarbeitersTableModel.getSelektierteMitarbeiters()) {
      ...
      SplitStringIntoMultipleLinesCommand splitStringIntoMultipleLinesCommand =
          new SplitStringIntoMultipleLinesCommand(
              mitarbeiter.getVertretungsmoeglichkeitenLineBreaksReplacedBySemicolonOrPeriod(),
              32,
              3);
      ...
      cellsRow2.add(
          mitarbeiter.getAdresse() == null
              ? ""
              : nullAsEmptyString(mitarbeiter.getAdresse().getStrHausnummer()));
      cellsRow2.add(
          mitarbeiter.getAdresse() == null
              ? ""
              : mitarbeiter.getAdresse().getPlz() + " " + mitarbeiter.getAdresse().getOrt());
