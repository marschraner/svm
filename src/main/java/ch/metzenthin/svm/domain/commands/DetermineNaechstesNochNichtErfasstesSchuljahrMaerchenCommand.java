...
public class DetermineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand implements Command {
  ...
  public DetermineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand(
      List<Maerchen> bereitsErfassteMaerchens) {
  ...
  public void execute() {
    ...
    while (isMaerchenBereitsErfasst(naechstesSchuljahr)
