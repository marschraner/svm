...
public class CreateElternmithilfeListeCommand extends CreateListeCommand {
  ...
  public CreateElternmithilfeListeCommand(
  ...
  public void execute() {
    ...
    // Inhalt
    Map<Schueler, Maercheneinteilung> mapOfSchuelerAndMaercheneinteilung =
    ...
    for (Schueler schueler : schuelerSuchenTableModel.getSelektierteSchuelerList()) {
      ...
      // Falls Elternteil nach Erfassen der Elternmithilfe gelöscht wurde, kann Elternmithilfe null
      // sein.
    ...
    // Elternmithilfe
    maercheneinteilungenMitElternmithilfe.sort(
    ...
    for (Maercheneinteilung maercheneinteilung : maercheneinteilungenMitElternmithilfe) {
      ...
      if (maercheneinteilung.getElternmithilfeCode() != null) {
        SplitStringIntoMultipleLinesCommand splitStringIntoMultipleLinesCommand =
            new SplitStringIntoMultipleLinesCommand(
                maercheneinteilung.getElternmithilfeCode().getBeschreibung(), 21, 3);
      ...
      // Wenn Elternmithilfe und Schüler unterschiedliche Nachnamen haben, soll zudem Nachname des
      // Schülers angegeben werden
      ...
      cellsRow2.add(
          elternmithilfe.getAdresse().getPlz() + " " + elternmithilfe.getAdresse().getOrt());
