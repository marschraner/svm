...
public class SaveOrUpdateMitarbeiterCommand implements Command {
  ...
  public SaveOrUpdateMitarbeiterCommand(
      Mitarbeiter mitarbeiter,
      Adresse adresse,
      Set<MitarbeiterCode> mitarbeiterCodes,
      Mitarbeiter mitarbeiterOrigin,
      List<Mitarbeiter> bereitsErfassteMitarbeiter) {
  ...
  private void addMitarbeiterCodesNeuerMitarbeiter() {
    ...
    for (MitarbeiterCode mitarbeiterCode : mitarbeiterCodes) {
      mitarbeiterSaved =
          mitarbeiterCodeDao.addToMitarbeiterAndSave(mitarbeiterCode, mitarbeiterSaved);
    }
  }
      ...
      if (!found) {
        ...
        mitarbeiterSaved =
            mitarbeiterCodeDao.removeFromMitarbeiterAndUpdate(
                mitarbeiterCodeOriginIt, mitarbeiterSaved);
      }
    }
  }
