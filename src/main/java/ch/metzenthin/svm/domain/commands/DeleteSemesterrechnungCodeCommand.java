...
public class DeleteSemesterrechnungCodeCommand implements Command {
  ...
  public DeleteSemesterrechnungCodeCommand(
      List<SemesterrechnungCode> semesterrechnungCodes, int indexCodeToBeDeleted) {
  ...
  public void execute() {
    SemesterrechnungCode semesterrechnungCodeToBeDeleted =
        semesterrechnungCodes.get(indexCodeToBeDeleted);
