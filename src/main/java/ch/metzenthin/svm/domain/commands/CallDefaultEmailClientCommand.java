...
public class CallDefaultEmailClientCommand implements Command {
  ...
  @SuppressWarnings({"ExtractMethodRecommender", "java:S125"})
  @Override
  public void execute() {
    ...
    // Zusammensetzen zu einzigem String mit durch ";" (oder anderem Separator gemäss
    // .svm-Konfiguration) getrennten E-Mails
    ...
    try {
      ...
      // emailAdressenAsSingleString = emailAdressenAsSingleString.replaceAll(",\\p{Blank}*", ";");
      //  // ; als Trenner zwischen mehreren Emails verwenden
