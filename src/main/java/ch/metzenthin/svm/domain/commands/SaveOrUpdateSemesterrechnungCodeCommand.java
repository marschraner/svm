...
public class SaveOrUpdateSemesterrechnungCodeCommand implements Command {
  ...
  public SaveOrUpdateSemesterrechnungCodeCommand(
      SemesterrechnungCode semesterrechnungCode,
      SemesterrechnungCode semesterrechnungCodeOrigin,
      List<SemesterrechnungCode> bereitsErfassteSemesterrechnungCodes) {
