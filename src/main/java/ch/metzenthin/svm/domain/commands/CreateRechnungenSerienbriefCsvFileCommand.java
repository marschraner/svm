...
public class CreateRechnungenSerienbriefCsvFileCommand extends CreateListeCommand {
  ...
  public CreateRechnungenSerienbriefCsvFileCommand(
  ...
  @SuppressWarnings({"DuplicatedCode", "java:S135", "java:S3776", "java:S6541"})
  @Override
  public void execute() {
      ...
      for (Semesterrechnung semesterrechnung : semesterrechnungList) {
        ...
        if (rechnungstyp == Rechnungstyp.VORRECHNUNG) {
          ...
          if (semesterrechnung.getBemerkungen() != null) {
            out.write(
                semesterrechnung
                    .getBemerkungenLineBreaksReplacedByCommaOrPeriod()
                    .replace(";", ","));
          }
          out.write(separator);
          ...
          out.write(separator);
          if (semesterrechnung.getErmaessigungVorrechnung() != null
          ...
          out.write(separator);
          if (semesterrechnung.getZuschlagVorrechnung() != null
          ...
          if (ermaessigungStipendiumVorrechnung != null
          ...
          out.write(separator);
          BigDecimal rechnungsbetragNachrechnung =
              semesterrechnung.getRechnungsbetragNachrechnung();
