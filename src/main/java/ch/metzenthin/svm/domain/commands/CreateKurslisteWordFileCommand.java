...
public class CreateKurslisteWordFileCommand extends CreateListeCommand {
  ...
  public CreateKurslisteWordFileCommand(
      KurseTableModel kurseTableModel, String titel, File outputFile) {
  ...
  public void execute() {
    ...
    for (Kurs kurs : kurse) {
      ...
      SplitStringIntoMultipleLinesCommand splitStringIntoMultipleLinesCommand =
          new SplitStringIntoMultipleLinesCommand(kurs.getKurstyp().getBezeichnung(), 22, 2);
      ...
      splitStringIntoMultipleLinesCommand =
          new SplitStringIntoMultipleLinesCommand(kurs.getBemerkungen(), 16, 2);
      splitStringIntoMultipleLinesCommand.execute();
    ...
    String titel1 =
        "Kinder- und Jugendtheater Metzenthin AG                              " + schuljahrSemester;
