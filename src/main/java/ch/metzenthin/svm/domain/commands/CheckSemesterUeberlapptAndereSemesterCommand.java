...
public class CheckSemesterUeberlapptAndereSemesterCommand implements Command {
  ...
  public CheckSemesterUeberlapptAndereSemesterCommand(
      Semester semester, Semester semesterOrigin, List<Semester> bereitsErfassteSemester) {
    ...
    for (Semester bereitsErfasstesSemester : bereitsErfassteSemester) {
      if (!bereitsErfasstesSemester.isIdenticalWith(semesterOrigin)
          && checkIfTwoPeriodsOverlap(
              bereitsErfasstesSemester.getSemesterbeginn(),
              bereitsErfasstesSemester.getSemesterende(),
