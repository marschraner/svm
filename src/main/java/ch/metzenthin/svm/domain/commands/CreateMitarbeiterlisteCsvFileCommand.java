...
public class CreateMitarbeiterlisteCsvFileCommand extends CreateListeCommand {
  ...
  public CreateMitarbeiterlisteCsvFileCommand(
      List<? extends Mitarbeiter> mitarbeiterList, File outputFile, boolean nameEinspaltig) {
    ...
    try {
      ...
      for (Mitarbeiter mitarbeiter : mitarbeiterList) {
        ...
        if (mitarbeiter.getVertretungsmoeglichkeiten() != null) {
          out.write(
              mitarbeiter
                  .getVertretungsmoeglichkeitenLineBreaksReplacedByCommaOrPeriod()
                  .replace(";", ","));
        }
        out.write(separator);
