 ...
 */
class ListenExportModelOldImpl extends AbstractModel implements ListenExportModelOld {
  ...
  private final StringModelAttribute titelModelAttribute =
  ...
  @Override
  public String[] getListenErstellenWarning(
    ...
    switch (listentyp) {
      case VORRECHNUNGEN_SERIENBRIEF -> {
        if (!checkIfRechnungsdatumVorrechnungUeberallGesetzt(semesterrechnungenTableModel)) {
          String listenErstellenWarningMessage =
              "Die Rechnungsauswahl enthält Vorrechnungen ohne Rechnungsdatum. \n"
                  + "Es werden nur Rechnungen mit gesetztem Rechnungsdatum exportiert. Fortfahren?";
          listenErstellenWarning =
              new String[] {listenErstellenWarningMessage, RECHNUNGSDATUM_NICHT_UEBERALL_GESETZT};
        }
      }
      case NACHRECHNUNGEN_SERIENBRIEF -> {
        if (!checkIfRechnungsdatumNachrechnungUeberallGesetzt(semesterrechnungenTableModel)) {
          String listenErstellenWarningMessage =
              "Die Rechnungsauswahl enthält Nachrechnungen ohne Rechnungsdatum. \n"
                  + "Es werden nur Rechnungen mit gesetztem Rechnungsdatum exportiert. Fortfahren?";
          listenErstellenWarning =
              new String[] {listenErstellenWarningMessage, RECHNUNGSDATUM_NICHT_UEBERALL_GESETZT};
        }
  ...
  @Override
  public CreateListeCommand.Result createListenFile(
      File outputFile,
    ...
    switch (listentyp) {
      case SCHUELER_ADRESSLISTE -> {
        CreateSchuelerAdresslisteCommand createSchuelerAdresslisteCommand =
            new CreateSchuelerAdresslisteCommand(schuelerSuchenTableModel, titel, outputFile);
      ...
      case ABSENZENLISTE_GANZES_SEMESTER,
        ...
        CreateListeFromTemplateCommand createListeFromTemplateCommand =
            new CreateListeFromTemplateCommand(
                schuelerSuchenTableModel, titel, listentyp, outputFile);
      ...
      case ROLLENLISTE -> {
        CreateRollenlisteCommand createRollenlisteCommand =
            new CreateRollenlisteCommand(schuelerSuchenTableModel, titel, outputFile);
        commandInvoker.executeCommand(createRollenlisteCommand);
        result = createRollenlisteCommand.getResult();
      }
      case ELTERNMITHILFE_LISTE -> {
        CreateElternmithilfeListeCommand createElternmithilfeListeCommand =
            new CreateElternmithilfeListeCommand(schuelerSuchenTableModel, titel, outputFile);
      ...
      case SCHUELER_ADRESSETIKETTEN -> {
        CreateAdressenCsvFileCommand createAdressenCsvFileCommandSchueler =
            new CreateAdressenCsvFileCommand(
                schuelerSuchenTableModel.getSelektierteSchuelerList(), outputFile);
      ...
      case RECHNUNGSEMPFAENGER_ADRESSETIKETTEN -> {
        ...
        CreateAdressenCsvFileCommand createAdressenCsvFileCommandRechnungsempfaenger =
            new CreateAdressenCsvFileCommand(rechnungsempfaengerList, outputFile);
      ...
      case MUTTER_ODER_VATER_ADRESSETIKETTEN -> {
        ...
        CreateAdressenCsvFileCommand createAdressenCsvFileCommandMutterOderVater =
            new CreateAdressenCsvFileCommand(mutterOderVaterList, outputFile);
      ...
      case ELTERNMITHILFE_ADRESSETIKETTEN -> {
        ...
        for (Map.Entry<Schueler, Maercheneinteilung> maercheneinteilungenEntry :
            maercheneinteilungen.entrySet()) {
        ...
        CreateAdressenCsvFileCommand createAdressenCsvFileCommandElternmithilfe =
            new CreateAdressenCsvFileCommand(elternmithilfeList, outputFile);
      ...
      case PROBEPLAENE_ETIKETTEN -> {
        CreateProbeplaeneEtikettenCsvFileCommand createProbeplaeneEtikettenCsvFileCommand =
            new CreateProbeplaeneEtikettenCsvFileCommand(schuelerSuchenTableModel, outputFile);
      ...
      case SCHUELERLISTE_CSV -> {
        CreateSchuelerlisteCsvFileCommand createSchuelerlisteCsvFileCommand =
            new CreateSchuelerlisteCsvFileCommand(schuelerSuchenTableModel, outputFile);
        commandInvoker.executeCommand(createSchuelerlisteCsvFileCommand);
        result = createSchuelerlisteCsvFileCommand.getResult();
      }
      case MITARBEITER_ADRESSLISTE_MIT_GEBURTSDATUM, MITARBEITER_ADRESSLISTE_OHNE_GEBURTSDATUM -> {
        CreateMitarbeiterAdresslisteCommand createMitarbeiterAdresslisteMitGeburtsdatumCommand =
            new CreateMitarbeiterAdresslisteCommand(
                mitarbeitersTableModel, titel, outputFile, listentyp);
      ...
      case VERTRETUNGSLISTE -> {
        CreateVertretungslisteCommand createVertretungslisteCommand =
            new CreateVertretungslisteCommand(mitarbeitersTableModel, titel, outputFile);
      ...
      case MITARBEITER_ADRESSLISTE_MIT_GEBURTSDATUM_AHV_IBAN_VERTRETUNGSMOEGLICHKEITEN -> {
        CreateMitarbeiterAdresslisteAlleAttributeCommand
            createMitarbeiterAdresslisteAlleAttributeCommand =
                new CreateMitarbeiterAdresslisteAlleAttributeCommand(
                    mitarbeitersTableModel, titel, outputFile);
      ...
      case MITARBEITER_ADRESSETIKETTEN -> {
        CreateAdressenCsvFileCommand createAdressenCsvFileCommandMitarbeiter =
            new CreateAdressenCsvFileCommand(
                mitarbeitersTableModel.getSelektierteMitarbeiters(), outputFile);
      ...
      case MITARBEITER_LISTE_NAME_ZWEISPALTIG_CSV -> {
        CreateMitarbeiterlisteCsvFileCommand createMitarbeiterlisteNameZweispaltigCsvFileCommand =
            new CreateMitarbeiterlisteCsvFileCommand(
                mitarbeitersTableModel.getSelektierteMitarbeiters(), outputFile, false);
      ...
      case MITARBEITER_LISTE_NAME_EINSPALTIG_CSV -> {
        CreateMitarbeiterlisteCsvFileCommand createMitarbeiterlisteNameEinspaltigCsvFileCommand =
            new CreateMitarbeiterlisteCsvFileCommand(
                mitarbeitersTableModel.getSelektierteMitarbeiters(), outputFile, true);
      ...
      case KURSLISTE_WORD -> {
        CreateKurslisteWordFileCommand createKurslisteWordFileCommand =
            new CreateKurslisteWordFileCommand(kurseTableModel, titel, outputFile);
        commandInvoker.executeCommand(createKurslisteWordFileCommand);
        result = createKurslisteWordFileCommand.getResult();
      }
      case KURSLISTE_CSV -> {
        CreateKurslisteCsvFileCommand createKurslisteCsvFileCommand =
            new CreateKurslisteCsvFileCommand(kurseTableModel.getKurse(), outputFile);
      ...
      case VORRECHNUNGEN_SERIENBRIEF -> {
        ...
        CreateRechnungenSerienbriefCsvFileCommand createVorrechnungenSerienbriefCsvFileCommand =
            new CreateRechnungenSerienbriefCsvFileCommand(
      ...
      case NACHRECHNUNGEN_SERIENBRIEF -> {
        ...
        CreateRechnungenSerienbriefCsvFileCommand createNachrechnungenSerienbriefCsvFileCommand =
            new CreateRechnungenSerienbriefCsvFileCommand(
                semesterrechnungenTableModel.getSelektierteSemesterrechnungen(),
                previousSemester2,
      ...
      case MAHNUNGEN_VORRECHNUNGEN_SERIENBRIEF -> {
        CreateMahnungenSerienbriefCsvFileCommand
            createMahnungenVorrechnungenSerienbriefCsvFileCommand =
                new CreateMahnungenSerienbriefCsvFileCommand(
                    semesterrechnungenTableModel.getSelektierteSemesterrechnungen(),
                    Rechnungstyp.VORRECHNUNG,
                    outputFile);
      ...
      case MAHNUNGEN_NACHRECHNUNGEN_SERIENBRIEF -> {
        CreateMahnungenSerienbriefCsvFileCommand
            createMahnungenNachrechnungenSerienbriefCsvFileCommand =
                new CreateMahnungenSerienbriefCsvFileCommand(
                    semesterrechnungenTableModel.getSelektierteSemesterrechnungen(),
                    Rechnungstyp.NACHRECHNUNG,
                    outputFile);
      ...
      case SEMESTERRECHNUNGEN_ADRESSETIKETTEN -> {
        ...
        for (Semesterrechnung semesterrechnung :
            semesterrechnungenTableModel.getSelektierteSemesterrechnungen()) {
          rechnungsempfaengerSemesterrechnungSet.add(semesterrechnung.getRechnungsempfaenger());
        }
        List<Person> rechnungsempfaengerSemesterrechnungList =
            new ArrayList<>(rechnungsempfaengerSemesterrechnungSet);
        Collections.sort(rechnungsempfaengerSemesterrechnungList);
        CreateAdressenCsvFileCommand
            createAdressenCsvFileCommandRechnungsempfaengerSemesterrechnung =
                new CreateAdressenCsvFileCommand(
                    rechnungsempfaengerSemesterrechnungList, outputFile);
      ...
      case RECHNUNGSLISTE -> {
        ...
        CreateRechnungslisteCsvFileCommand createRechnungslisteCsvFileCommand =
            new CreateRechnungslisteCsvFileCommand(
                semesterrechnungenTableModel.getSelektierteSemesterrechnungen(),
                previousSemester3,
                outputFile);
  ...
  private Semester findPreviousSemester(SemesterrechnungenTableModel semesterrechnungenTableModel) {
    ...
    if (semesterrechnungenTableModel.getSelektierteSemesterrechnungen().isEmpty()) {
      ...
      currentSemester =
          semesterrechnungenTableModel.getSelektierteSemesterrechnungen().get(0).getSemester();
    }
  ...
  public String getTitleInit(SchuelerSuchenTableModel schuelerSuchenTableModel) {
    ...
    switch (listentyp) {
      case SCHUELER_ADRESSLISTE -> {
        if (schuelerSuchenTableModel.isKursFuerSucheBeruecksichtigen()
            && schuelerSuchenTableModel.getLehrkraft() != null) {
      ...
      case ELTERNMITHILFE_LISTE -> {
        ...
        if (schuelerSuchenTableModel.getElternmithilfeCode() != null) {
          titleInit =
              titleInit + " " + schuelerSuchenTableModel.getElternmithilfeCode().getBeschreibung();
        }
        if (schuelerSuchenTableModel.getGruppe() != null) {
          titleInit = titleInit + " Gruppe " + schuelerSuchenTableModel.getGruppe().toString();
        }
  ...
  private String getTitleSpecificKurs(SchuelerSuchenTableModel schuelerSuchenTableModel) {
    if (schuelerSuchenTableModel.getWochentag() != null
        && schuelerSuchenTableModel.getZeitBeginn() != null) {
      CommandInvoker commandInvoker = getCommandInvoker();
      FindKursCommand findKursCommand =
          new FindKursCommand(
              schuelerSuchenTableModel.getSemester(),
              schuelerSuchenTableModel.getWochentag(),
              schuelerSuchenTableModel.getZeitBeginn(),
              schuelerSuchenTableModel.getLehrkraft());
      ...
      return Mitarbeiter.getMitarbeiterAsStr(lehrkraefte)
          ...
          + " "
          + asString(kursFound.getZeitBeginn())
          + "-"
          + asString(kursFound.getZeitEnde())
          + ", "
          + kursFound.getKursort().getBezeichnung()
          + ", "
          + kursFound.getStufe()
          + ")";
    } else {
  ...
  private boolean checkIfRechnungsdatumVorrechnungUeberallGesetzt(
      SemesterrechnungenTableModel semesterrechnungenTableModel) {
    for (Semesterrechnung semesterrechnung :
        semesterrechnungenTableModel.getSelektierteSemesterrechnungen()) {
  ...
  @SuppressWarnings("BooleanMethodIsAlwaysInverted")
  private boolean checkIfRechnungsdatumNachrechnungUeberallGesetzt(
      SemesterrechnungenTableModel semesterrechnungenTableModel) {
    for (Semesterrechnung semesterrechnung :
        semesterrechnungenTableModel.getSelektierteSemesterrechnungen()) {
