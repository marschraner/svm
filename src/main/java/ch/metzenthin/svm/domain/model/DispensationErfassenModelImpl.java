...
public class DispensationErfassenModelImpl extends AbstractModel
  ...
  private final CalendarModelAttribute dispensationsbeginnModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DISPENSATIONSBEGINN,
          getNYearsBeforeNow(5),
          getNYearsAfterNow(5),
  ...
  public void setDispensationsbeginn(String dispensationsbeginn) throws SvmValidationException {
    ...
    if (!isBulkUpdate()
        && dispensation.getDispensationsbeginn() != null
        && dispensation.getDispensationsende() != null
        && dispensation.getDispensationsbeginn().after(dispensation.getDispensationsende())) {
  ...
  private final CalendarModelAttribute dispensationsendeModelAttribute =
      new CalendarModelAttribute(
          this,
  ...
  private final StringModelAttribute voraussichtlicheDauerModelAttribute =
  ...
  private final StringModelAttribute grundModelAttribute =
      new StringModelAttribute(
          this,
          Field.GRUND,
          5,
  ...
  @Override
  public boolean checkDispensationUeberlapptAndereDispensationen(
    ...
    CheckDispensationUeberlapptAndereDispensationenCommand
        checkDispensationUeberlapptAndereDispensationenCommand =
            new CheckDispensationUeberlapptAndereDispensationenCommand(
                dispensation,
                dispensationOrigin,
                schuelerDatenblattModel.getSchueler().getDispensationen());
  ...
  public void speichern(
    ...
    AddDispensationToSchuelerAndSaveCommand addDispensationToSchuelerAndSaveCommand =
        new AddDispensationToSchuelerAndSaveCommand(
            this.getDispensation(), dispensationOrigin, schuelerDatenblattModel.getSchueler());
  ...
  void doValidate() throws SvmValidationException {
    if (dispensation.getDispensationsbeginn() == null) {
      throw new SvmValidationException(
          2010, "Dispensationsbeginn obligatorisch", Field.DISPENSATIONSBEGINN);
    }
