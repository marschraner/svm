...
public class AngehoerigerModelImpl extends PersonModelImpl implements AngehoerigerModel {
  ...
  public boolean isCompleted() {
    if (isSetName()
        && (angehoeriger.getWuenschtEmails() != null && angehoeriger.getWuenschtEmails())
  ...
  public void doValidate() throws SvmValidationException {
    if (angehoeriger.getWuenschtEmails() != null
  ...
  public void initializeCompleted() {
    if (angehoerigerOrigin != null) {
      ...
      try {
        ...
        isRechnungsempfaenger =
            !isRechnungsempfaengerOrigin; // damit PropertyChange ausgelöst wird!
        setIsRechnungsempfaenger(isRechnungsempfaengerOrigin);
        isGleicheAdresseWieSchueler =
            !isGleicheAdresseWieSchuelerOrigin; // damit PropertyChange ausgelöst wird!
        setIsGleicheAdresseWieSchueler(isGleicheAdresseWieSchuelerOrigin);
        if (angehoerigerOrigin.getWuenschtEmails() != null) {
          setWuenschtEmails(
              !angehoerigerOrigin.getWuenschtEmails()); // damit PropertyChange ausgelöst wird!
        }
