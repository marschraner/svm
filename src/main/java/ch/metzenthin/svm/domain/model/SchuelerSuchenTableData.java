...
public class SchuelerSuchenTableData {
  ...
  public SchuelerSuchenTableData(
      List<Schueler> schuelerList,
      Map<Schueler, List<Kurs>> kurse,
      Semester semester,
      Wochentag wochentag,
      Time zeitBeginn,
      ...
      boolean kursFuerSucheBeruecksichtigen,
      boolean maerchenFuerSucheBeruecksichtigen,
      boolean nachRollenGesucht,
      Calendar stichtag,
  ...
  private void initColumns() {
    ...
    if ((semester != null
        ...
        || (maerchenFuerSucheBeruecksichtigen && !kursFuerSucheBeruecksichtigen)) {
  ...
  public int getAnzZuExportierendeMaercheneinteilungen() {
    ...
    for (Map.Entry<Schueler, Maercheneinteilung> mearcheneinteilungEntry :
