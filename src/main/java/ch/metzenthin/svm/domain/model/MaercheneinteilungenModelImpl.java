...
class MaercheneinteilungenModelImpl extends AbstractModel implements MaercheneinteilungenModel {
  ...
  @Override
  public MaercheneinteilungErfassenModel getMaercheneinteilungErfassenModel(
    ...
    MaercheneinteilungErfassenModel maercheneinteilungErfassenModel =
        svmContext.getModelFactory().createMaercheneinteilungErfassenModel();
    Maercheneinteilung maercheneinteilungSelected =
        maercheneinteilungenTableModel.getMaercheneinteilungSelected(rowSelected);
  ...
  @Override
  public void maercheneinteilungLoeschen(
      MaercheneinteilungenTableModel maercheneinteilungenTableModel,
    ...
    DeleteMaercheneinteilungCommand deleteMaercheneinteilungCommand =
        new DeleteMaercheneinteilungCommand(
            schuelerDatenblattModel.getSchueler().getSortedMaercheneinteilungen(), rowSelected);
  ...
  @Override
  public List<Maerchen> getSelectableMaerchens(
    ...
    for (Maerchen maerchen : selectableMaerchens) {
      for (Maercheneinteilung maercheneinteilung :
          schuelerDatenblattModel.getSchueler().getMaercheneinteilungen()) {
