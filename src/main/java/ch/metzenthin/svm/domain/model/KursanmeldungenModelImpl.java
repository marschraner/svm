...
class KursanmeldungenModelImpl extends AbstractModel implements KursanmeldungenModel {
  ...
  @Override
  public KursanmeldungErfassenModel getKursanmeldungErfassenModel(
    ...
    KursanmeldungErfassenModel kursanmeldungErfassenModel =
        svmContext.getModelFactory().createKursanmeldungErfassenModel();
    Kursanmeldung kursanmeldungSelected =
        kursanmeldungenTableModel.getKursanmeldungSelected(rowSelected);
    kursanmeldungErfassenModel.setKursanmeldungOrigin(kursanmeldungSelected);
    return kursanmeldungErfassenModel;
  }

  @Override
  public void kursanmeldungLoeschen(
    ...
    DeleteKursanmeldungCommand deleteKursanmeldungCommand =
        new DeleteKursanmeldungCommand(
            schuelerDatenblattModel.getSchueler().getSortedKursanmeldungen(), rowSelected);
  ...
  */
  @Override
  public Calendar getSpaetestesAbmeldedatumKurseNeustesSemester(
      SchuelerDatenblattModel schuelerDatenblattModel) {
    ...
    List<Kursanmeldung> kursanmeldungenNeustesSemester =
        getKursanmeldungenNeustesSemester(kursanmeldungen, neustesSemester);
  ...
  private List<Kursanmeldung> getKursanmeldungenNeustesSemester(
      Collection<Kursanmeldung> kursanmeldungen, Semester neustesSemester) {
    ...
    for (Kursanmeldung kursanmeldung : kursanmeldungen) {
      if (kursanmeldung
          ...
          .getSemester()
          .getSemesterId()
          .equals(neustesSemester.getSemesterId())) {
  ...
  @Override
  public void schuelerVomKinderUndJugendtheaterAbmelden(
