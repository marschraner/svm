...
public class SemestersModelImpl extends AbstractModel implements SemestersModel {
  ...
  @Override
  public SemesterErfassenModel getSemesterErfassenModel(
      SvmContext svmContext, int indexSemesterToBeModified) {
  ...
  @Override
  public DeleteSemesterCommand.Result semesterLoeschen(
      SvmContext svmContext,
      SemestersTableModel semestersTableModel,
      int indexSemesterToBeRemoved) {
    List<Semester> semesters = semestersTableModel.getSemestersTableData().getSemesters();
    CommandInvoker commandInvoker = getCommandInvoker();
    DeleteSemesterCommand deleteSemesterCommand =
        new DeleteSemesterCommand(semesters, indexSemesterToBeRemoved);
    ...
    semestersTableModel
        ...
        .setSemesters(svmContext.getSvmModel().getSemestersAll());
