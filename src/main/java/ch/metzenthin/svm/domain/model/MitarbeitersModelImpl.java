...
public class MitarbeitersModelImpl extends AbstractModel implements MitarbeitersModel {
  ...
  @Override
  public MitarbeiterErfassenModel getMitarbeiterErfassenModel(
      SvmContext svmContext,
      MitarbeitersTableModel mitarbeitersTableModel,
      int indexMitarbeiterToBeModified) {
    ...
    List<Mitarbeiter> mitarbeiters =
        mitarbeitersTableModel.getMitarbeitersTableData().mitarbeiters();
  ...
  @Override
  public DeleteMitarbeiterCommand.Result mitarbeiterLoeschen(
      MitarbeitersTableModel mitarbeitersTableModel, int indexMitarbeiterToBeRemoved) {
    List<Mitarbeiter> mitarbeiters = mitarbeitersTableModel.getMitarbeiters();
    CommandInvoker commandInvoker = getCommandInvoker();
    DeleteMitarbeiterCommand deleteMitarbeiterCommand =
        new DeleteMitarbeiterCommand(mitarbeiters, indexMitarbeiterToBeRemoved);
  ...
  public CallDefaultEmailClientCommand.Result callEmailClient(
    ...
    CallDefaultEmailClientCommand callDefaultEmailClientCommand =
        new CallDefaultEmailClientCommand(emailAdressen, false);
