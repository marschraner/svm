...
public class KursorteModelImpl extends AbstractModel implements KursorteModel {
  ...
  @Override
  public DeleteKursortCommand.Result eintragLoeschen(
    ...
    DeleteKursortCommand deleteKursortCommand =
        new DeleteKursortCommand(kursorte, indexKursortToBeRemoved);
  ...
  @Override
  public KursortErfassenModel getKursortErfassenModel(
