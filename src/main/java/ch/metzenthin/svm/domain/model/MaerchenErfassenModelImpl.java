...
public class MaerchenErfassenModelImpl extends AbstractModel implements MaerchenErfassenModel {
  ...
  private final IntegerModelAttribute anzahlVorstellungenModelAttribute =
  ...
  public boolean checkMaerchenBereitsErfasst(SvmModel svmModel) {
    ...
    CheckMaerchenBereitsErfasstCommand checkMaerchenBereitsErfasstCommand =
        new CheckMaerchenBereitsErfasstCommand(
            maerchen, maerchenOrigin, svmModel.getMaerchensAll());
  ...
  public String getNaechstesNochNichtErfasstesSchuljahrMaerchen(SvmModel svmModel) {
    CommandInvoker commandInvoker = getCommandInvoker();
    DetermineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand
        determineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand =
            new DetermineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand(
                svmModel.getMaerchensAll());
    commandInvoker.executeCommand(determineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand);
    return determineNaechstesNochNichtErfasstesSchuljahrMaerchenCommand
        .getNaechstesNochNichtErfasstesSchuljahrMaerchen();
  }
  ...
  public void speichern(SvmModel svmModel, MaerchensTableModel maerchensTableModel) {
    ...
    SaveOrUpdateMaerchenCommand saveOrUpdateMaerchenCommand =
        new SaveOrUpdateMaerchenCommand(maerchen, maerchenOrigin, svmModel.getMaerchensAll());
