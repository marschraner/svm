 ...
 */
public class MaercheneinteilungErfassenModelImpl extends PersonModelImpl
  ...
  private final StringModelAttribute rolle1ModelAttribute =
  ...
  private final StringModelAttribute bilderRolle1ModelAttribute =
      new StringModelAttribute(
          this,
          Field.BILDER_ROLLE1,
          1,
  ...
  private final StringModelAttribute rolle2ModelAttribute =
      new StringModelAttribute(
          this,
          Field.ROLLE2,
          1,
  ...
  private final StringModelAttribute bilderRolle2ModelAttribute =
      new StringModelAttribute(
          this,
          Field.BILDER_ROLLE2,
          1,
  ...
  private final StringModelAttribute rolle3ModelAttribute =
      new StringModelAttribute(
          this,
          Field.ROLLE3,
          1,
  ...
  private final StringModelAttribute bilderRolle3ModelAttribute =
      new StringModelAttribute(
          this,
          Field.BILDER_ROLLE3,
          1,
  ...
  public Maerchen getMaerchenInit(List<Maerchen> selectableMaerchens) {
    DetermineMaerchenInitCommand determineMaerchenInitCommand =
        new DetermineMaerchenInitCommand(selectableMaerchens);
  ...
  public boolean checkIfMaerchenIsInPast() {
    ...
    int schuljahr1Maerchen =
        Integer.parseInt(maercheneinteilung.getMaerchen().getSchuljahr().substring(0, 4));
    return schuljahr1Maerchen < schuljahr1;
  }

  @Override
  public Elternmithilfe[] getSelectableElternmithilfen(
  ...
  public ElternmithilfeCode[] getSelectableElternmithilfeCodes(SvmModel svmModel) {
    List<ElternmithilfeCode> elternmithilfeCodeList =
        svmModel.getSelektierbareElternmithilfeCodesAll();
    ...
    if (maercheneinteilungOrigin != null
        && maercheneinteilungOrigin.getElternmithilfeCode() != null) {
      // Beim Bearbeiten muss ggf auch ein nicht mehr selektierbarer Elternmithilfe-Code angezeigt
      // werden können
      boolean found = false;
  ...
  public boolean checkIfElternmithilfeHasEmail(SchuelerDatenblattModel schuelerDatenblattModel) {
    ...
    if (maercheneinteilung.getElternmithilfe() == Elternmithilfe.MUTTER
      ...
      return maercheneinteilung.getElternmithilfe() != Elternmithilfe.VATER
  ...
  public List<Maercheneinteilung>
    ...
    CheckElternmithilfeBereitsBeiGeschwisterErfasstCommand
        checkElternmithilfeBereitsBeiGeschwisterErfasstCommand =
            new CheckElternmithilfeBereitsBeiGeschwisterErfasstCommand(schueler, getMaerchen());
  ...
  public void speichern(
    ...
    if (elternmithilfeCode != null
        && elternmithilfeCode.isIdenticalWith(ELTERNMITHILFE_CODE_KEINER)) {
    ...
    SaveOrUpdateMaercheneinteilungCommand saveOrUpdateMaercheneinteilungCommand =
        new SaveOrUpdateMaercheneinteilungCommand(
            maercheneinteilung,
    ...
    maercheneinteilungenTableModel
        .getMaercheneinteilungenTableData()
    ...
    if (maercheneinteilungOrigin != null) {
      ...
      try {
        ...
        ElternmithilfeDrittperson eltermithilfeDrittpersonOrigin =
            maercheneinteilungOrigin.getElternmithilfeDrittperson();
        if (eltermithilfeDrittpersonOrigin != null) {
          ...
          if (eltermithilfeDrittpersonOrigin.getAdresse() != null) {
            setStrasseHausnummer(
                eltermithilfeDrittpersonOrigin.getAdresse().getStrasseHausnummer());
  ...
  public void doValidate() throws SvmValidationException {
    ...
    if (isSetElternmithilfe() && !isSetElternmithilfeCode()) {
      throw new SvmValidationException(
          3007, "Kein Eltern-Mithilfe-Code ausgewählt", Field.ELTERNMITHILFE_CODE);
    }
    if (isSetElternmithilfeCode() && !isSetElternmithilfe()) {
      throw new SvmValidationException(
          3008, "Keine Eltern-Mithilfe ausgewählt", Field.ELTERNMITHILFE);
    }
