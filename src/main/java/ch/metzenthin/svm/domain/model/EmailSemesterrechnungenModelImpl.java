 ...
 */
public class EmailSemesterrechnungenModelImpl extends AbstractModel
    implements EmailSemesterrechnungenModel {
  ...
  public CallDefaultEmailClientCommand.Result callEmailClient(
    ...
    for (Semesterrechnung semesterrechnung :
      ...
      if (mutterUndOderVaterSelected
          || (rechnungsempfaengerSelected && emailAdressenSemesterrechnung.isEmpty())) {
      ...
      if (!emailAdressenSemesterrechnung.isEmpty()) {
        ...
        fehlendeEmailAdressen.add(
            rechnungsempfaenger.getNachname() + " " + rechnungsempfaenger.getVorname());
      }
    }
