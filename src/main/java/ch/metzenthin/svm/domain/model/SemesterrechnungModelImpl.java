...
abstract class SemesterrechnungModelImpl extends AbstractModel implements SemesterrechnungModel {
  ...
  private final CalendarModelAttribute rechnungsdatumVorrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.RECHNUNGSDATUM_VORRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 1),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
  ...
  @Override
  public void setRechnungsdatumVorrechnung(String rechnungsdatumVorrechnung)
      throws SvmValidationException {
    rechnungsdatumVorrechnungModelAttribute.setNewValue(
        false, rechnungsdatumVorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute ermaessigungVorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.ERMAESSIGUNG_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setErmaessigungVorrechnung(String ermaessigungVorrechnung)
      throws SvmValidationException {
    ermaessigungVorrechnungModelAttribute.setNewValue(
        false, ermaessigungVorrechnung, isBulkUpdate());
  }

  private final StringModelAttribute ermaessigungsgrundVorrechnungModelAttribute =
      new StringModelAttribute(
          this,
          Field.ERMAESSIGUNGSGRUND_VORRECHNUNG,
          5,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  public void setErmaessigungsgrundVorrechnung(String ermaessigungsgrundVorrechnung)
      throws SvmValidationException {
    ermaessigungsgrundVorrechnungModelAttribute.setNewValue(
        false, ermaessigungsgrundVorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute zuschlagVorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.ZUSCHLAG_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  private final StringModelAttribute zuschlagsgrundVorrechnungModelAttribute =
      new StringModelAttribute(
          this,
          Field.ZUSCHLAGSGRUND_VORRECHNUNG,
          5,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  public void setZuschlagsgrundVorrechnung(String zuschlagsgrundVorrechnung)
      throws SvmValidationException {
    zuschlagsgrundVorrechnungModelAttribute.setNewValue(
        false, zuschlagsgrundVorrechnung, isBulkUpdate());
  }

  private final IntegerModelAttribute anzahlWochenVorrechnungModelAttribute =
      new IntegerModelAttribute(
          this,
          Field.ANZAHL_WOCHEN_VORRECHNUNG,
          1,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setAnzahlWochenVorrechnung(String anzahlWochenVorrechnung)
      throws SvmValidationException {
    anzahlWochenVorrechnungModelAttribute.setNewValue(
        false, anzahlWochenVorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute wochenbetragVorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.WOCHENBETRAG_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setWochenbetragVorrechnung(String wochenbetragVorrechnung)
      throws SvmValidationException {
    wochenbetragVorrechnungModelAttribute.setNewValue(
        false, wochenbetragVorrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung1VorrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_1_VORRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 1),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setDatumZahlung1Vorrechnung(String datumZahlung1Vorrechnung)
      throws SvmValidationException {
    datumZahlung1VorrechnungModelAttribute.setNewValue(
        false, datumZahlung1Vorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung1VorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_1_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung1Vorrechnung(String betragZahlung1Vorrechnung)
      throws SvmValidationException {
    betragZahlung1VorrechnungModelAttribute.setNewValue(
        false, betragZahlung1Vorrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung2VorrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_2_VORRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 2),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
            public Calendar getValue() {
  ...
  @Override
  public void setDatumZahlung2Vorrechnung(String datumZahlung2Vorrechnung)
      throws SvmValidationException {
    datumZahlung2VorrechnungModelAttribute.setNewValue(
        false, datumZahlung2Vorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung2VorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_2_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung2Vorrechnung(String betragZahlung2Vorrechnung)
      throws SvmValidationException {
    betragZahlung2VorrechnungModelAttribute.setNewValue(
        false, betragZahlung2Vorrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung3VorrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_3_VORRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 3),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
            public Calendar getValue() {
  ...
  @Override
  public void setDatumZahlung3Vorrechnung(String datumZahlung3Vorrechnung)
      throws SvmValidationException {
    datumZahlung3VorrechnungModelAttribute.setNewValue(
        false, datumZahlung3Vorrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung3VorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_3_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung3Vorrechnung(String betragZahlung3Vorrechnung)
      throws SvmValidationException {
    betragZahlung3VorrechnungModelAttribute.setNewValue(
        false, betragZahlung3Vorrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute rechnungsdatumNachrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.RECHNUNGSDATUM_NACHRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 1),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setRechnungsdatumNachrechnung(String rechnungsdatumNachrechnung)
      throws SvmValidationException {
    rechnungsdatumNachrechnungModelAttribute.setNewValue(
        false, rechnungsdatumNachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute ermaessigungNachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.ERMAESSIGUNG_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setErmaessigungNachrechnung(String ermaessigungNachrechnung)
      throws SvmValidationException {
    ermaessigungNachrechnungModelAttribute.setNewValue(
        false, ermaessigungNachrechnung, isBulkUpdate());
  }

  private final StringModelAttribute ermaessigungsgrundNachrechnungModelAttribute =
      new StringModelAttribute(
          this,
          Field.ERMAESSIGUNGSGRUND_NACHRECHNUNG,
          5,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  public void setErmaessigungsgrundNachrechnung(String ermaessigungsgrundNachrechnung)
      throws SvmValidationException {
    ermaessigungsgrundNachrechnungModelAttribute.setNewValue(
        false, ermaessigungsgrundNachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute zuschlagNachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.ZUSCHLAG_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  private final StringModelAttribute zuschlagsgrundNachrechnungModelAttribute =
      new StringModelAttribute(
          this,
          Field.ZUSCHLAGSGRUND_NACHRECHNUNG,
          5,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  public void setZuschlagsgrundNachrechnung(String zuschlagsgrundNachrechnung)
      throws SvmValidationException {
    zuschlagsgrundNachrechnungModelAttribute.setNewValue(
        false, zuschlagsgrundNachrechnung, isBulkUpdate());
  }

  private final IntegerModelAttribute anzahlWochenNachrechnungModelAttribute =
      new IntegerModelAttribute(
          this,
          Field.ANZAHL_WOCHEN_NACHRECHNUNG,
          1,
          50,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setAnzahlWochenNachrechnung(String anzahlWochenNachrechnung)
      throws SvmValidationException {
    anzahlWochenNachrechnungModelAttribute.setNewValue(
        false, anzahlWochenNachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute wochenbetragNachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.WOCHENBETRAG_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setWochenbetragNachrechnung(String wochenbetragNachrechnung)
      throws SvmValidationException {
    wochenbetragNachrechnungModelAttribute.setNewValue(
        false, wochenbetragNachrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung1NachrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_1_NACHRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 1),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setDatumZahlung1Nachrechnung(String datumZahlung1Nachrechnung)
      throws SvmValidationException {
    datumZahlung1NachrechnungModelAttribute.setNewValue(
        false, datumZahlung1Nachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung1NachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_1_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung1Nachrechnung(String betragZahlung1Nachrechnung)
      throws SvmValidationException {
    betragZahlung1NachrechnungModelAttribute.setNewValue(
        false, betragZahlung1Nachrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung2NachrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_2_NACHRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 2),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setDatumZahlung2Nachrechnung(String datumZahlung2Nachrechnung)
      throws SvmValidationException {
    datumZahlung2NachrechnungModelAttribute.setNewValue(
        false, datumZahlung2Nachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung2NachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_2_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung2Nachrechnung(String betragZahlung2Nachrechnung)
      throws SvmValidationException {
    betragZahlung2NachrechnungModelAttribute.setNewValue(
        false, betragZahlung2Nachrechnung, isBulkUpdate());
  }

  private final CalendarModelAttribute datumZahlung3NachrechnungModelAttribute =
      new CalendarModelAttribute(
          this,
          Field.DATUM_ZAHLUNG_3_NACHRECHNUNG,
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MIN, Calendar.JANUARY, 3),
          new GregorianCalendar(Schuljahre.SCHULJAHR_VALID_MAX, Calendar.DECEMBER, 31),
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setDatumZahlung3Nachrechnung(String datumZahlung3Nachrechnung)
      throws SvmValidationException {
    datumZahlung3NachrechnungModelAttribute.setNewValue(
        false, datumZahlung3Nachrechnung, isBulkUpdate());
  }

  private final PreisModelAttribute betragZahlung3NachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.BETRAG_ZAHLUNG_3_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setBetragZahlung3Nachrechnung(String betragZahlung3Nachrechnung)
      throws SvmValidationException {
    betragZahlung3NachrechnungModelAttribute.setNewValue(
        false, betragZahlung3Nachrechnung, isBulkUpdate());
  }
