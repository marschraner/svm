...
public class IntegerModelAttribute {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(IntegerModelAttribute.class);
  ...
  IntegerModelAttribute(
      ModelAttributeListener modelAttributeListener,
      Field field,
      int minValidValue,
      int maxValidValue,
      AttributeAccessor<Integer> attributeAccessor) {
