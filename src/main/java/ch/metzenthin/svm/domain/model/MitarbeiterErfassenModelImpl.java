...
public class MitarbeiterErfassenModelImpl extends PersonModelImpl
  ...
  private final StringModelAttribute ahvNummerModelAttribute =
  ...
  private final StringModelAttribute ibanNummerModelAttribute =
      new StringModelAttribute(
          this,
          Field.IBAN_NUMMER,
          15,
  ...
  public void setIbanNummer(String ibanNummer) throws SvmValidationException {
    if (!isBulkUpdate()
        && checkNotEmpty(ibanNummer)
        && !IBAN_NUMMER_VALIDATOR.isValid(ibanNummer)) {
      invalidate();
  ...
  public void setVertretungsmoeglichkeiten(String vertretungsmoeglichkeiten)
    ...
    vertretungsmoeglichkeitenModelAttribute.setNewValue(
        false, vertretungsmoeglichkeiten, isBulkUpdate());
  }
  ...
  public void setAktiv(Boolean isSelected) {
    boolean oldValue = mitarbeiter.isAktiv();
  ...
  public String getCodesAsStr() {
    ...
    StringBuilder mitarbeiterCodesAsStr =
        new StringBuilder(getMitarbeiterCodesAsList().get(0).getKuerzel());
  ...
  public boolean checkMitarbeiterBereitsErfasst(SvmModel svmModel) {
    ...
    CheckMitarbeiterBereitsErfasstCommand checkMitarbeiterBereitsErfasstCommand =
        new CheckMitarbeiterBereitsErfasstCommand(
            mitarbeiter, mitarbeiterOrigin, svmModel.getMitarbeitersAll());
  ...
  public void speichern(SvmModel svmModel, MitarbeitersTableModel mitarbeitersTableModel) {
    ...
    SaveOrUpdateMitarbeiterCommand saveOrUpdateMitarbeiterCommand =
        new SaveOrUpdateMitarbeiterCommand(
            ...
            mitarbeiterCodes,
            mitarbeiterOrigin,
            mitarbeitersTableModel.getMitarbeiters());
  ...
  public void initializeCompleted() {
    if (mitarbeiterOrigin != null) {
      ...
      try {
        ...
        setAktiv(!mitarbeiterOrigin.isAktiv()); // damit PropertyChange ausgelöst wird!
        setAktiv(mitarbeiterOrigin.isAktiv());
