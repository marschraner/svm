...
public class SemesterrechnungenTableData {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    ...
    switch (columns.get(columnIndex)) {
      ...
      case RECHNUNGSEMPFAENGER ->
          value =
              semesterrechnung.getRechnungsempfaenger().getNachname()
                  + " "
                  + semesterrechnung.getRechnungsempfaenger().getVorname();
      case SCHUELER ->
  ...
  public Class<?> getColumnClass(int columnIndex) {
    return switch (columns.get(columnIndex)) {
      ...
      case RECHNUNGSDATUM_VORRECHNUNG, RECHNUNGSDATUM_NACHRECHNUNG -> Calendar.class;
      case ANZAHL_WOCHEN_VORRECHNUNG, ANZAHL_WOCHEN_NACHRECHNUNG -> Integer.class;
      case WOCHENBETRAG_VORRECHNUNG,
