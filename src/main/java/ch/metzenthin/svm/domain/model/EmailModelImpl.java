...
public class EmailModelImpl extends AbstractModel implements EmailModel {
  ...
  @Override
  public EmailEmpfaenger[] getSelectableEmailEmpfaengers(
  ...
  public CallDefaultEmailClientCommand.Result callEmailClient(
    ...
    String emailClientMultipleMailsSeparator =
        svmProperties.getProperty(SvmProperties.KEY_EMAIL_CLIENT_MULTIPLE_MAILS_SEPARATOR);
    ...
    CallDefaultEmailClientCommand callDefaultEmailClientCommand =
        new CallDefaultEmailClientCommand(emailAdresse, false);
