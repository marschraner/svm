...
public class SchuelerDatenblattModelImpl implements SchuelerDatenblattModel {
  ...
  public SchuelerDatenblattModelImpl(Schueler schueler) {
    ...
    this.aktuelleMaercheneinteilung =
        determineAktuelleMaercheneinteilung(schueler.getSortedMaercheneinteilungen());
  ...
  public String getLabelRechnungsempfaenger() {
    return (schueler.getRechnungsempfaenger().getAnrede() == Anrede.FRAU
  ...
  public String getGeschwisterAsString() {
    CheckGeschwisterSchuelerRechnungempfaengerCommand command =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(
            schueler, isRechnungsempfaengerDrittperson());
    command.execute();
  ...
  public String getLabelSchuelerGleicherRechnungsempfaenger1() {
    return "Andere Schüler mit "
        + (schueler.getRechnungsempfaenger().getAnrede() == Anrede.FRAU ? "gleicher" : "gleichem");
  }
  ...
  public String getSchuelerGleicherRechnungsempfaengerAsString() {
    CheckGeschwisterSchuelerRechnungempfaengerCommand command =
        new CheckGeschwisterSchuelerRechnungempfaengerCommand(schueler);
    command.execute();
    List<Schueler> schuelerList =
        command.getAndereSchuelerMitVaterMutterOderDrittpersonAlsRechnungsempfaengerList();
  ...
  public String getDispensationsdauerAsString() {
    ...
    if (!dispensationen.isEmpty()) {
      Dispensation dispensation =
          (neusteZuoberst ? dispensationen.get(0) : dispensationen.get(dispensationen.size() - 1));
      if (isDispensationAktuell(dispensation)) {
        ...
        if (dispensation.getDispensationsende() == null) {
          ...
          dauer =
              asString(dispensation.getDispensationsbeginn())
                  + " - "
                  + asString(dispensation.getDispensationsende());
        }
        return dauer;
      }
    }
  ...
  public String getFruehereDispensationenAsString() {
    ...
    for (Dispensation dispensation : dispensationen) {
      if (!isDispensationAktuell(dispensation) && isDispensationToBeDisplayed(dispensation)) {
        ...
        fruehereDispensationen
            .append(asString(dispensation.getDispensationsbeginn()))
            .append(" - ")
            .append(asString(dispensation.getDispensationsende()))
            .append(" (")
            .append(dispensation.getGrund())
            .append(")");
      }
    }
  ...
  private boolean isDispensationToBeDisplayed(Dispensation dispensation) {
    ...
    return minSemesterEnde.before(dispensation.getDispensationsende())
        || minSemesterEnde.equals(dispensation.getDispensationsende());
  }
  ...
  public String getSemesterKurseAsString(SvmModel svmModel) {
    if (!schueler.getKursanmeldungen().isEmpty()) {
      FindSemesterForCalendarCommand findSemesterForCalendarCommand =
          new FindSemesterForCalendarCommand(svmModel.getSemestersAll());
      ...
      for (Kursanmeldung kursanmeldung : schueler.getSortedKursanmeldungen()) {
        ...
        gleichesSemester =
            previousSchuljahr != null
                && previousSemesterbezeichnung != null
        ...
        if (!gleichesSemester) {
          semesterSb
              .append(kurs.getSemester().getSchuljahr())
              .append(", ")
              .append(kurs.getSemester().getSemesterbezeichnung())
              .append(":");
        }
  ...
  private boolean isKursToBeDisplayed(
      Kurs kurs, Semester previousSemester, Semester currentSemester, Semester nextSemester) {
    return (currentSemester != null
            && kurs.getSemester().getSemesterId().equals(currentSemester.getSemesterId()))
        // bereits erfasstes nächstes Semester
        || (nextSemester != null
            && kurs.getSemester().getSemesterId().equals(nextSemester.getSemesterId()))
        // zwischen zwei Semestern
        || (currentSemester == null
            && previousSemester != null
            && kurs.getSemester().getSemesterId().equals(previousSemester.getSemesterId()));
  }
  ...
  public String getBilderRolle1() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getBilderRolle1() == null) {
      return "-";
    }
  ...
  public String getBilderRolle2() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getBilderRolle2() == null) {
      return "-";
    }
  ...
  public String getBilderRolle3() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getBilderRolle3() == null) {
      return "-";
    }
  ...
  public String getElternmithilfe() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getElternmithilfe() == null) {
      return "-";
    }
  ...
  public String getElternmithilfeCode() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getElternmithilfeCode() == null) {
      return "-";
    }
  ...
  public String getKuchenVorstellungenAsString() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getKuchenVorstellungenAsString().isEmpty()) {
      return "-";
    }
  ...
  public String getZusatzattribut() {
    if (aktuelleMaercheneinteilung == null
        || aktuelleMaercheneinteilung.getZusatzattribut() == null) {
      return "-";
    }
  ...
  private Maercheneinteilung determineAktuelleMaercheneinteilung(
      List<Maercheneinteilung> maercheneinteilungen) {
  ...
  private boolean isDispensationAktuell(Dispensation dispensation) {
    ...
    return dispensation.getDispensationsende() == null
        || dispensation.getDispensationsende().equals(today)
        || dispensation.getDispensationsende().after(today);
  }
  ...
  public AngehoerigerModel getMutterModel(SvmContext svmContext) {
    ...
    mutterModel.setAngehoeriger(
        schueler.getMutter(),
        isGleicheAdresseWieSchueler(schueler.getMutter()),
  ...
  public AngehoerigerModel getVaterModel(SvmContext svmContext) {
    ...
    vaterModel.setAngehoeriger(
        schueler.getVater(),
        isGleicheAdresseWieSchueler(schueler.getVater()),
  ...
  @Override
  public void refreshSchuelerSuchenTableData(
    ...
    boolean keineAbgemeldetenKurseAnzeigen =
        schuelerSuchenTableModel.isKeineAbgemeldetenKurseAnzeigen();
    ...
    FindKurseMapSchuelerSemesterCommand findKurseMapSchuelerSemesterCommand =
        new FindKurseMapSchuelerSemesterCommand(
            ...
            mitarbeiter,
            stichtag,
            keineAbgemeldetenKurseAnzeigen,
            anmeldemonat,
            abmeldemonat);
    commandInvoker.executeCommand(findKurseMapSchuelerSemesterCommand);
    schuelerSuchenTableModel
        .getSchuelerSuchenTableData()
        .setKurse(findKurseMapSchuelerSemesterCommand.getKurseMap());
    ...
    schuelerSuchenTableModel
        .getSchuelerSuchenTableData()
        .setMaercheneinteilungen(
            findMaercheneinteilungenMapSchuelerSemesterCommand.getMaercheneinteilungenMap());
  }

  private boolean isGleicheAdresseWieSchueler(Angehoeriger angehoeriger) {
    return (angehoeriger != null)
        && (schueler.getAdresse().isIdenticalWith(angehoeriger.getAdresse()));
  }

  @Override
  public boolean checkIfStammdatenMitEmail() {
    return checkNotEmpty(schueler.getEmail())
        || schueler.getMutter() != null && checkNotEmpty(schueler.getMutter().getEmail())
