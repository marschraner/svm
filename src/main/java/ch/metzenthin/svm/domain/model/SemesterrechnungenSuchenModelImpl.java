...
final class SemesterrechnungenSuchenModelImpl extends SemesterrechnungModelImpl
    implements SemesterrechnungenSuchenModel {
  ...
  private PraezisierungRechnungsdatumVorrechnungSelected
  ...
  private PraezisierungRechnungsbetragVorrechnungSelected
  ...
  private PraezisierungRechnungsdatumNachrechnungSelected
      praezisierungRechnungsdatumNachrechnungSelected;
  private PraezisierungErmaessigungNachrechnungSelected
  ...
  private PraezisierungAnzahlWochenNachrechnungSelected
      praezisierungAnzahlWochenNachrechnungSelected;
  private PraezisierungWochenbetragNachrechnungSelected
      praezisierungWochenbetragNachrechnungSelected;
  private PraezisierungRechnungsbetragNachrechnungSelected
  ...
  private final StringModelAttribute nachnameModelAttribute =
  ...
  private final StringModelAttribute vornameModelAttribute =
      new StringModelAttribute(
          this,
          Field.VORNAME,
          1,
  ...
  @Override
  public void setSemesterrechnungCodeJaNeinSelected(
    ...
    firePropertyChange(
        Field.SEMESTERRECHNUNG_CODE_JA_NEIN, oldValue, this.semesterrechnungCodeJaNeinSelected);
  }
  ...
  @Override
  public void setRechnungsdatumGesetztVorrechnungSelected(
      RechnungsdatumGesetztVorrechnungSelected rechnungsdatumGesetztVorrechnungSelected) {
    RechnungsdatumGesetztVorrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.RECHNUNGSDATUM_GESETZT_VORRECHNUNG,
        oldValue,
        this.rechnungsdatumGesetztVorrechnungSelected);
  }

  @Override
  public PraezisierungRechnungsdatumVorrechnungSelected
      getPraezisierungRechnungsdatumVorrechnungSelected() {
    return praezisierungRechnungsdatumVorrechnungSelected;
  }

  @Override
  public void setPraezisierungRechnungsdatumVorrechnungSelected(
      PraezisierungRechnungsdatumVorrechnungSelected
          praezisierungRechnungsdatumVorrechnungSelected) {
    PraezisierungRechnungsdatumVorrechnungSelected oldValue =
        this.praezisierungRechnungsdatumVorrechnungSelected;
    this.praezisierungRechnungsdatumVorrechnungSelected =
        praezisierungRechnungsdatumVorrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_RECHNUNGSDATUM_VORRECHNUNG,
        oldValue,
        this.praezisierungRechnungsdatumVorrechnungSelected);
  }

  @Override
  public PraezisierungErmaessigungVorrechnungSelected
      getPraezisierungErmaessigungVorrechnungSelected() {
    return praezisierungErmaessigungVorrechnungSelected;
  }

  @Override
  public void setPraezisierungErmaessigungVorrechnungSelected(
      PraezisierungErmaessigungVorrechnungSelected praezisierungErmaessigungVorrechnungSelected) {
    PraezisierungErmaessigungVorrechnungSelected oldValue =
        this.praezisierungErmaessigungVorrechnungSelected;
    this.praezisierungErmaessigungVorrechnungSelected =
        praezisierungErmaessigungVorrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_ERMAESSIGUNG_VORRECHNUNG,
        oldValue,
        this.praezisierungErmaessigungVorrechnungSelected);
  }
  ...
  @Override
  public void setPraezisierungZuschlagVorrechnungSelected(
      PraezisierungZuschlagVorrechnungSelected praezisierungZuschlagVorrechnungSelected) {
    PraezisierungZuschlagVorrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.PRAEZISIERUNG_ZUSCHLAG_VORRECHNUNG,
        oldValue,
        this.praezisierungZuschlagVorrechnungSelected);
  }

  @Override
  public PraezisierungAnzahlWochenVorrechnungSelected
      getPraezisierungAnzahlWochenVorrechnungSelected() {
    return praezisierungAnzahlWochenVorrechnungSelected;
  }

  @Override
  public void setPraezisierungAnzahlWochenVorrechnungSelected(
      PraezisierungAnzahlWochenVorrechnungSelected praezisierungAnzahlWochenVorrechnungSelected) {
    PraezisierungAnzahlWochenVorrechnungSelected oldValue =
        this.praezisierungAnzahlWochenVorrechnungSelected;
    this.praezisierungAnzahlWochenVorrechnungSelected =
        praezisierungAnzahlWochenVorrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_ANZAHL_WOCHEN_VORRECHNUNG,
        oldValue,
        this.praezisierungAnzahlWochenVorrechnungSelected);
  }

  @Override
  public PraezisierungWochenbetragVorrechnungSelected
      getPraezisierungWochenbetragVorrechnungSelected() {
    return praezisierungWochenbetragVorrechnungSelected;
  }

  @Override
  public void setPraezisierungWochenbetragVorrechnungSelected(
      PraezisierungWochenbetragVorrechnungSelected praezisierungWochenbetragVorrechnungSelected) {
    PraezisierungWochenbetragVorrechnungSelected oldValue =
        this.praezisierungWochenbetragVorrechnungSelected;
    this.praezisierungWochenbetragVorrechnungSelected =
        praezisierungWochenbetragVorrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_WOCHENBETRAG_VORRECHNUNG,
        oldValue,
        this.praezisierungWochenbetragVorrechnungSelected);
  }

  public PraezisierungRechnungsbetragVorrechnungSelected
      getPraezisierungRechnungsbetragVorrechnungSelected() {
    return praezisierungRechnungsbetragVorrechnungSelected;
  }

  public void setPraezisierungRechnungsbetragVorrechnungSelected(
      PraezisierungRechnungsbetragVorrechnungSelected
          praezisierungRechnungsbetragVorrechnungSelected) {
    PraezisierungRechnungsbetragVorrechnungSelected oldValue =
        this.praezisierungRechnungsbetragVorrechnungSelected;
    this.praezisierungRechnungsbetragVorrechnungSelected =
        praezisierungRechnungsbetragVorrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_RECHNUNGSBETRAG_VORRECHNUNG,
        oldValue,
        this.praezisierungRechnungsbetragVorrechnungSelected);
  }

  private final PreisModelAttribute rechnungsbetragVorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.RECHNUNGSBETRAG_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setRechnungsbetragVorrechnung(String rechnungsbetragVorrechnung)
      throws SvmValidationException {
    rechnungsbetragVorrechnungModelAttribute.setNewValue(
        false, rechnungsbetragVorrechnung, isBulkUpdate());
  }

  public PraezisierungRestbetragVorrechnungSelected
      getPraezisierungRestbetragVorrechnungSelected() {
    return praezisierungRestbetragVorrechnungSelected;
  }

  public void setPraezisierungRestbetragVorrechnungSelected(
      PraezisierungRestbetragVorrechnungSelected praezisierungRestbetragVorrechnungSelected) {
    PraezisierungRestbetragVorrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.PRAEZISIERUNG_RESTBETRAG_VORRECHNUNG,
        oldValue,
        this.praezisierungRestbetragVorrechnungSelected);
  }

  private final PreisModelAttribute restbetragVorrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.RESTBETRAG_VORRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public SechsJahresRabattJaNeinVorrechnungSelected
      getSechsJahresRabattJaNeinVorrechnungSelected() {
    return sechsJahresRabattJaNeinVorrechnungSelected;
  }

  @Override
  public void setSechsJahresRabattJaNeinVorrechnungSelected(
      SechsJahresRabattJaNeinVorrechnungSelected sechsJahresRabattJaNeinVorrechnungSelected) {
    SechsJahresRabattJaNeinVorrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.SECHS_JAHRES_RABATT_VORRECHNUNG,
        oldValue,
        this.sechsJahresRabattJaNeinVorrechnungSelected);
  }
  ...
  @Override
  public void setRechnungsdatumGesetztNachrechnungSelected(
      RechnungsdatumGesetztNachrechnungSelected rechnungsdatumGesetztNachrechnungSelected) {
    RechnungsdatumGesetztNachrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.RECHNUNGSDATUM_GESETZT_NACHRECHNUNG,
        oldValue,
        this.rechnungsdatumGesetztNachrechnungSelected);
  }

  @Override
  public PraezisierungRechnungsdatumNachrechnungSelected
      getPraezisierungRechnungsdatumNachrechnungSelected() {
    return praezisierungRechnungsdatumNachrechnungSelected;
  }

  @Override
  public void setPraezisierungRechnungsdatumNachrechnungSelected(
      PraezisierungRechnungsdatumNachrechnungSelected
          praezisierungRechnungsdatumNachrechnungSelected) {
    PraezisierungRechnungsdatumNachrechnungSelected oldValue =
        this.praezisierungRechnungsdatumNachrechnungSelected;
    this.praezisierungRechnungsdatumNachrechnungSelected =
        praezisierungRechnungsdatumNachrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_RECHNUNGSDATUM_NACHRECHNUNG,
        oldValue,
        this.praezisierungRechnungsdatumNachrechnungSelected);
  }

  @Override
  public PraezisierungErmaessigungNachrechnungSelected
      getPraezisierungErmaessigungNachrechnungSelected() {
    return praezisierungErmaessigungNachrechnungSelected;
  }

  @Override
  public void setPraezisierungErmaessigungNachrechnungSelected(
      PraezisierungErmaessigungNachrechnungSelected praezisierungErmaessigungNachrechnungSelected) {
    PraezisierungErmaessigungNachrechnungSelected oldValue =
        this.praezisierungErmaessigungNachrechnungSelected;
    this.praezisierungErmaessigungNachrechnungSelected =
        praezisierungErmaessigungNachrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_ERMAESSIGUNG_NACHRECHNUNG,
        oldValue,
        this.praezisierungErmaessigungNachrechnungSelected);
  }
  ...
  @Override
  public void setPraezisierungZuschlagNachrechnungSelected(
      PraezisierungZuschlagNachrechnungSelected praezisierungZuschlagNachrechnungSelected) {
    PraezisierungZuschlagNachrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.PRAEZISIERUNG_ZUSCHLAG_NACHRECHNUNG,
        oldValue,
        this.praezisierungZuschlagNachrechnungSelected);
  }

  @Override
  public PraezisierungAnzahlWochenNachrechnungSelected
      getPraezisierungAnzahlWochenNachrechnungSelected() {
    return praezisierungAnzahlWochenNachrechnungSelected;
  }

  @Override
  public void setPraezisierungAnzahlWochenNachrechnungSelected(
      PraezisierungAnzahlWochenNachrechnungSelected praezisierungAnzahlWochenNachrechnungSelected) {
    PraezisierungAnzahlWochenNachrechnungSelected oldValue =
        this.praezisierungAnzahlWochenNachrechnungSelected;
    this.praezisierungAnzahlWochenNachrechnungSelected =
        praezisierungAnzahlWochenNachrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_ANZAHL_WOCHEN_NACHRECHNUNG,
        oldValue,
        this.praezisierungAnzahlWochenNachrechnungSelected);
  }

  @Override
  public PraezisierungWochenbetragNachrechnungSelected
      getPraezisierungWochenbetragNachrechnungSelected() {
    return praezisierungWochenbetragNachrechnungSelected;
  }

  @Override
  public void setPraezisierungWochenbetragNachrechnungSelected(
      PraezisierungWochenbetragNachrechnungSelected praezisierungWochenbetragNachrechnungSelected) {
    PraezisierungWochenbetragNachrechnungSelected oldValue =
        this.praezisierungWochenbetragNachrechnungSelected;
    this.praezisierungWochenbetragNachrechnungSelected =
        praezisierungWochenbetragNachrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_WOCHENBETRAG_NACHRECHNUNG,
        oldValue,
        this.praezisierungWochenbetragNachrechnungSelected);
  }

  public PraezisierungRechnungsbetragNachrechnungSelected
      getPraezisierungRechnungsbetragNachrechnungSelected() {
    return praezisierungRechnungsbetragNachrechnungSelected;
  }

  public void setPraezisierungRechnungsbetragNachrechnungSelected(
      PraezisierungRechnungsbetragNachrechnungSelected
          praezisierungRechnungsbetragNachrechnungSelected) {
    PraezisierungRechnungsbetragNachrechnungSelected oldValue =
        this.praezisierungRechnungsbetragNachrechnungSelected;
    this.praezisierungRechnungsbetragNachrechnungSelected =
        praezisierungRechnungsbetragNachrechnungSelected;
    firePropertyChange(
        Field.PRAEZISIERUNG_RECHNUNGSBETRAG_NACHRECHNUNG,
        oldValue,
        this.praezisierungRechnungsbetragNachrechnungSelected);
  }

  private final PreisModelAttribute rechnungsbetragNachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.RECHNUNGSBETRAG_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setRechnungsbetragNachrechnung(String rechnungsbetragNachrechnung)
      throws SvmValidationException {
    rechnungsbetragNachrechnungModelAttribute.setNewValue(
        false, rechnungsbetragNachrechnung, isBulkUpdate());
  }

  public PraezisierungRestbetragNachrechnungSelected
      getPraezisierungRestbetragNachrechnungSelected() {
    return praezisierungRestbetragNachrechnungSelected;
  }

  public void setPraezisierungRestbetragNachrechnungSelected(
      PraezisierungRestbetragNachrechnungSelected praezisierungRestbetragNachrechnungSelected) {
    PraezisierungRestbetragNachrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.PRAEZISIERUNG_RESTBETRAG_NACHRECHNUNG,
        oldValue,
        this.praezisierungRestbetragNachrechnungSelected);
  }

  private final PreisModelAttribute restbetragNachrechnungModelAttribute =
      new PreisModelAttribute(
          this,
          Field.RESTBETRAG_NACHRECHNUNG,
          MIN_VALID_VALUE,
          MAX_VALID_VALUE,
          new AttributeAccessor<>() {
            @Override
  ...
  @Override
  public void setRestbetragNachrechnung(String restbetragNachrechnung)
      throws SvmValidationException {
    restbetragNachrechnungModelAttribute.setNewValue(false, restbetragNachrechnung, isBulkUpdate());
  }

  @Override
  public SechsJahresRabattJaNeinNachrechnungSelected
      getSechsJahresRabattJaNeinNachrechnungSelected() {
    return sechsJahresRabattJaNeinNachrechnungSelected;
  }

  @Override
  public void setSechsJahresRabattJaNeinNachrechnungSelected(
      SechsJahresRabattJaNeinNachrechnungSelected sechsJahresRabattJaNeinNachrechnungSelected) {
    SechsJahresRabattJaNeinNachrechnungSelected oldValue =
    ...
    firePropertyChange(
        Field.SECHS_JAHRES_RABATT_NACHRECHNUNG,
        oldValue,
        this.sechsJahresRabattJaNeinNachrechnungSelected);
  }
  ...
  public void setPraezisierungDifferenzSchulgeldSelected(
    ...
    firePropertyChange(
        Field.PRAEZISIERUNG_DIFFERENZ_SCHULGELD,
        oldValue,
        this.praezisierungDifferenzSchulgeldSelected);
  }

  private final PreisModelAttribute differenzSchulgeldModelAttribute =
      new PreisModelAttribute(
          this,
  ...
  public SemesterrechnungenTableData suchen() {
    ...
    CreateAndFindSemesterrechnungenCommand createAndFindSemesterrechnungenCommand =
        new CreateAndFindSemesterrechnungenCommand(this);
    ...
    return new SemesterrechnungenTableData(
        createAndFindSemesterrechnungenCommand.getSemesterrechnungenFound(),
        semester,
        previousSemester,
        geloescht);
  }
