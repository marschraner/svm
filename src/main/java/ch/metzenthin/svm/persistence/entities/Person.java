...
public abstract class Person extends AbstractEntity implements Comparable<Person> {
  ...
  public boolean isIdenticalWith(Person otherPerson) {
    return otherPerson != null
        ...
        && ((geburtsdatum == null && otherPerson.getGeburtsdatum() == null)
            || (geburtsdatum != null && geburtsdatum.equals(otherPerson.getGeburtsdatum())))
        && ((festnetz == null && otherPerson.getFestnetz() == null)
            || (festnetz != null && festnetz.equals(otherPerson.getFestnetz())))
        && ((natel == null && otherPerson.getNatel() == null)
            || (natel != null && natel.equals(otherPerson.getNatel())))
        && ((email == null && otherPerson.getEmail() == null)
            || (email != null && email.equals(otherPerson.getEmail())))
        && ((adresse == null && otherPerson.getAdresse() == null)
            || (adresse != null && adresse.isIdenticalWith(otherPerson.getAdresse())));
  }
  ...
  public boolean isPartOf(Person otherPerson) {
    return otherPerson != null
        ...
        && (geburtsdatum == null || geburtsdatum.equals(otherPerson.getGeburtsdatum()))
        && (festnetz == null
            || festnetz.trim().isEmpty()
            || festnetz.equals(otherPerson.getFestnetz()))
  ...
  @Override
  public int hashCode() {
    return Objects.hash(anrede, vorname, nachname, geburtsdatum, festnetz, natel, email, adresse);
  }
    ...
    if (result == 0) {
      ...
      if (result == 0 && adresse != null && otherPerson.adresse != null) {
        ...
        if (result == 0
            ...
            && otherPerson.adresse.getStrasse() != null) {
