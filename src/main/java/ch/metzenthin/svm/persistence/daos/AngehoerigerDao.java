...
public class AngehoerigerDao extends GenericDao<Angehoeriger, Integer> {
  ...
  /**
   * In der DB nach Angehörigen suchen. Sämtliche Attribute sind optional. Es werden alle
   * Angehörigen ausgegeben, deren Attribute mit den in der Suche gesetzten übereinstimmen.
   *
  ...
  public List<Angehoeriger> findAngehoerige(Angehoeriger angehoeriger) {
    ...
    TypedQuery<Angehoeriger> typedQuery =
        db.getCurrentEntityManager().createQuery(selectStatementSb.toString(), Angehoeriger.class);
