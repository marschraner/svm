...
public class CodeSpecificHinzufuegenController extends AbstractController {
  ...
  public CodeSpecificHinzufuegenController(
      SvmContext svmContext,
      CodesTableModel codesTableModel,
      CodeSpecificHinzufuegenModel codeSpecificHinzufuegenModel,
  ...
  public void setCodeSpecificHinzufuegenDialog(JDialog codeSpecificHinzufuegenDialog) {
    ...
    codeSpecificHinzufuegenDialog.addWindowListener(
        new WindowAdapter() {
          @Override
  ...
  private void onCodeSelected() {
    LOGGER.trace(
        "xCodeXHinzufuegenController Event SchuelerCode selected={}",
        comboBoxCode.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxCode.getSelectedItem(), codeSpecificHinzufuegenModel.getCode());
    try {
      setModelCode();
  ...
  private void onMitarbeiterCodeHinzufuegen() {
    ...
    codeSpecificHinzufuegenModel.mitarbeiterCodeHinzufuegen(
        codesTableModel, mitarbeiterErfassenModel);
    codeSpecificHinzufuegenDialog.dispose();
  }
