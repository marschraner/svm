...
public class MaerchenErfassenController extends AbstractController {
  ...
  public MaerchenErfassenController(
  ...
  public void setMaerchenErfassenDialog(JDialog maerchenErfassenDialog) {
    ...
    maerchenErfassenDialog.addWindowListener(
        new WindowAdapter() {
          @Override
  ...
  private void initSchuljahr() {
    String initSchuljahr =
        maerchenErfassenModel.getNaechstesNochNichtErfasstesSchuljahrMaerchen(
  ...
  private void onSchuljahrSelected() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(spinnerSchuljahre.getValue(), maerchenErfassenModel.getSchuljahr());
    try {
      setModelSchuljahr();
    } catch (SvmValidationException e) {
      return;
  ...
  private void onBezeichnungEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtBezeichnung.getText(), maerchenErfassenModel.getBezeichnung());
    try {
  ...
  private void setModelBezeichnung(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaerchenErfassenController setModelBezeichnung RequiredException={}", e.getMessage());
  ...
  public void setTxtAnzahlVorstellungen(JTextField txtAnzahlVorstellungen) {
    ...
    this.txtAnzahlVorstellungen.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onAnzahlVorstellungenEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            txtAnzahlVorstellungen.getText(), maerchenErfassenModel.getAnzahlVorstellungen());
    try {
  ...
  private void setModelAnzahlVorstellungen(boolean showRequiredErrMsg)
    ...
    try {
      ...
      LOGGER.trace(
          "MaerchenErfassenController setModelAnzahlVorstellungen RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaerchenErfassenController setModelAnzahlVorstellungen Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  private void onSpeichern() {
    ...
    if (maerchenErfassenModel.checkMaerchenBereitsErfasst(svmContext.getSvmModel())) {
      JOptionPane.showMessageDialog(
          maerchenErfassenDialog,
          "Märchen für Schuljahr "
              + maerchenErfassenModel.getMaerchen().getSchuljahr()
              + " bereits erfasst.",
          "Fehler",
  ...
  void doPropertyChange(PropertyChangeEvent evt) {
    ...
    if (checkIsFieldChange(Field.SCHULJAHR, evt)) {
      ...
      txtAnzahlVorstellungen.setText(
          Integer.toString(maerchenErfassenModel.getAnzahlVorstellungen()));
    }
  }
