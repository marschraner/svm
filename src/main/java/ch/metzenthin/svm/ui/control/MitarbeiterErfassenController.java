...
public class MitarbeiterErfassenController extends PersonController {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(MitarbeiterErfassenController.class);
  ...
  public MitarbeiterErfassenController(
  ...
  public void setMitarbeiterErfassenDialog(JDialog mitarbeiterErfassenDialog) {
    ...
    mitarbeiterErfassenDialog.addWindowListener(
        new WindowAdapter() {
          @Override
  ...
  public void setTxtAhvNummer(JTextField txtAhvNummer) {
    ...
    this.txtAhvNummer.addFocusListener(
        new FocusAdapter() {
          @Override
  ...
  private void onAhvNummerEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtAhvNummer.getText(), mitarbeiterErfassenModel.getAhvNummer());
    try {
  ...
  private void setModelAhvNummer(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MitarbeiterErfassenController setModelAhvNummer RequiredException={}", e.getMessage());
  ...
  public void setTxtIbanNummer(JTextField txtIbanNummer) {
    ...
    this.txtIbanNummer.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onIbanNummerEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtIbanNummer.getText(), mitarbeiterErfassenModel.getIbanNummer());
    try {
  ...
  private void setModelIbanNummer(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MitarbeiterErfassenController setModelIbanNummer RequiredException={}", e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
  ...
  private void onLehrkraftEvent() {
    LOGGER.trace(
        "MitarbeiterErfassenController Event Lehrkraft. Selected={}",
        checkBoxLehrkraft.isSelected());
    setModelLehrkraft();
  }
  ...
  public void setTextAreaVertretungsmoeglichkeiten(JTextArea textAreaVertretungsmoeglichkeiten) {
    ...
    textAreaVertretungsmoeglichkeiten.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
    ...
    textAreaVertretungsmoeglichkeiten.setFocusTraversalKeys(
  ...
  private void onVertretungsmoeglichkeitenEvent() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            textAreaVertretungsmoeglichkeiten.getText(),
            mitarbeiterErfassenModel.getVertretungsmoeglichkeiten());
    try {
  ...
  private void setModelVertretungsmoeglichkeiten() throws SvmValidationException {
    ...
    try {
      mitarbeiterErfassenModel.setVertretungsmoeglichkeiten(
          textAreaVertretungsmoeglichkeiten.getText());
    } catch (SvmValidationException e) {
      LOGGER.trace(
          "MitarbeiterErfassenController setModelVertretungsmoeglichkeiten Exception={}",
          e.getMessage());
      showErrMsg(e);
      throw e;
    }
  ...
  private void onBemerkungenEvent() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(textAreaBemerkungen.getText(), mitarbeiterErfassenModel.getBemerkungen());
    try {
      setModelBemerkungen();
    } catch (SvmValidationException e) {
      return;
  ...
  private void setModelBemerkungen() throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MitarbeiterErfassenController setModelBemerkungen Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  private void onAktivEvent() {
    LOGGER.trace(
        "MitarbeiterErfassenController Event Aktiv. Selected={}", checkBoxAktiv.isSelected());
    setModelAktiv();
  }
  ...
  private void onCodesBearbeiten() {
    CodesTableModel codesTableModel =
        new CodesTableModel(mitarbeiterErfassenModel.getCodesTableData());
    String title = mitarbeiterErfassenModel.getCodesBearbeitenTitle();
    CodesDialog codesDialog =
        new CodesDialog(
            svmContext,
            codesTableModel,
  ...
  private void onSpeichern() {
    ...
    if (mitarbeiterErfassenModel.checkMitarbeiterBereitsErfasst(svmContext.getSvmModel())) {
      JOptionPane.showMessageDialog(
          mitarbeiterErfassenDialog,
          "Der Mitarbeiter ist bereits in der Datenbank gespeichert und kann nicht ein weiteres Mal erfasst werden.",
          "Fehler",
  ...
  void doPropertyChange(PropertyChangeEvent evt) {
    ...
    if (checkIsFieldChange(Field.AHV_NUMMER, evt)) {
      ...
      textAreaVertretungsmoeglichkeiten.setText(
          mitarbeiterErfassenModel.getVertretungsmoeglichkeiten());
  ...
  void validateFields() throws SvmValidationException {
    ...
    if (textAreaVertretungsmoeglichkeiten != null
        && textAreaVertretungsmoeglichkeiten.isEnabled()) {
