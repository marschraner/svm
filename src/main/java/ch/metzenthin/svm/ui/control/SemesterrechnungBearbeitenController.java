...
public class SemesterrechnungBearbeitenController extends SemesterrechnungController {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SemesterrechnungBearbeitenController.class);
  ...
  public SemesterrechnungBearbeitenController(
  ...
  private void scroll(int selectedRow) {
    if ((this.selectedRow == selectedRow)
        || (selectedRow < 0)
        || (selectedRow >= semesterrechnungenTableModel.getRowCount())) {
      return;
    }
    this.selectedRow = selectedRow;
    setNewModel();
  ...
  private void setNewModel() {
    ...
    // ACHTUNG: Vor Zuweisung des neuen Models invalidate auf altem Model aufrufen, damit
    // Txt-Einträge alle auf null gesetzt werden.
    //          Sonst bleiben Txt-Werte, die null sein sollten, aber vor dem Blättern einen Wert
    // hatten, mit dem alten Wert behaftet!
    ...
    semesterrechnungBearbeitenModel =
        semesterrechnungenModel.getSemesterrechnungBearbeitenModel(
            svmContext, semesterrechnungenTableModel, convertRowIndexToModel());
  ...
  private void enableBtnNachfolgender() {
    btnNachfolgender.setEnabled(
        semesterrechnungenTableModel != null
            && selectedRow != (semesterrechnungenTableModel.getRowCount() - 1));
  }
  ...
  private void setLblNachnameVorname() {
    lblNachnameVorname.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerNachname()
            + " "
            + semesterrechnungBearbeitenModel.getRechnungsempfaengerVorname());
  }
  ...
  private void setLblName() {
    lblName.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerAnrede()
            + " "
            + semesterrechnungBearbeitenModel.getRechnungsempfaengerVorname()
            + " "
            + semesterrechnungBearbeitenModel.getRechnungsempfaengerNachname());
  ...
  private void setLblPlzOrt() {
    lblPlzOrt.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerPlz()
            + " "
            + semesterrechnungBearbeitenModel.getRechnungsempfaengerOrt());
  }
  ...
  private void setLblSchuelersVorrechnung() {
    lblSchuelersVorrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerSchuelersVorrechnung());
  }
  ...
  private void setLblKurseVorrechnung() {
    lblKurseVorrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerKurseVorrechnung());
  }
  ...
  private void setLblSechsJahresRabattVorrechnung() {
    lblSechsJahresRabattVorrechnung.setText(
        semesterrechnungBearbeitenModel.getSechsJahresRabattVorrechnung());
  }
  ...
  private void setLblErmaessigungVorrechnung() {
    if (semesterrechnungBearbeitenModel.getErmaessigungVorrechnung() != null) {
      lblErmaessigungVorrechnung.setText(
          semesterrechnungBearbeitenModel.getErmaessigungVorrechnung().toString());
    }
  }
  ...
  private void setLblZuschlagVorrechnung() {
    if (semesterrechnungBearbeitenModel.getZuschlagVorrechnung() != null) {
      lblZuschlagVorrechnung.setText(
          semesterrechnungBearbeitenModel.getZuschlagVorrechnung().toString());
    }
  }
  ...
  private void setLblMalRabattFaktorVorrechnung() {
    lblMalRabattFaktorVorrechnung.setVisible(
        !semesterrechnungBearbeitenModel.getRabattFaktor().isEmpty());
  }
  ...
  private void setLblRechnungsbetragVorrechnung() {
    lblRechnungsbetragVorrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsbetragVorrechnung());
  }
  ...
  private void setLblSchuelersNachrechnung() {
    lblSchuelersNachrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerSchuelersNachrechnung());
  }
  ...
  private void setLblKurseNachrechnung() {
    lblKurseNachrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsempfaengerKurseNachrechnung());
  }
  ...
  private void setLblSechsJahresRabattNachrechnung() {
    lblSechsJahresRabattNachrechnung.setText(
        semesterrechnungBearbeitenModel.getSechsJahresRabattNachrechnung());
  }
  ...
  private void setLblErmaessigungNachrechnung() {
    if (semesterrechnungBearbeitenModel.getErmaessigungNachrechnung() != null) {
      lblErmaessigungNachrechnung.setText(
          semesterrechnungBearbeitenModel.getErmaessigungNachrechnung().toString());
    }
  }
  ...
  private void setLblZuschlagNachrechnung() {
    if (semesterrechnungBearbeitenModel.getZuschlagNachrechnung() != null) {
      lblZuschlagNachrechnung.setText(
          semesterrechnungBearbeitenModel.getZuschlagNachrechnung().toString());
    }
  }
  ...
  private void setLblMalRabattFaktorNachrechnung() {
    lblMalRabattFaktorNachrechnung.setVisible(
        !semesterrechnungBearbeitenModel.getRabattFaktor().isEmpty());
  }
  ...
  private void setLblRechnungsbetragNachrechnung() {
    lblRechnungsbetragNachrechnung.setText(
        semesterrechnungBearbeitenModel.getRechnungsbetragNachrechnung());
  }
  ...
  private void setLblScrollPosition() {
    lblScrollPosition.setText(
        (selectedRow + 1) + " / " + semesterrechnungenTableModel.getRowCount());
  }
  ...
  public void setTxtRechnungsdatumVorrechnung(JTextField txtRechnungsdatumVorrechnung) {
    ...
    txtRechnungsdatumVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
  ...
  public void setTxtErmaessigungVorrechnung(JTextField txtErmaessigungVorrechnung) {
    ...
    txtErmaessigungVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtErmaessigungsgrundVorrechnung(JTextField txtErmaessigungsgrundVorrechnung) {
    ...
    txtErmaessigungsgrundVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtZuschlagVorrechnung(JTextField txtZuschlagVorrechnung) {
    ...
    txtZuschlagVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtZuschlagsgrundVorrechnung(JTextField txtZuschlagsgrundVorrechnung) {
    ...
    txtZuschlagsgrundVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtAnzahlWochenVorrechnung(JTextField txtAnzahlWochenVorrechnung) {
    ...
    txtAnzahlWochenVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtWochenbetragVorrechnung(JTextField txtWochenbetragVorrechnung) {
    ...
    txtWochenbetragVorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung1Vorrechnung(JTextField txtDatumZahlung1Vorrechnung) {
    ...
    txtDatumZahlung1Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung1Vorrechnung(JTextField txtBetragZahlung1Vorrechnung) {
    ...
    txtBetragZahlung1Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung2Vorrechnung(JTextField txtDatumZahlung2Vorrechnung) {
    ...
    txtDatumZahlung2Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung2Vorrechnung(JTextField txtBetragZahlung2Vorrechnung) {
    ...
    txtBetragZahlung2Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung3Vorrechnung(JTextField txtDatumZahlung3Vorrechnung) {
    ...
    txtDatumZahlung3Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung3Vorrechnung(JTextField txtBetragZahlung3Vorrechnung) {
    ...
    txtBetragZahlung3Vorrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtRechnungsdatumNachrechnung(JTextField txtRechnungsdatumNachrechnung) {
    ...
    txtRechnungsdatumNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtErmaessigungNachrechnung(JTextField txtErmaessigungNachrechnung) {
    ...
    txtErmaessigungNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtErmaessigungsgrundNachrechnung(JTextField txtErmaessigungsgrundNachrechnung) {
    ...
    txtErmaessigungsgrundNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtZuschlagNachrechnung(JTextField txtZuschlagNachrechnung) {
    ...
    txtZuschlagNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtZuschlagsgrundNachrechnung(JTextField txtZuschlagsgrundNachrechnung) {
    ...
    txtZuschlagsgrundNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtAnzahlWochenNachrechnung(JTextField txtAnzahlWochenNachrechnung) {
    ...
    txtAnzahlWochenNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtWochenbetragNachrechnung(JTextField txtWochenbetragNachrechnung) {
    ...
    txtWochenbetragNachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung1Nachrechnung(JTextField txtDatumZahlung1Nachrechnung) {
    ...
    txtDatumZahlung1Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung1Nachrechnung(JTextField txtBetragZahlung1Nachrechnung) {
    ...
    txtBetragZahlung1Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung2Nachrechnung(JTextField txtDatumZahlung2Nachrechnung) {
    ...
    txtDatumZahlung2Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung2Nachrechnung(JTextField txtBetragZahlung2Nachrechnung) {
    ...
    txtBetragZahlung2Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtDatumZahlung3Nachrechnung(JTextField txtDatumZahlung3Nachrechnung) {
    ...
    txtDatumZahlung3Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTxtBetragZahlung3Nachrechnung(JTextField txtBetragZahlung3Nachrechnung) {
    ...
    txtBetragZahlung3Nachrechnung.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  public void setTextAreaBemerkungen(JTextArea textAreaBemerkungen) {
    ...
    textAreaBemerkungen.addKeyListener(
        new KeyAdapter() {
          @Override
          public void keyTyped(KeyEvent e) {
            enableSpeichernDisableNavigation();
  ...
  void onRechnungsdatumNachrechnungEvent() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            ...
            semesterrechnungBearbeitenModel.getRechnungsdatumNachrechnung());
    try {
      setModelRechnungsdatumNachrechnung();
      // Beim Setzen des Rechnungsdatums der Nachrechnung die Zahlungen der Vorrechnung einmalig in
      // die Nachrechnung kopieren
  ...
  private void onZurueck() {
    if (semesterrechnungenTableModel != null && semesterrechnungenTableModel.getRowCount() > 1) {
      SemesterrechnungenPanel semesterrechnungenPanel =
          new SemesterrechnungenPanel(svmContext, semesterrechnungenTableModel, false);
      ...
      zurueckZuSemesterrechnungSuchenListener.actionPerformed(
          new ActionEvent(
              btnZurueck, ActionEvent.ACTION_PERFORMED, "Zurück zu Semesterrechnungen suchen"));
    }
  }
  ...
  private void onVerwerfen() {
    ...
    // Wenn beim Editieren ein ungültiger Wert eingegeben wurde, wurde dieser nicht ins Model
    // geschrieben,
    // d.h. im Model befindet sich immer noch der Wert von SemesterOrigin.
    // In einem solchen Fall wird durch initializeModelWithSemesterOrigin kein PropertyChangeEvent
    // ausgelöst,
    // und die Felder werden in der View nicht aktualisiert, d.h. sie zeigen immer noch die
    // fehlerhafte Eingabe
