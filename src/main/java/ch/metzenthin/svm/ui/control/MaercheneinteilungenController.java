...
public class MaercheneinteilungenController {
  ...
  public void setMaercheneinteilungenTable(JTable maercheneinteilungenTable) {
    ...
    maercheneinteilungenTable.addMouseListener(
        new MouseAdapter() {
          @Override
  ...
  public void setBtnNeu(JButton btnNeu) {
    ...
    if (maercheneinteilungenModel
        .getSelectableMaerchens(svmContext.getSvmModel(), schuelerDatenblattModel)
        .isEmpty()) {
      btnNeu.setEnabled(false);
    }
  ...
  private void onNeu() {
    ...
    MaercheneinteilungErfassenDialog maercheneinteilungErfassenDialog =
        new MaercheneinteilungErfassenDialog(
            svmContext,
            maercheneinteilungenModel,
            maercheneinteilungenTableModel,
            schuelerDatenblattModel,
            maercheneinteilungenTable.getSelectedRow(),
            false,
            "Märcheneinteilung erfassen");
  ...
  private void onLoeschen() {
    ...
    if (n == 0) {
      maercheneinteilungenModel.maercheneinteilungLoeschen(
          maercheneinteilungenTableModel,
          schuelerDatenblattModel,
          maercheneinteilungenTable.getSelectedRow());
      maercheneinteilungenTableModel.fireTableDataChanged();
