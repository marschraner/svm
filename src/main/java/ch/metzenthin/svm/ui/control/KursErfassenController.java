...
public class KursErfassenController extends AbstractController {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(KursErfassenController.class);
  ...
  public void setKursErfassenDialog(JDialog kursErfassenDialog) {
    ...
    kursErfassenDialog.addWindowListener(
        new WindowAdapter() {
          @Override
  ...
  public void setComboBoxKurstyp(JComboBox<Kurstyp> comboBoxKurstyp) {
    ...
    Kurstyp[] selectableKurstypen =
        kursErfassenModel.getSelectableKurstypen(svmContext.getSvmModel());
  ...
  private void onKurstypSelected() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxKurstyp.getSelectedItem(), kursErfassenModel.getKurstyp());
    try {
      setModelKurstyp();
  ...
  public void setTxtAltersbereich(JTextField txtAltersbereich) {
    ...
    this.txtAltersbereich.addFocusListener(
        new FocusAdapter() {
          @Override
  ...
  private void onAltersbereichEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtAltersbereich.getText(), kursErfassenModel.getAltersbereich());
    try {
  ...
  private void setModelAltersbereich(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "KursErfassenController setModelAltersbereich RequiredException={}", e.getMessage());
  ...
  public void setTxtStufe(JTextField txtStufe) {
    ...
    this.txtStufe.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
            onStufeEvent(false);
  ...
  private void onStufeEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtStufe.getText(), kursErfassenModel.getStufe());
    try {
  ...
  private void onWochentagSelected() {
    LOGGER.trace(
        "KursErfassenController Event Wochentag selected={}", comboBoxWochentag.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxWochentag.getSelectedItem(), kursErfassenModel.getWochentag());
    try {
      setModelWochentag();
    } catch (SvmValidationException e) {
      return;
  ...
  private void onZeitBeginnEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtZeitBeginn.getText(), kursErfassenModel.getZeitBeginn());
    try {
  ...
  private void setModelZeitBeginn(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "KursErfassenController setModelZeitBeginn RequiredException={}", e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
  ...
  public void setTxtZeitEnde(JTextField txtZeitEnde) {
    ...
    this.txtZeitEnde.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onZeitEndeEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtZeitEnde.getText(), kursErfassenModel.getZeitEnde());
    try {
  ...
  public void setComboBoxKursort(JComboBox<Kursort> comboBoxKursort) {
    ...
    Kursort[] selectableKursorte =
        kursErfassenModel.getSelectableKursorte(svmContext.getSvmModel());
  ...
  private void onKursortSelected() {
    LOGGER.trace(
        "KursErfassenController Event Kursort selected={}", comboBoxKursort.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxKursort.getSelectedItem(), kursErfassenModel.getKursort());
    try {
      setModelKursort();
    } catch (SvmValidationException e) {
      return;
  ...
  public void setComboBoxLehrkraft1(JComboBox<Mitarbeiter> comboBoxLehrkraft1) {
    ...
    Mitarbeiter[] selectableLehrkraefte1 =
        kursErfassenModel.getSelectableLehrkraefte1(svmContext.getSvmModel());
  ...
  private void onLehrkraft1Selected() {
    LOGGER.trace(
        "KursErfassenController Event Lehrkraft1 selected={}",
        comboBoxLehrkraft1.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxLehrkraft1.getSelectedItem(), kursErfassenModel.getMitarbeiter1());
    try {
      setModelLehrkraft1();
    } catch (SvmValidationException e) {
      return;
  ...
  private void setModelLehrkraft1() throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "KursErfassenController setModelLehrkraft1 RequiredException={}", e.getMessage());
      if (isModelValidationMode()) {
  ...
  public void setComboBoxLehrkraft2(JComboBox<Mitarbeiter> comboBoxLehrkraft2) {
    ...
    Mitarbeiter[] selectableLehrkraefte2 =
        kursErfassenModel.getSelectableLehrkraefte2(svmContext.getSvmModel());
  ...
  private void onLehrkraft2Selected() {
    LOGGER.trace(
        "KursErfassenController Event Lehrkraft2 selected={}",
        comboBoxLehrkraft2.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxLehrkraft2.getSelectedItem(), kursErfassenModel.getMitarbeiter2());
    setModelLehrkraft2();
    if (equalFieldAndModelValue && isModelValidationMode()) {
      // Wenn Field und Model den gleichen Wert haben, erfolgt kein PropertyChangeEvent. Deshalb
      // muss hier die Validierung angestossen werden.
  ...
  private void onBemerkungenEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtBemerkungen.getText(), kursErfassenModel.getBemerkungen());
    try {
  ...
  private void setModelBemerkungen(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "KursErfassenController setModelBemerkungen RequiredException={}", e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
