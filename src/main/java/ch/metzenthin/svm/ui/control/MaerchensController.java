...
public class MaerchensController {
  ...
  public void setMaerchensTable(JTable maerchensTable) {
    ...
    maerchensTable.addMouseListener(
        new MouseAdapter() {
          @Override
  ...
  private void initializeMaerchensTable() {
    MaerchensTableData maerchensTableData =
        new MaerchensTableData(svmContext.getSvmModel().getMaerchensAll());
  ...
  private void onNeu() {
    ...
    MaerchenErfassenDialog maerchenErfassenDialog =
        new MaerchenErfassenDialog(
            svmContext, maerchensTableModel, maerchensModel, 0, false, "Neues Märchen");
