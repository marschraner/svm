...
public class ListenExportController extends AbstractController {
  ...
  public ListenExportController(
      ListenExportModel listenExportModel,
  ...
  private void onListentypSelected() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxListentyp.getSelectedItem(), listenExportModel.getListentyp());
    try {
      setModelListentyp();
  ...
  private void onTitelEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtTitel.getText(), listenExportModel.getTitel());
    try {
  ...
  private void onOk() {
    ...
    String[] listenErstellenWarning =
        listenExportModel.getListenErstellenWarning(semesterrechnungenTableModel);
    ...
    SwingWorker<CreateListeCommand.Result, String> worker =
        new SwingWorker<>() {
          ...
          protected CreateListeCommand.Result doInBackground() {
            return listenExportModel.createListenFile(
                outputFile,
  ...
  private void enableDisableFields() {
    if (listenExportModel.getListentyp() != null
        && listenExportModel.getListentyp().getFiletyp() == Filetyp.CSV) {
      disableTitel();
    } else {
      enableTitel();
    }
