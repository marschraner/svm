...
public abstract class PersonController extends AbstractController {
  ...
  public void setTxtStrasseHausnummer(JTextField txtStrasseHausnummer) {
    ...
    this.txtStrasseHausnummer.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  public void setTxtFestnetz(JTextField txtFestnetz) {
    ...
    this.txtFestnetz.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  public void setTxtNatel(JTextField txtNatel) {
    ...
    this.txtNatel.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
            onNatelEvent(false);
  ...
  public void setTxtEmail(JTextField txtEmail) {
    ...
    this.txtEmail.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
            onEmailEvent(false);
  ...
  public void setTxtGeburtsdatum(JTextField txtGeburtsdatum) {
    ...
    this.txtGeburtsdatum.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onNachnameEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtNachname.getText(), personModel.getNachname());
    try {
  ...
  private void onVornameEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtVorname.getText(), personModel.getVorname());
    try {
  ...
  private void onStrasseHausnummerEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtStrasseHausnummer.getText(), personModel.getStrasseHausnummer());
    try {
  ...
  private void onFestnetzEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtFestnetz.getText(), personModel.getFestnetz());
    try {
  ...
  private void onGeburtsdatumEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtGeburtsdatum.getText(), personModel.getGeburtsdatum());
    try {
