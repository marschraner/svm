...
public class MonatsstatistikKurseController extends AbstractController {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(MonatsstatistikKurseController.class);
  ...
  public MonatsstatistikKurseController(
      MonatsstatistikKurseModel monatsstatistikKurseModel, boolean defaultButtonEnabled) {
  ...
  private void initMonatJahr() {
    ...
    try {
      monatsstatistikKurseModel.setMonatJahr(
  ...
  private void onMonatJahrEvent() {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            ...
            monatsstatistikKurseModel.getMonatJahr(),
  ...
  private void onSuchen() {
    ...
    JOptionPane.showMessageDialog(
        null, statistik, "Statistik per Ende Monat", JOptionPane.INFORMATION_MESSAGE);
    btnSuchen.setFocusPainted(false);
  }
  ...
  void doPropertyChange(PropertyChangeEvent evt) {
    ...
    if (checkIsFieldChange(Field.MONAT_JAHR, evt)) {
      txtMonatJahr.setText(
          asString(monatsstatistikKurseModel.getMonatJahr(), MONAT_JAHR_DATE_FORMAT_STRING));
    }
  }
