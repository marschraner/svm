...
public class DispensationenController {
  ...
  public void setDispensationenTable(JTable dispensationenTable) {
    ...
    dispensationenTable.addMouseListener(
        new MouseAdapter() {
          @Override
  ...
  private void onNeu() {
    ...
    DispensationErfassenDialog dispensationErfassenDialog =
        new DispensationErfassenDialog(
            svmContext,
  ...
  private void onBearbeiten() {
    ...
    DispensationErfassenDialog dispensationErfassenDialog =
        new DispensationErfassenDialog(
            ...
            dispensationenModel,
            schuelerDatenblattModel,
            dispensationenTable.getSelectedRow(),
            true,
            "Dispensation bearbeiten");
    dispensationErfassenDialog.pack();
    dispensationErfassenDialog.setVisible(true);
    dispensationenTableModel.fireTableDataChanged();
  ...
  private void onLoeschen() {
    ...
    if (n == 0) {
      dispensationenModel.eintragLoeschen(
          dispensationenTableModel, schuelerDatenblattModel, dispensationenTable.getSelectedRow());
      dispensationenTableModel.fireTableDataChanged();
