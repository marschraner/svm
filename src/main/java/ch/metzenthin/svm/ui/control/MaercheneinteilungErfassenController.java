...
public class MaercheneinteilungErfassenController extends PersonController {
  ...
  public MaercheneinteilungErfassenController(
      SvmContext svmContext,
      MaercheneinteilungErfassenModel maercheneinteilungErfassenModel,
    ...
    this.maercheneinteilungErfassenModel.addCompletedListener(
        this::onMaercheneinteilungErfassenModelCompleted);
  ...
  public void setMaercheneinteilungErfassenDialog(JDialog maercheneinteilungErfassenDialog) {
    ...
    maercheneinteilungErfassenDialog.addWindowListener(
        new WindowAdapter() {
          @Override
  ...
  public void setSpinnerMaerchen(JSpinner spinnerMaerchen) {
    ...
    List<Maerchen> selectableMaerchenList =
        maercheneinteilungenModel.getSelectableMaerchens(
            svmContext.getSvmModel(), schuelerDatenblattModel);
    Maerchen[] selectableMaerchens;
    if (isBearbeiten) {
      selectableMaerchens =
          maercheneinteilungErfassenModel.getSelectableMaerchenMaercheneinteilungOrigin();
    } else {
    ...
    if (!isBearbeiten) {
      Maerchen maerchenInit =
          maercheneinteilungErfassenModel.getMaerchenInit(selectableMaerchenList);
  ...
  private void onMaerchenSelected() {
    LOGGER.trace(
        "MaercheneinteilungErfassenController Event Maerchen selected ={}",
        spinnerMaerchen.getValue());
    boolean equalFieldAndModelValue =
        equalsNullSafe(spinnerMaerchen.getValue(), maercheneinteilungErfassenModel.getMaerchen());
    setModelMaerchen();
  ...
  private void onGruppeSelected() {
    LOGGER.trace(
        "MaercheneinteilungErfassenController Event Gruppe selected={}",
        comboBoxGruppe.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            comboBoxGruppe.getSelectedItem(), maercheneinteilungErfassenModel.getGruppe());
    try {
      setModelGruppe();
  ...
  private void setModelGruppe() throws SvmRequiredException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelGruppe RequiredException={}",
          e.getMessage());
  ...
  public void setTxtRolle1(JTextField txtRolle1) {
    ...
    this.txtRolle1.addFocusListener(
        new FocusAdapter() {
          @Override
  ...
  private void onRolle1Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtRolle1.getText(), maercheneinteilungErfassenModel.getRolle1());
    try {
  ...
  private void setModelRolle1(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle1 RequiredException={}",
          e.getMessage());
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle1 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setTxtBilderRolle1(JTextField txtBilderRolle1) {
    ...
    this.txtBilderRolle1.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onBilderRolle1Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            txtBilderRolle1.getText(), maercheneinteilungErfassenModel.getBilderRolle1());
    try {
  ...
  private void setModelBilderRolle1(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle1 RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle1 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setTxtRolle2(JTextField txtRolle2) {
    ...
    this.txtRolle2.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
            onRolle2Event(false);
  ...
  private void onRolle2Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtRolle2.getText(), maercheneinteilungErfassenModel.getRolle2());
    try {
  ...
  private void setModelRolle2(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle2 RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle2 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setTxtBilderRolle2(JTextField txtBilderRolle2) {
    ...
    this.txtBilderRolle2.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onBilderRolle2Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            txtBilderRolle2.getText(), maercheneinteilungErfassenModel.getBilderRolle2());
    try {
  ...
  private void setModelBilderRolle2(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle2 RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle2 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setTxtRolle3(JTextField txtRolle3) {
    ...
    this.txtRolle3.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
            onRolle3Event(false);
  ...
  private void onRolle3Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtRolle3.getText(), maercheneinteilungErfassenModel.getRolle3());
    try {
  ...
  private void setModelRolle3(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle3 RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelRolle3 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setTxtBilderRolle3(JTextField txtBilderRolle3) {
    ...
    this.txtBilderRolle3.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onBilderRolle3Event(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            txtBilderRolle3.getText(), maercheneinteilungErfassenModel.getBilderRolle3());
    try {
  ...
  private void setModelBilderRolle3(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle3 RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBilderRolle3 Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  public void setComboBoxElternmithilfe(JComboBox<Elternmithilfe> comboBoxElternmithilfe) {
    ...
    Elternmithilfe[] selectableElternmithilfen =
        maercheneinteilungErfassenModel.getSelectableElternmithilfen(schuelerDatenblattModel);
  ...
  private void onElternmithilfeSelected() {
    LOGGER.trace(
        "MaercheneinteilungErfassenController Event Elternmithilfe selected={}",
        comboBoxElternmithilfe.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            comboBoxElternmithilfe.getSelectedItem(),
            maercheneinteilungErfassenModel.getElternmithilfe());
  ...
  private void setModelElternmithilfe() {
    ...
    maercheneinteilungErfassenModel.setElternmithilfe(
        (Elternmithilfe) comboBoxElternmithilfe.getSelectedItem());
  }

  public void setComboBoxElternmithilfeCode(
      JComboBox<ElternmithilfeCode> comboBoxElternmithilfeCode) {
    this.comboBoxElternmithilfeCode = comboBoxElternmithilfeCode;
    ElternmithilfeCode[] selectableElternmithilfeCodes =
        maercheneinteilungErfassenModel.getSelectableElternmithilfeCodes(svmContext.getSvmModel());
  ...
  private void onElternmithilfeCodeSelected() {
    LOGGER.trace(
        "MaercheneinteilungErfassenController Event ElternmithilfeCode selected={}",
        comboBoxElternmithilfeCode.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            comboBoxElternmithilfeCode.getSelectedItem(),
            maercheneinteilungErfassenModel.getElternmithilfeCode());
  ...
  private void setModelElternmithilfeCode() {
    ...
    maercheneinteilungErfassenModel.setElternmithilfeCode(
  ...
  private void onKuchenVorstellung1Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung1. Selected={}",
        checkBoxKuchenVorstellung1.isSelected());
  ...
  private void onKuchenVorstellung2Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung2. Selected={}",
        checkBoxKuchenVorstellung2.isSelected());
  ...
  private void onKuchenVorstellung3Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung3. Selected={}",
        checkBoxKuchenVorstellung3.isSelected());
  ...
  private void onKuchenVorstellung4Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung4. Selected={}",
        checkBoxKuchenVorstellung4.isSelected());
  ...
  private void onKuchenVorstellung5Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung5. Selected={}",
        checkBoxKuchenVorstellung5.isSelected());
  ...
  private void onKuchenVorstellung6Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung6. Selected={}",
        checkBoxKuchenVorstellung6.isSelected());
  ...
  private void onKuchenVorstellung7Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung7. Selected={}",
        checkBoxKuchenVorstellung7.isSelected());
  ...
  private void onKuchenVorstellung8Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung8. Selected={}",
        checkBoxKuchenVorstellung8.isSelected());
  ...
  private void onKuchenVorstellung9Event() {
    LOGGER.trace(
        "AngehoerigerController Event KuchenVorstellung9. Selected={}",
        checkBoxKuchenVorstellung9.isSelected());
  ...
  public void setTxtZusatzattribut(JTextField txtZusatzattribut) {
    ...
    this.txtZusatzattribut.addFocusListener(
        new FocusAdapter() {
          @Override
          public void focusLost(FocusEvent e) {
  ...
  private void onZusatzattributEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(
            txtZusatzattribut.getText(), maercheneinteilungErfassenModel.getZusatzattribut());
    try {
  ...
  private void setModelZusatzattribut(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelZusatzattribut RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelZusatzattribut Exception={}",
          e.getMessage());
      showErrMsg(e);
      throw e;
    }
  ...
  private void onBemerkungenEvent(boolean showRequiredErrMsg) {
    ...
    boolean equalFieldAndModelValue =
        equalsNullSafe(txtBemerkungen.getText(), maercheneinteilungErfassenModel.getBemerkungen());
    try {
  ...
  private void setModelBemerkungen(boolean showRequiredErrMsg) throws SvmValidationException {
    ...
    try {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBemerkungen RequiredException={}",
          e.getMessage());
      if (isModelValidationMode() || !showRequiredErrMsg) {
      ...
      LOGGER.trace(
          "MaercheneinteilungErfassenController setModelBemerkungen Exception={}", e.getMessage());
      showErrMsg(e);
      throw e;
    }
  }
  ...
  private void onSpeichern() {
    ...
    if (n == 0) {
      if (!maercheneinteilungErfassenModel.checkIfElternmithilfeHasTelefon(
          schuelerDatenblattModel)) {
        JOptionPane.showMessageDialog(
            maercheneinteilungErfassenDialog,
            "Für die Elternmithilfe sind weder Festnetz noch Natel erfasst. Bitte Schüler-Stammdaten ergänzen.",
            "Elternmithilfe ohne Telefon",
            JOptionPane.WARNING_MESSAGE);
      }
      if (!maercheneinteilungErfassenModel.checkIfElternmithilfeHasEmail(schuelerDatenblattModel)) {
        JOptionPane.showMessageDialog(
            maercheneinteilungErfassenDialog,
            "Für die Elternmithilfe ist keine E-Mail erfasst. Bitte Schüler-Stammdaten ergänzen.",
            "Elternmithilfe ohne E-Mail",
            JOptionPane.WARNING_MESSAGE);
      }
      maercheneinteilungErfassenModel.speichern(
          maercheneinteilungenTableModel, schuelerDatenblattModel);
    }
  ...
  private void writeElternhilfeBereitsErfasstBemerkung() {
    if (!checkNotEmpty(maercheneinteilungErfassenModel.getBemerkungen())
      ...
      for (Maercheneinteilung maercheneinteilungGeschwister :
          maercheneinteilungenVonGeschwisternMitBereitsErfassterElternmithilfe) {
        geschwisterStringBuilder
            .append(maercheneinteilungGeschwister.getSchueler().getVorname())
            .append(" ")
      ...
      // Letztes ", " weglassen
      String geschwister =
          geschwisterStringBuilder.substring(0, geschwisterStringBuilder.length() - 2);
      try {
  ...
  private void enableDisableFields() {
    if (maercheneinteilungErfassenModel.getElternmithilfe() == null
        || maercheneinteilungErfassenModel.getElternmithilfe() != Elternmithilfe.DRITTPERSON) {
