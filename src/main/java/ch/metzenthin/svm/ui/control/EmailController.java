...
public class EmailController extends AbstractController {
  ...
  private void onEmailEmpfaengerSelected() {
    LOGGER.trace(
        "EmailController Event EmailEmpfaenger selected={}",
        comboBoxEmailEmpfaenger.getSelectedItem());
    boolean equalFieldAndModelValue =
        equalsNullSafe(comboBoxEmailEmpfaenger.getSelectedItem(), emailModel.getEmailEmpfaenger());
  ...
  private void onOk() {
    ...
    CallDefaultEmailClientCommand.Result result =
        emailModel.callEmailClient(schuelerDatenblattModel);
