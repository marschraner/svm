...
public class SchuelerDatenblattController {
  ...
  public SchuelerDatenblattController(
    ...
    schuelerDatenblattModel =
        schuelerSuchenTableModel.getSchuelerDatenblattModel(convertRowIndexToModel());
  }

  private void scroll(int selectedRow) {
    if ((this.selectedRow == selectedRow)
        || (selectedRow < 0)
        || (selectedRow >= schuelerSuchenTableModel.getRowCount())) {
      return;
    }
    this.selectedRow = selectedRow;
    setNewModel();
  ...
  private void setLabelVornameNachname() {
    String abgemeldet =
        (schuelerDatenblattModel.getSchueler().isAbgemeldet() ? "  (abgemeldet)" : "");
    labelVornameNachname.setText(
  ...
  public void setLabelSchuelerGleicherRechnungsempfaenger1(
      JLabel labelSchuelerGleicherRechnungsempfaenger1) {
  ...
  private void setLabelSchuelerGleicherRechnungsempfaenger1() {
    labelSchuelerGleicherRechnungsempfaenger1.setVisible(
        !schuelerDatenblattModel.getSchuelerGleicherRechnungsempfaengerAsString().isEmpty());
    labelSchuelerGleicherRechnungsempfaenger1.setText(
        schuelerDatenblattModel.getLabelSchuelerGleicherRechnungsempfaenger1());
  }

  public void setLabelSchuelerGleicherRechnungsempfaenger2(
      JLabel labelSchuelerGleicherRechnungsempfaenger2) {
  ...
  private void setLabelSchuelerGleicherRechnungsempfaenger2() {
    labelSchuelerGleicherRechnungsempfaenger2.setVisible(
        !schuelerDatenblattModel.getSchuelerGleicherRechnungsempfaengerAsString().isEmpty());
    labelSchuelerGleicherRechnungsempfaenger2.setText(
        schuelerDatenblattModel.getLabelSchuelerGleicherRechnungsempfaenger2());
  }

  public void setLabelSchuelerGleicherRechnungsempfaengerValue(
      JLabel labelSchuelerGleicherRechnungsempfaengerValue) {
    this.labelSchuelerGleicherRechnungsempfaengerValue =
        labelSchuelerGleicherRechnungsempfaengerValue;
    setLabelSchuelerGleicherRechnungsemfpaengerValue();
  }

  private void setLabelSchuelerGleicherRechnungsemfpaengerValue() {
    labelSchuelerGleicherRechnungsempfaengerValue.setVisible(
        !schuelerDatenblattModel.getSchuelerGleicherRechnungsempfaengerAsString().isEmpty());
    labelSchuelerGleicherRechnungsempfaengerValue.setText(
        schuelerDatenblattModel.getSchuelerGleicherRechnungsempfaengerAsString());
  }
  ...
  private void setLabelFruehereAnmeldungen() {
    labelFruehereAnmeldungen.setVisible(
        !schuelerDatenblattModel.getFruehereAnmeldungenAsString().isEmpty());
  }
  ...
  private void setLabelFruehereAnmeldungenValue() {
    labelFruehereAnmeldungenValue.setVisible(
        !schuelerDatenblattModel.getFruehereAnmeldungenAsString().isEmpty());
  ...
  private void setLabelNichtDispensiert() {
    labelNichtDispensiert.setVisible(
        schuelerDatenblattModel.getDispensationsdauerAsString().isEmpty());
  }
  ...
  private void setLabelDispensationsdauer() {
    labelDispensationsdauer.setVisible(
        !schuelerDatenblattModel.getDispensationsdauerAsString().isEmpty());
  }
  ...
  private void setLabelFruehereDispensationenValue() {
    labelFruehereDispensationenValue.setText(
        schuelerDatenblattModel.getFruehereDispensationenAsString());
  }
  ...
  private void setLabelSemesterKurseValue() {
    labelSemesterKurseValue.setText(
        schuelerDatenblattModel.getSemesterKurseAsString(svmContext.getSvmModel()));
  }
  ...
  private void setLabelVorstellungenKuchenValue() {
    if (schuelerDatenblattModel.getMaerchen().equals("-")) {
      ...
      labelVorstellungenKuchenValue.setText(
          schuelerDatenblattModel.getKuchenVorstellungenAsString());
  ...
  private void onZurueck() {
    if (schuelerSuchenTableModel.getRowCount() > 1) {
      ...
      zurueckZuSchuelerSuchenListener.actionPerformed(
          new ActionEvent(btnZurueck, ActionEvent.ACTION_PERFORMED, "Zurück zu Schüler suchen"));
    }
  }
  ...
  private void onStammdatenBearbeiten() {
    ...
    SchuelerErfassenPanel schuelerErfassenPanel =
        new SchuelerErfassenPanel(svmContext, schuelerDatenblattModel);
    ...
    nextPanelListener.actionPerformed(
        new ActionEvent(
            new Object[] {schuelerErfassenPanel.$$$getRootComponent$$$(), "Stammdaten bearbeiten"},
            ActionEvent.ACTION_PERFORMED,
            "Schueler bearbeiten"));
  }
  ...
  private void onDispensationenBearbeiten() {
    DispensationenTableModel dispensationenTableModel =
        new DispensationenTableModel(schuelerDatenblattModel.getDispensationenTableData());
    DispensationenPanel dispensationenPanel =
        new DispensationenPanel(
            svmContext,
    ...
    nextPanelListener.actionPerformed(
        new ActionEvent(
            new Object[] {dispensationenPanel.$$$getRootComponent$$$(), "Dispensationen"},
            ActionEvent.ACTION_PERFORMED,
            "Dispensationen"));
  }
  ...
  private void onCodesBearbeiten() {
    CodesTableModel codesTableModel =
        new CodesTableModel(schuelerDatenblattModel.getCodesTableData());
    ...
    nextPanelListener.actionPerformed(
        new ActionEvent(
            new Object[] {codesPanel.$$$getRootComponent$$$(), "Codes"},
            ActionEvent.ACTION_PERFORMED,
            "Codes"));
  }
  ...
  private void onKurseBearbeiten() {
    KursanmeldungenTableModel kursanmeldungenTableModel =
        new KursanmeldungenTableModel(schuelerDatenblattModel.getKurseinteilungenTableData());
    String titel =
        "Kurse "
            + schuelerDatenblattModel.getSchuelerVorname()
            + " "
            + schuelerDatenblattModel.getSchuelerNachname();
    KursanmeldungPanel kursanmeldungPanel =
        new KursanmeldungPanel(
            svmContext,
            kursanmeldungenTableModel,
            schuelerDatenblattModel,
            schuelerSuchenTableModel,
            schuelerSuchenResultTable,
            selectedRow,
    ...
    nextPanelListener.actionPerformed(
        new ActionEvent(
            new Object[] {kursanmeldungPanel.$$$getRootComponent$$$(), "Kurse"},
            ActionEvent.ACTION_PERFORMED,
            "Kurse"));
  }
  ...
  private void onMaerchenBearbeiten() {
    MaercheneinteilungenTableModel maercheneinteilungenTableModel =
        new MaercheneinteilungenTableModel(
            schuelerDatenblattModel.getMaercheneinteilungenTableData());
    String titel =
        "Märcheneinteilungen "
            + schuelerDatenblattModel.getSchuelerVorname()
            + " "
            + schuelerDatenblattModel.getSchuelerNachname();
    MaercheneinteilungenPanel maercheneinteilungenPanel =
        new MaercheneinteilungenPanel(
            svmContext,
            maercheneinteilungenTableModel,
            schuelerDatenblattModel,
            schuelerSuchenTableModel,
            schuelerSuchenResultTable,
            selectedRow,
    ...
    nextPanelListener.actionPerformed(
        new ActionEvent(
            new Object[] {
              maercheneinteilungenPanel.$$$getRootComponent$$$(), "Märcheneinteilungen"
            },
            ActionEvent.ACTION_PERFORMED,
            "Märcheneinteilungen"));
  }
