...
public class CodeListPanel extends AbstractListPanel {
  ...
  public CodeListPanel(String title) {
    $$$setupUI$$$();
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Codes",
