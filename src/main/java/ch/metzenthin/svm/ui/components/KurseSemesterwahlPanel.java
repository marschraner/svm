...
public class KurseSemesterwahlPanel extends AbstractSuchenPanel {
  ...
  @Getter private JSpinner semesterSpinner;
  private JButton btnOk;
  private JButton btnAbbrechen;

  public KurseSemesterwahlPanel() {
    $$$setupUI$$$();
  }
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Schuljahr / Semester",
    ...
    gbc.anchor = GridBagConstraints.WEST;
    gbc.fill = GridBagConstraints.HORIZONTAL;
    panel1.add(semesterSpinner, gbc);
