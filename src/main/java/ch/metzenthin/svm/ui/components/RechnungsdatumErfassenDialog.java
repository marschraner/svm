...
public class RechnungsdatumErfassenDialog extends JDialog {
  ...
  public RechnungsdatumErfassenDialog(
  ...
  private void createRechnungsdatumErfassenController(
      SvmContext svmContext,
      SemesterrechnungenTableModel semesterrechnungenTableModel,
      Rechnungstyp rechnungstyp) {
    RechnungsdatumErfassenModel rechnungsdatumErfassenModel =
        svmContext.getModelFactory().createRechnungsdatumErfassenModel();
    RechnungsdatumErfassenController rechnungsdatumErfassenController =
        new RechnungsdatumErfassenController(
            semesterrechnungenTableModel,
            rechnungsdatumErfassenModel,
            rechnungstyp,
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Rechnungsdatum",
