...
public class MitarbeitersPanel {
  ...
  private void createMitarbeitersController(
      SvmContext svmContext, MitarbeitersTableModel mitarbeitersTableModel) {
    mitarbeitersController =
        new MitarbeitersController(
            svmContext.getModelFactory().createLehrkraefteModel(),
            svmContext,
