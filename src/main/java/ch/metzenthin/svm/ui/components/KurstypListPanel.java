...
public class KurstypListPanel extends AbstractListPanel {

  private JPanel panel1;
  private JPanel datenPanel;
  private JPanel titelPanel;
  private JPanel buttonPanel;
  private JTable kurstypTable;
  ...
  public KurstypListPanel() {
    $$$setupUI$$$();
  }

  private void createUIComponents() {
    kurstypTable = new JTable();
    kurstypTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
  }
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Kurstypen",
    ...
    kurstypTable.setPreferredScrollableViewportSize(new Dimension(400, 300));
    scrollPane1.setViewportView(kurstypTable);
