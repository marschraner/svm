...
public class SchuelerPanel {
  ...
  private SchuelerController createSchuelerController(
      SchuelerModel schuelerModel, boolean defaultButtonEnabled) {
    SchuelerController schuelerController =
        new SchuelerController(schuelerModel, defaultButtonEnabled);
