...
public class KursanmeldungPanel {
  ...
  public KursanmeldungPanel(
    ...
    createUIComponents();
    createKurseinteilungenController(
        svmContext,
  ...
  private void createKurseinteilungenController(
      SvmContext svmContext,
      KursanmeldungenTableModel kursanmeldungenTableModel,
      SchuelerDatenblattModel schuelerDatenblattModel,
      SchuelerSuchenTableModel schuelerSuchenTableModel,
      ...
      int selectedRow,
      boolean isFromSchuelerSuchenResult) {
    kursanmeldungenController =
        new KursanmeldungenController(
            svmContext.getModelFactory().createKursanmeldungenModel(),
            svmContext,
            kursanmeldungenTableModel,
            schuelerDatenblattModel,
            schuelerSuchenTableModel,
