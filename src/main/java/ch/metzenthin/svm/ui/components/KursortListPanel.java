...
public class KursortListPanel extends AbstractListPanel {

  private JPanel panel1;
  private JPanel datenPanel;
  private JPanel titelPanel;
  private JPanel buttonPanel;
  private JTable kursortTable;
  ...
  public KursortListPanel() {
    $$$setupUI$$$();
  }

  private void createUIComponents() {
    kursortTable = new JTable();
    kursortTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
  }
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Kursorte",
    ...
    kursortTable.setPreferredScrollableViewportSize(new Dimension(400, 300));
    scrollPane1.setViewportView(kursortTable);
