...
public class MaercheneinteilungenPanel {
  ...
  public MaercheneinteilungenPanel(
    ...
    createUIComponents();
    createMaercheneinteilungenController(
        svmContext,
  ...
  private void createMaercheneinteilungenController(
      SvmContext svmContext,
      MaercheneinteilungenTableModel maercheneinteilungenTableModel,
      SchuelerDatenblattModel schuelerDatenblattModel,
      SchuelerSuchenTableModel schuelerSuchenTableModel,
      ...
      int selectedRow,
      boolean isFromSchuelerSuchenResult) {
    maercheneinteilungenController =
        new MaercheneinteilungenController(
            svmContext.getModelFactory().createMaercheneinteilungenModel(),
            svmContext,
            maercheneinteilungenTableModel,
            schuelerDatenblattModel,
            schuelerSuchenTableModel,
  ...
  public void addZurueckZuSchuelerSuchenListener(ActionListener zurueckZuSchuelerSuchenListener) {
    maercheneinteilungenController.addZurueckZuSchuelerSuchenListener(
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Märcheneinteilungen",
