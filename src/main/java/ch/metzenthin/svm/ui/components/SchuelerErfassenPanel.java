...
public class SchuelerErfassenPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Vater", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(panel3.getFont().getName(), Font.BOLD, panel3.getFont().getSize())));
        ...
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel3.add(vaterPanel.$$$getRootComponent$$$(), gbc);
        ...
        panel4.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Mutter"));
        ...
        gbc.weighty = 0.5;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel4.add(mutterPanel.$$$getRootComponent$$$(), gbc);
        ...
        panel5.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Rechnungsempfänger"));
        ...
        gbc.weighty = 0.5;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel5.add(rechnungsempfaengerPanel.$$$getRootComponent$$$(), gbc);
