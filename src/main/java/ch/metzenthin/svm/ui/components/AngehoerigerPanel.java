...
public class AngehoerigerPanel {
  ...
  public AngehoerigerController setModel(
      AngehoerigerModel angehoerigerModel, boolean defaultButtonEnabled) {
    initializeErrLbls();
    return createAngehoerigerController(angehoerigerModel, defaultButtonEnabled);
  }

  @SuppressWarnings("DuplicatedCode")
  private AngehoerigerController createAngehoerigerController(
      AngehoerigerModel angehoerigerModel, boolean defaultButtonEnabled) {
    AngehoerigerController angehoerigerController =
        new AngehoerigerController(angehoerigerModel, defaultButtonEnabled);
