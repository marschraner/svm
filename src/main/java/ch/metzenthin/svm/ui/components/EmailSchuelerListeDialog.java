...
public class EmailSchuelerListeDialog extends JDialog {
  ...
  public EmailSchuelerListeDialog(
  ...
  private void createEmailController(
    ...
    EmailSchuelerListeModel emailSchuelerListeModel =
        svmContext.getModelFactory().createEmailSchuelerListeModel();
    EmailSchuelerListeController emailSchuelerListeController =
        new EmailSchuelerListeController(emailSchuelerListeModel, schuelerSuchenTableModel);
    emailSchuelerListeController.setEmailSchuelerListeDialog(this);
    emailSchuelerListeController.setContentPane(contentPane);
    emailSchuelerListeController.setComboBoxEmailSchuelerListeEmpfaengerGruppe(
        comboBoxEmailSchuelerListeEmpfaengerGruppe);
  ...
  private void createUIComponents() {
    comboBoxEmailSchuelerListeEmpfaengerGruppe =
        new JComboBox<>(EmailSchuelerListeEmpfaengerGruppe.values());
  }
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "E-Mail Empfänger-Gruppe",
