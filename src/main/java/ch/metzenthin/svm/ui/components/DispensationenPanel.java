...
public class DispensationenPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Dispensationen"));
        ...
        btnNeuenEintrag = new JButton();
        btnNeuenEintrag.setActionCommand("Neuen Eintrag");
        btnNeuenEintrag.setMaximumSize(new Dimension(168, 29));
        btnNeuenEintrag.setMinimumSize(new Dimension(168, 29));
        btnNeuenEintrag.setPreferredSize(new Dimension(168, 29));
        btnNeuenEintrag.setSelected(true);
        btnNeuenEintrag.setText("Neuen Eintrag");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.insets = new Insets(5, 5, 10, 5);
        panel5.add(btnNeuenEintrag, gbc);
        btnEintragBearbeiten = new JButton();
        btnEintragBearbeiten.setMaximumSize(new Dimension(168, 29));
        btnEintragBearbeiten.setMinimumSize(new Dimension(168, 29));
        btnEintragBearbeiten.setPreferredSize(new Dimension(168, 29));
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.insets = new Insets(5, 5, 10, 5);
        panel5.add(btnEintragBearbeiten, gbc);
        ...
        btnZurueck.setMaximumSize(new Dimension(143, 29));
        btnZurueck.setMinimumSize(new Dimension(143, 29));
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.insets = new Insets(5, 5, 10, 5);
        panel6.add(btnZurueck, gbc);
        btnAbbrechen = new JButton();
        btnAbbrechen.setMaximumSize(new Dimension(143, 29));
        btnAbbrechen.setMinimumSize(new Dimension(143, 29));
