...
public class MaerchenErfassenDialog extends JDialog {
  ...
  public MaerchenErfassenDialog(
      SvmContext svmContext,
      MaerchensTableModel maerchensTableModel,
      MaerchensModel maerchensModel,
      int indexBearbeiten,
    ...
    createMaerchenErfassenController(
        svmContext, maerchensTableModel, maerchensModel, indexBearbeiten, isBearbeiten);
  }

  private void createMaerchenErfassenController(
      SvmContext svmContext,
      MaerchensTableModel maerchensTableModel,
      MaerchensModel maerchensModel,
      int indexBearbeiten,
    ...
    MaerchenErfassenModel maerchenErfassenModel =
        (isBearbeiten
            ? maerchensModel.getMaerchenErfassenModel(svmContext, indexBearbeiten)
            : svmContext.getModelFactory().createMaerchenErfassenModel());
    MaerchenErfassenController maerchenErfassenController =
        new MaerchenErfassenController(
            svmContext,
            maerchensTableModel,
            maerchenErfassenModel,
            isBearbeiten,
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Märchen",
