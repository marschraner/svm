...
public class EmailSemesterrechnungenDialog extends JDialog {
  ...
  public EmailSemesterrechnungenDialog(
  ...
  private void createEmailSemesterrechnungenController(
      SvmContext svmContext, SemesterrechnungenTableModel semesterrechnungenTableModel) {
    EmailSemesterrechnungenModel emailSemesterrechnungenModel =
        svmContext.getModelFactory().createEmailSemesterrechnungenModel();
    EmailSemesterrechnungenController emailSemesterrechnungenController =
        new EmailSemesterrechnungenController(
            emailSemesterrechnungenModel, semesterrechnungenTableModel);
