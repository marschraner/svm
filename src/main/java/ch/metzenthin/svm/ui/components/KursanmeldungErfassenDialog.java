...
public class KursanmeldungErfassenDialog extends JDialog {
  ...
  public KursanmeldungErfassenDialog(
    ...
    createKursanmeldungErfassenController(
        svmContext,
  ...
  private void createKursanmeldungErfassenController(
      SvmContext svmContext,
      KursanmeldungenModel kursanmeldungenModel,
      KursanmeldungenTableModel kursanmeldungenTableModel,
      SchuelerDatenblattModel schuelerDatenblattModel,
    ...
    KursanmeldungErfassenModel kursanmeldungErfassenModel =
        (isBearbeiten
            ? kursanmeldungenModel.getKursanmeldungErfassenModel(
                svmContext, kursanmeldungenTableModel, indexBearbeiten)
            : svmContext.getModelFactory().createKursanmeldungErfassenModel());
    KursanmeldungErfassenController kursanmeldungErfassenController =
        new KursanmeldungErfassenController(
            svmContext,
            kursanmeldungErfassenModel,
            kursanmeldungenTableModel,
            schuelerDatenblattModel,
            isBearbeiten,
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Kursanmeldung",
