...
public class SemesterrechnungenPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Semesterrechnungen", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel2.getFont())));
        ...
        btnAlleSelektieren.setMaximumSize(new Dimension(131, 18));
        btnAlleSelektieren.setMinimumSize(new Dimension(131, 18));
        btnAlleSelektieren.setOpaque(false);
        btnAlleSelektieren.setPreferredSize(new Dimension(131, 18));
        ...
        btnAlleDeselektieren.setMaximumSize(new Dimension(143, 18));
        btnAlleDeselektieren.setMinimumSize(new Dimension(143, 18));
        btnAlleDeselektieren.setOpaque(false);
        btnAlleDeselektieren.setPreferredSize(new Dimension(143, 18));
