...
public class SemesterrechnungenPanel {
    ...
    public SemesterrechnungenPanel(SvmContext svmContext, SemesterrechnungenTableModel semesterrechnungenTableModel) {
        $$$setupUI$$$();
        createUIComponents();
        semesterrechnungenController = new SemesterrechnungenController(svmContext, semesterrechnungenTableModel, semesterrechnungenTable);
        ...
        semesterrechnungenController.setBtnRechnungsdatumAlle(btnRechnungsdatumAlle);
        semesterrechnungenController.setBtnSchulgeldAlle(btnSchulgeldAlle);
    ...
    private void $$$setupUI$$$() {
        ...
        btnRechnungsdatumAlle = new JButton();
        btnRechnungsdatumAlle.setMaximumSize(new Dimension(158, 29));
        btnRechnungsdatumAlle.setMinimumSize(new Dimension(158, 29));
        btnRechnungsdatumAlle.setPreferredSize(new Dimension(158, 29));
        btnRechnungsdatumAlle.setText("Rechn.datum alle");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel3.add(btnRechnungsdatumAlle, gbc);
        ...
        btnSchulgeldAlle = new JButton();
        btnSchulgeldAlle.setMaximumSize(new Dimension(134, 29));
        btnSchulgeldAlle.setMinimumSize(new Dimension(134, 29));
        btnSchulgeldAlle.setPreferredSize(new Dimension(134, 29));
        btnSchulgeldAlle.setText("Schulgeld alle");
        gbc = new GridBagConstraints();
        gbc.gridx = 4;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel3.add(btnSchulgeldAlle, gbc);
        ...
        btnPanel.add(panel4, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel4.add(btnDetailsBearbeiten, gbc);
