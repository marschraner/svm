...
public class MaerchensPanel {
  ...
  private void createMaerchensController(SvmContext svmContext) {
    maerchensController =
        new MaerchensController(svmContext.getModelFactory().createMaerchensModel(), svmContext);
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Märchen",
