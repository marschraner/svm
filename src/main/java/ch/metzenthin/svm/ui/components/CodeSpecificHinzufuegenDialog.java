...
public class CodeSpecificHinzufuegenDialog extends JDialog {
  ...
  public CodeSpecificHinzufuegenDialog(
    ...
    createCodeSchuelerHinzufuegenController(
        svmContext,
        codesTableModel,
        codesModel,
  ...
  private void createCodeSchuelerHinzufuegenController(
      SvmContext svmContext,
      CodesTableModel codesTableModel,
      CodesModel codesModel,
      SchuelerDatenblattModel schuelerDatenblattModel,
    ...
    CodeSpecificHinzufuegenModel codeSpecificHinzufuegenModel =
        svmContext.getModelFactory().createCodeSchuelerHinzufuegenModel();
    CodeSpecificHinzufuegenController codeSpecificHinzufuegenController =
        new CodeSpecificHinzufuegenController(
            svmContext,
            codesTableModel,
            codeSpecificHinzufuegenModel,
            codesModel,
            schuelerDatenblattModel,
            mitarbeiterErfassenModel,
            codetyp);
