...
public class UiComponentsUtils {
  ...
  /**
   * Source: <a
   * href="https://kahdev.wordpress.com/2011/10/30/java-specifying-the-column-widths-of-a-jtable-as-percentages/">...</a>
   *
   * <p>Set the width of the columns as percentages.
   *
   * @param table the {@link JTable} whose columns will be set
   * @param percentages the widths of the columns as percentages; note: this method does NOT verify
   *     that all percentages add up to 100% and for the columns to appear properly, it is
   *     recommended that the widths for ALL columns be specified
   */
    ...
    for (int i = 0; i < tableModel.getColumnCount(); i++) {
      ...
      if (columnClass.equals(String.class)) {
        tableCellRenderer = new StringTableCellRenderer();
          ...
          || columnClass.equals(BigDecimal.class)) {
