...
public class MaerchenListPanel extends AbstractListPanel {

  private JPanel panel1;
  private JPanel datenPanel;
  private JPanel titelPanel;
  private JPanel buttonPanel;
  private JTable maerchenListTable;
  ...
  public JTable getTable() {
    return maerchenListTable;
  }

  public MaerchenListPanel() {
    $$$setupUI$$$();
  }

  private void createUIComponents() {
    maerchenListTable = new JTable();
    maerchenListTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
  }
  ...
  private void $$$setupUI$$$() {
    ...
    maerchenListTable.setPreferredScrollableViewportSize(new Dimension(750, 400));
    scrollPane1.setViewportView(maerchenListTable);
