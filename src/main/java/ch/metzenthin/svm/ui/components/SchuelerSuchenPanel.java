...
public class SchuelerSuchenPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.VERTICAL;
        panelRight.add(spacer40, gbc);
        final JPanel spacer41 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.fill = GridBagConstraints.VERTICAL;
        panelRight.add(spacer41, gbc);
        ...
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer42, gbc);
        final JPanel spacer43 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        anAbmeldeStatistikPanel.add(spacer43, gbc);
