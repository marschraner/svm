...
public class SchuelerSuchenPanel {
    ...
    public SchuelerSuchenPanel(SvmContext svmContext) {
        $$$setupUI$$$();
        initializeStammdatenFields();
        initializeKursFields();
        initializeCodesFields();
        initializeAnAbmeldestatistikFields();
        initializeStichtag();
        initializeErrLbls();
        createSchuelerSuchenController(svmContext);
    }

    private void initializeStammdatenFields() {
        ...
        radioBtnSchueler.setEnabled(false);
        radioBtnEltern.setEnabled(false);
        radioBtnRechnungsempfaenger.setEnabled(false);
        radioBtnRolleAlle.setEnabled(false);
    }

    private void initializeKursFields() {
        txtLehrkraft.setEnabled(false);
        comboBoxWochentag.setEnabled(false);
        txtVon.setEnabled(false);
        txtBis.setEnabled(false);
    }

    private void initializeCodesFields() {
        txtCodes.setEnabled(false);
    }

    private void initializeAnAbmeldestatistikFields() {
        txtAnAbmeldemonat.setEnabled(false);
        radioBtnAnmeldungen.setEnabled(false);
        radioBtnAbmeldungen.setEnabled(false);
    }
    ...
    private void createSchuelerSuchenController(SvmContext svmContext) {
        ...
        schuelerSuchenController.setTxtGeburtsdatum(txtGeburtsdatum);
        ...
        schuelerSuchenController.setTxtAnAbmeldemonat(txtAnAbmeldemonat);
        ...
        schuelerSuchenController.setRadioBtnGroupAnAbmeldungen(radioBtnAnmeldungen, radioBtnAbmeldungen);
        schuelerSuchenController.setCheckBoxStammdatenBeruecksichtigen(checkBoxStammdatenBeruecksichtigen);
        schuelerSuchenController.setCheckBoxKursBeruecksichtigen(checkBoxKursBeruecksichtigen);
        schuelerSuchenController.setCheckBoxCodesBeruecksichtigen(checkBoxCodesBeruecksichtigen);
        schuelerSuchenController.setCheckBoxAnAbmeldestatistikBeruecksichtigen(checkBoxAnAbmeldestatistikBeruecksichtigen);
        ...
        schuelerSuchenController.setErrLblGeburtsdatum(errLblGeburtsdatum);
        schuelerSuchenController.setErrLblStichtag(errLblStichtag);
        schuelerSuchenController.setErrLblAnAbmeldemonat(errLblAnAbmeldemonat);
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setLayout(new GridLayoutManager(1, 2, new Insets(10, 0, 10, 0), -1, -1, true, false));
        panel.add(panel1, BorderLayout.SOUTH);
        btnSuchen = new JButton();
        btnSuchen.setText("Suchen");
        panel1.add(btnSuchen, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        btnAbbrechen = new JButton();
        btnAbbrechen.setText("Abbrechen");
        panel1.add(btnAbbrechen, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel2 = new JPanel();
        panel2.setLayout(new GridLayoutManager(2, 2, new Insets(10, 0, 0, 0), -1, -1, true, false));
        panel.add(panel2, BorderLayout.CENTER);
        panelLeft = new JPanel();
        panelLeft.setLayout(new GridBagLayout());
        panel2.add(panelLeft, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        gbc.gridwidth = 9;
        gbc.anchor = GridBagConstraints.WEST;
        stammdatenPanel.add(errLblGeburtsdatum, gbc);
        ...
        label10.setText("Für Suche berücksichtigen");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 20;
        gbc.anchor = GridBagConstraints.WEST;
        stammdatenPanel.add(label10, gbc);
        checkBoxStammdatenBeruecksichtigen = new JCheckBox();
        checkBoxStammdatenBeruecksichtigen.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 20;
        gbc.anchor = GridBagConstraints.WEST;
        stammdatenPanel.add(checkBoxStammdatenBeruecksichtigen, gbc);
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        statusDispensationGeschlechtPanel.add(spacer21, gbc);
        ...
        panel2.add(panelRight, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        checkBoxKursBeruecksichtigen = new JCheckBox();
        checkBoxKursBeruecksichtigen.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 8;
        gbc.anchor = GridBagConstraints.WEST;
        kursPanel.add(checkBoxKursBeruecksichtigen, gbc);
        ...
        label20.setDisplayedMnemonic('C');
        label20.setDisplayedMnemonicIndex(0);
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ...
        checkBoxCodesBeruecksichtigen = new JCheckBox();
        checkBoxCodesBeruecksichtigen.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 4;
        gbc.anchor = GridBagConstraints.WEST;
        codesPanel.add(checkBoxCodesBeruecksichtigen, gbc);
        final JLabel label21 = new JLabel();
        label21.setText("Für Suche berücksichtigen");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 4;
        gbc.anchor = GridBagConstraints.WEST;
        codesPanel.add(label21, gbc);
        ...
        label22.setText("Stichtag");
        label22.setDisplayedMnemonic('T');
        label22.setDisplayedMnemonicIndex(1);
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.WEST;
        stichtagPanel.add(label22, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.ipadx = 200;
        stichtagPanel.add(spacer50, gbc);
        final JPanel spacer51 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.VERTICAL;
        stichtagPanel.add(spacer51, gbc);
        anAbmeldeStatistikPanel = new JPanel();
        anAbmeldeStatistikPanel.setLayout(new GridBagLayout());
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.BOTH;
        ...
        anAbmeldeStatistikPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "An-/Abmeldesstatistik", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(anAbmeldeStatistikPanel.getFont().getName(), Font.BOLD, anAbmeldeStatistikPanel.getFont().getSize()), new Color(-16777216)));
        final JLabel label23 = new JLabel();
        label23.setText("Monat/Jahr");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.WEST;
        anAbmeldeStatistikPanel.add(label23, gbc);
        final JPanel spacer52 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer52, gbc);
        final JPanel spacer53 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        anAbmeldeStatistikPanel.add(spacer53, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        anAbmeldeStatistikPanel.add(txtAnAbmeldemonat, gbc);
        final JPanel spacer54 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 4;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        anAbmeldeStatistikPanel.add(spacer54, gbc);
        ...
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        anAbmeldeStatistikPanel.add(errLblAnAbmeldemonat, gbc);
        ...
        gbc.gridy = 3;
        gbc.anchor = GridBagConstraints.WEST;
        anAbmeldeStatistikPanel.add(radioBtnAbmeldungen, gbc);
        final JPanel spacer55 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 4;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer55, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.ipadx = 200;
        anAbmeldeStatistikPanel.add(spacer56, gbc);
        final JPanel spacer57 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer57, gbc);
        final JLabel label24 = new JLabel();
        label24.setText("Für Suche berücksichtigen");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 6;
        gbc.anchor = GridBagConstraints.WEST;
        anAbmeldeStatistikPanel.add(label24, gbc);
        final JPanel spacer58 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 7;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer58, gbc);
        checkBoxAnAbmeldestatistikBeruecksichtigen = new JCheckBox();
        checkBoxAnAbmeldestatistikBeruecksichtigen.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 6;
        gbc.anchor = GridBagConstraints.WEST;
        anAbmeldeStatistikPanel.add(checkBoxAnAbmeldestatistikBeruecksichtigen, gbc);
        final JPanel spacer59 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 5;
        gbc.fill = GridBagConstraints.VERTICAL;
        anAbmeldeStatistikPanel.add(spacer59, gbc);
        ...
        label20.setLabelFor(txtCodes);
        label22.setLabelFor(txtStichtag);
        label23.setLabelFor(txtAnAbmeldemonat);
