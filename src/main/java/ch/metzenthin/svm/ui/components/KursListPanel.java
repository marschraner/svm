...
public class KursListPanel extends AbstractListPanel {

  private JPanel panel1;
  private JPanel datenPanel;
  private JPanel titelPanel;
  private JPanel kursListTablePanel;
  private JPanel buttonPanel;
  private JLabel lblTitel;
  private JTable kursListTable;
  @Getter private JLabel lblTotal;
  ...
  @Getter private JButton btnImportieren;
  @Getter private JButton btnExportieren;
  ...
  public JTable getTable() {
    return kursListTable;
  }

  public KursListPanel(String titel) {
    $$$setupUI$$$();
    createUIComponents();
  ...
  private void createUIComponents() {
    ...
    kursListTable.setAutoCreateRowSorter(true);
    kursListTable.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    kursListTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    final JScrollPane scrollPane = new JScrollPane(kursListTable);
    kursListTablePanel.add(scrollPane);
  }
  ...
  private void $$$setupUI$$$() {
    ...
    kursListTablePanel = new JPanel();
    kursListTablePanel.setLayout(new BorderLayout(0, 0));
    gbc = new GridBagConstraints();
    gbc.gridx = 1;
    gbc.gridy = 3;
    gbc.gridwidth = 4;
    ...
    gbc.weighty = 1.0;
    gbc.fill = GridBagConstraints.BOTH;
    panel2.add(kursListTablePanel, gbc);
