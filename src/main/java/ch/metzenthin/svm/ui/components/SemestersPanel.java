...
public class SemestersPanel {
    ...
    private void createSemestersController(SvmContext svmContext) {
        semestersController = new SemestersController(svmContext.getModelFactory().createSemestersModel(), svmContext);
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Semester", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(panel2.getFont().getName(), Font.BOLD, panel2.getFont().getSize())));
