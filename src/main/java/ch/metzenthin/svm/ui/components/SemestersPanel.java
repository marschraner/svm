...
public class SemestersPanel {
  ...
  private void createUIComponents() {
    ...
    semestersTable.setAutoCreateRowSorter(true);
    semestersTable.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    semestersTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    final JScrollPane scrollPane = new JScrollPane(semestersTable);
    semestersTablePanel.add(scrollPane);
  }
  ...
  private void $$$setupUI$$$() {
    ...
    label1.setText("Semester verwalten");
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 0;
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Semester",
    ...
    semestersTablePanel = new JPanel();
    semestersTablePanel.setLayout(new BorderLayout(0, 0));
    gbc = new GridBagConstraints();
    gbc.gridx = 1;
    gbc.gridy = 1;
    gbc.weightx = 1.0;
    gbc.weighty = 1.0;
    gbc.fill = GridBagConstraints.BOTH;
    panel2.add(semestersTablePanel, gbc);
