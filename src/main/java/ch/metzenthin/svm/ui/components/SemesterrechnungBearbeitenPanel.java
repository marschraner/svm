...
public class SemesterrechnungBearbeitenPanel {
    ...
    private void createSemesterrechnungBearbeitenController(SvmContext svmContext, SemesterrechnungBearbeitenModel semesterrechnungBearbeitenModel, SemesterrechnungenModel semesterrechnungenModel, SemesterrechnungenTableModel semesterrechnungenTableModel, JTable semesterrechnungenTable, int selectedRow) {
        ...
        semesterrechnungBearbeitenController.setTxtBetragZahlung1Vorrechnung(txtBetragZahlung1Vorrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung1Vorrechnung(txtDatumZahlung1Vorrechnung);
        semesterrechnungBearbeitenController.setTxtBetragZahlung2Vorrechnung(txtBetragZahlung2Vorrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung2Vorrechnung(txtDatumZahlung2Vorrechnung);
        semesterrechnungBearbeitenController.setTxtBetragZahlung3Vorrechnung(txtBetragZahlung3Vorrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung3Vorrechnung(txtDatumZahlung3Vorrechnung);
        ...
        semesterrechnungBearbeitenController.setTxtBetragZahlung1Nachrechnung(txtBetragZahlung1Nachrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung1Nachrechnung(txtDatumZahlung1Nachrechnung);
        semesterrechnungBearbeitenController.setTxtBetragZahlung2Nachrechnung(txtBetragZahlung2Nachrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung2Nachrechnung(txtDatumZahlung2Nachrechnung);
        semesterrechnungBearbeitenController.setTxtBetragZahlung3Nachrechnung(txtBetragZahlung3Nachrechnung);
        semesterrechnungBearbeitenController.setTxtDatumZahlung3Nachrechnung(txtDatumZahlung3Nachrechnung);
        ...
        semesterrechnungBearbeitenController.setErrLblBetragZahlung1Vorrechnung(errLblBetragZahlung1Vorrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung1Vorrechnung(errLblDatumZahlung1Vorrechnung);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung2Vorrechnung(errLblBetragZahlung2Vorrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung2Vorrechnung(errLblDatumZahlung2Vorrechnung);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung3Vorrechung(errLblBetragZahlung3Vorrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung3Vorrechnung(errLblDatumZahlung3Vorrechnung);
        ...
        semesterrechnungBearbeitenController.setErrLblBetragZahlung1Nachrechnung(errLblBetragZahlung1Nachrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung1Nachrechnung(errLblDatumZahlung1Nachrechnung);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung2Nachrechnung(errLblBetragZahlung2Nachrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung2Nachrechnung(errLblDatumZahlung2Nachrechnung);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung3Nachrechung(errLblBetragZahlung3Nachrechnung);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung3Nachrechnung(errLblDatumZahlung3Nachrechnung);
    ...
    private void $$$setupUI$$$() {
        ...
        zahlungenNachrechnungPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Zahlungen Nachrechnung", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(zahlungenNachrechnungPanel.getFont().getName(), Font.BOLD, zahlungenNachrechnungPanel.getFont().getSize())));
        ...
        lblRestbetragNachrechnung.setFont(new Font(lblRestbetragNachrechnung.getFont().getName(), Font.BOLD, lblRestbetragNachrechnung.getFont().getSize()));
        ...
        zahlungenVorrechnungPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Zahlungen Vorrechnung", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(zahlungenVorrechnungPanel.getFont().getName(), Font.BOLD, zahlungenVorrechnungPanel.getFont().getSize())));
        ...
        lblRestbetragVorrechnung.setFont(new Font(lblRestbetragVorrechnung.getFont().getName(), Font.BOLD, lblRestbetragVorrechnung.getFont().getSize()));
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel22.add(spacer141, gbc);
        final JPanel spacer142 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel22.add(spacer142, gbc);
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel23.add(spacer148, gbc);
        final JPanel spacer149 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel23.add(spacer149, gbc);
