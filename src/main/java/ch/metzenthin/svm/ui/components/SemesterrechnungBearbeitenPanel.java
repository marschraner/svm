...
public class SemesterrechnungBearbeitenPanel {
    ...
    private void createSemesterrechnungBearbeitenController(SvmContext svmContext, SemesterrechnungBearbeitenModel semesterrechnungBearbeitenModel, SemesterrechnungenModel semesterrechnungenModel, SemesterrechnungenTableModel semesterrechnungenTableModel, JTable semesterrechnungenTable, int selectedRow) {
        ...
        semesterrechnungBearbeitenController.setLblSechsJahresRabattVorrechnung(lblSechsJahresRabattVorrechnung);
        ...
        semesterrechnungBearbeitenController.setLblMalRabattFaktorVorrechnung(lblMalRabattFaktorVorrechnung);
        semesterrechnungBearbeitenController.setLblRabattFaktorVorrechnung(lblRabattFaktorVorrechnung);
        semesterrechnungBearbeitenController.setLblSchulgeldVorrechnung(lblSchulgeldVorrechnung);
        ...
        semesterrechnungBearbeitenController.setLblSechsJahresRabattNachrechnung(lblSechsJahresRabattNachrechnung);
        semesterrechnungBearbeitenController.setLblErmaessigungNachrechnung(lblErmaessigungNachrechnung);
        semesterrechnungBearbeitenController.setLblZuschlagNachrechnung(lblZuschlagNachrechnung);
        semesterrechnungBearbeitenController.setLblMalRabattFaktorNachrechnung(lblMalRabattFaktorNachrechnung);
        semesterrechnungBearbeitenController.setLblRabattFaktorNachrechnung(lblRabattFaktorNachrechnung);
        semesterrechnungBearbeitenController.setLblSchulgeldNachrechnung(lblSchulgeldNachrechnung);
        semesterrechnungBearbeitenController.setLblRestbetrag(lblRestbetrag);
        semesterrechnungBearbeitenController.setLblScrollPosition(lblScrollPosition);
        semesterrechnungBearbeitenController.setTxtRechnungsdatumVorrechnung(txtRechnungsdatumVorrechnung);
        semesterrechnungBearbeitenController.setTxtErmaessigungVorrechnung(txtErmaessigungVorrechnung);
        semesterrechnungBearbeitenController.setTxtErmaessigungsgrundVorrechnung(txtErmaessigungsgrundVorrechnung);
        semesterrechnungBearbeitenController.setTxtZuschlagVorrechnung(txtZuschlagVorrechnung);
        semesterrechnungBearbeitenController.setTxtZuschlagsgrundVorrechnung(txtZuschlagsgrundVorrechnung);
        ...
        semesterrechnungBearbeitenController.setTxtRechnungsdatumNachrechnung(txtRechnungsdatumNachrechnung);
        semesterrechnungBearbeitenController.setTxtErmaessigungNachrechnung(txtErmaessigungNachrechnung);
        semesterrechnungBearbeitenController.setTxtErmaessigungsgrundNachrechnung(txtErmaessigungsgrundNachrechnung);
        semesterrechnungBearbeitenController.setTxtZuschlagNachrechnung(txtZuschlagNachrechnung);
        semesterrechnungBearbeitenController.setTxtZuschlagsgrundNachrechnung(txtZuschlagsgrundNachrechnung);
        semesterrechnungBearbeitenController.setTxtAnzahlWochenNachrechnung(txtAnzahlWochenNachrechnung);
        semesterrechnungBearbeitenController.setTxtWochenbetragNachrechnung(txtWochenbetragNachrechnung);
        semesterrechnungBearbeitenController.setTxtBetragZahlung1(txtBetragZahlung1);
        semesterrechnungBearbeitenController.setTxtDatumZahlung1(txtDatumZahlung1);
        semesterrechnungBearbeitenController.setTxtBetragZahlung2(txtBetragZahlung2);
        semesterrechnungBearbeitenController.setTxtDatumZahlung2(txtDatumZahlung2);
        semesterrechnungBearbeitenController.setTxtBetragZahlung3(txtBetragZahlung3);
        semesterrechnungBearbeitenController.setTxtDatumZahlung3(txtDatumZahlung3);
        semesterrechnungBearbeitenController.setTextAreaBemerkungen(textAreaBemerkungen);
        semesterrechnungBearbeitenController.setErrLblRechnungsdatumVorrechnung(errLblRechnungsdatumVorrechnung);
        semesterrechnungBearbeitenController.setErrLblErmaessigungVorrechnung(errLblErmaessigungVorrechnung);
        semesterrechnungBearbeitenController.setErrLblErmaessigungsgrundVorrechnung(errLblErmaessigungsgrundVorrechnung);
        semesterrechnungBearbeitenController.setErrLblZuschlagVorrechnung(errLblZuschlagVorrechnung);
        semesterrechnungBearbeitenController.setErrLblZuschlagsgrundVorrechnung(errLblZuschlagsgrundVorrechnung);
        semesterrechnungBearbeitenController.setErrLblAnzahlWochenVorrechnung(errLblAnzahlWochenVorrechnung);
        semesterrechnungBearbeitenController.setErrLblWochenbetragVorrechnung(errLblWochenbetragVorrechnung);
        semesterrechnungBearbeitenController.setErrLblRechnungsdatumNachrechnung(errLblRechnungsdatumNachrechnung);
        semesterrechnungBearbeitenController.setErrLblErmaessigungNachrechnung(errLblErmaessigungNachrechnung);
        semesterrechnungBearbeitenController.setErrLblErmaessigungsgrundNachrechnung(errLblErmaessigungsgrundNachrechnung);
        semesterrechnungBearbeitenController.setErrLblZuschlagNachrechnung(errLblZuschlagNachrechnung);
        semesterrechnungBearbeitenController.setErrLblZuschlagsgrundNachrechnung(errLblZuschlagsgrundNachrechnung);
        semesterrechnungBearbeitenController.setErrLblAnzahlWochenNachrechnung(errLblAnzahlWochenNachrechnung);
        semesterrechnungBearbeitenController.setErrLblWochenbetragNachrechnung(errLblWochenbetragNachrechnung);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung1(errLblBetragZahlung1);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung1(errLblDatumZahlung1);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung2(errLblBetragZahlung2);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung2(errLblDatumZahlung2);
        semesterrechnungBearbeitenController.setErrLblBetragZahlung3(errLblBetragZahlung3);
        semesterrechnungBearbeitenController.setErrLblDatumZahlung3(errLblDatumZahlung3);
        ...
        semesterrechnungBearbeitenController.setComboBoxSemesterrechnungCode(comboBoxSemesterrechnungCode);
        ...
        semesterrechnungBearbeitenController.setBtnWochenbetragNachrechnung(btnWochenbetragNachrechnung);
        ...
        semesterrechnungBearbeitenController.setBtnZurueck(btnZurück);
    ...
    private void initializeErrLbls() {
        ...
        errLblBetragZahlung1.setForeground(Color.RED);
        errLblDatumZahlung1.setVisible(false);
        errLblDatumZahlung1.setForeground(Color.RED);
        errLblBetragZahlung2.setVisible(false);
        errLblBetragZahlung2.setForeground(Color.RED);
        errLblDatumZahlung2.setVisible(false);
        errLblDatumZahlung2.setForeground(Color.RED);
        errLblBetragZahlung3.setVisible(false);
        errLblBetragZahlung3.setForeground(Color.RED);
        errLblDatumZahlung3.setVisible(false);
        errLblDatumZahlung3.setForeground(Color.RED);
    ...
    public void addZurueckZuSemesterrechnungSuchenListener(ActionListener zurueckZuSemesterrechnungSuchenListener) {
        semesterrechnungBearbeitenController.addZurueckZuSemesterrechnungSuchenListener(zurueckZuSemesterrechnungSuchenListener);
    }
    ...
    private void $$$setupUI$$$() {
        ...
        lblNachnameVorname.setFont(new Font(lblNachnameVorname.getFont().getName(), lblNachnameVorname.getFont().getStyle(), 36));
        ...
        rechnungsempfaengerPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Rechungsempfänger", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(rechnungsempfaengerPanel.getFont().getName(), Font.BOLD, rechnungsempfaengerPanel.getFont().getSize())));
        ...
        schuelerKurseVorrechnungPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Schüler / Kurse vorhergehendes Semester (ohne Abmeldungen)", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(schuelerKurseVorrechnungPanel.getFont().getName(), Font.BOLD, schuelerKurseVorrechnungPanel.getFont().getSize())));
        ...
        lblSchulgeldVorrechnung = new JLabel();
        lblSchulgeldVorrechnung.setFont(new Font(lblSchulgeldVorrechnung.getFont().getName(), Font.BOLD, lblSchulgeldVorrechnung.getFont().getSize()));
        lblSchulgeldVorrechnung.setForeground(new Color(-16776961));
        lblSchulgeldVorrechnung.setText("Schulgeld");
        gbc = new GridBagConstraints();
        gbc.gridx = 11;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.WEST;
        panel9.add(lblSchulgeldVorrechnung, gbc);
        ...
        schuelerKurseNachrechnungPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Schüler / Kurse aktuelles Semester", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(schuelerKurseNachrechnungPanel.getFont().getName(), Font.BOLD, schuelerKurseNachrechnungPanel.getFont().getSize())));
        ...
        lblSchulgeldNachrechnung = new JLabel();
        lblSchulgeldNachrechnung.setFont(new Font(lblSchulgeldNachrechnung.getFont().getName(), Font.BOLD, lblSchulgeldNachrechnung.getFont().getSize()));
        lblSchulgeldNachrechnung.setForeground(new Color(-65536));
        lblSchulgeldNachrechnung.setText("Schulgeld");
        gbc = new GridBagConstraints();
        gbc.gridx = 11;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.WEST;
        panel13.add(lblSchulgeldNachrechnung, gbc);
        ...
        zahlungenPanel = new JPanel();
        zahlungenPanel.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1, true, false));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.fill = GridBagConstraints.BOTH;
        gbc.insets = new Insets(0, 10, 10, 10);
        panel3.add(zahlungenPanel, gbc);
        zahlungenPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Zahlungen / Restbetrag", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(zahlungenPanel.getFont().getName(), Font.BOLD, zahlungenPanel.getFont().getSize())));
        final JPanel panel16 = new JPanel();
        panel16.setLayout(new GridBagLayout());
        zahlungenPanel.add(panel16, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        txtBetragZahlung1 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel16.add(txtBetragZahlung1, gbc);
        ...
        txtDatumZahlung1 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel16.add(txtDatumZahlung1, gbc);
        errLblBetragZahlung1 = new JLabel();
        errLblBetragZahlung1.setText("errLblBetragZahlung1");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 1;
        gbc.gridwidth = 3;
        gbc.anchor = GridBagConstraints.WEST;
        panel16.add(errLblBetragZahlung1, gbc);
        errLblDatumZahlung1 = new JLabel();
        errLblDatumZahlung1.setText("errLblDatumZahlung1");
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 1;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panel16.add(errLblDatumZahlung1, gbc);
        ...
        txtBetragZahlung2 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 4;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel16.add(txtBetragZahlung2, gbc);
        errLblBetragZahlung2 = new JLabel();
        errLblBetragZahlung2.setText("errLblBetragZahlung2");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 3;
        gbc.gridwidth = 3;
        gbc.anchor = GridBagConstraints.WEST;
        panel16.add(errLblBetragZahlung2, gbc);
        ...
        txtDatumZahlung2 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 4;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel16.add(txtDatumZahlung2, gbc);
        errLblDatumZahlung2 = new JLabel();
        errLblDatumZahlung2.setText("errLblDatumZahlung2");
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 3;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panel16.add(errLblDatumZahlung2, gbc);
        final JPanel panel17 = new JPanel();
        panel17.setLayout(new GridBagLayout());
        zahlungenPanel.add(panel17, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label41 = new JLabel();
        label41.setText("Zahlung 3:");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        ...
        txtBetragZahlung3 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel17.add(txtBetragZahlung3, gbc);
        errLblBetragZahlung3 = new JLabel();
        errLblBetragZahlung3.setText("errLblBetragZahlung3");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 1;
        gbc.gridwidth = 3;
        gbc.anchor = GridBagConstraints.WEST;
        panel17.add(errLblBetragZahlung3, gbc);
        ...
        txtDatumZahlung3 = new JTextField();
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel17.add(txtDatumZahlung3, gbc);
        errLblDatumZahlung3 = new JLabel();
        errLblDatumZahlung3.setText("errLblDatumZahlung3");
        gbc = new GridBagConstraints();
        gbc.gridx = 5;
        gbc.gridy = 1;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panel17.add(errLblDatumZahlung3, gbc);
        ...
        label43.setFont(new Font(label43.getFont().getName(), Font.BOLD, label43.getFont().getSize()));
        label43.setForeground(new Color(-3669816));
        ...
        lblRestbetrag = new JLabel();
        lblRestbetrag.setFont(new Font(lblRestbetrag.getFont().getName(), Font.BOLD, lblRestbetrag.getFont().getSize()));
        lblRestbetrag.setForeground(new Color(-3669816));
        lblRestbetrag.setText("Restbetrag");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 4;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panel17.add(lblRestbetrag, gbc);
        ...
        stipendiumGratiskindPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Code / Bemerkungen / Stipendium / Gratiskinder", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font(stipendiumGratiskindPanel.getFont().getName(), Font.BOLD, stipendiumGratiskindPanel.getFont().getSize())));
        ...
        buttonPanel.add(panel20, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.WEST;
        panel20.add(lblScrollPosition, gbc);
        ...
        buttonPanel.add(panel21, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel21.add(btnNachfolgender, gbc);
        final JPanel spacer129 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel21.add(spacer129, gbc);
        final JPanel spacer130 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel21.add(spacer130, gbc);
        final JPanel spacer131 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel21.add(spacer131, gbc);
        ...
        btnZurück = new JButton();
        btnZurück.setMaximumSize(new Dimension(114, 29));
        ...
        label37.setLabelFor(txtBetragZahlung1);
        label38.setLabelFor(txtDatumZahlung1);
        label39.setLabelFor(txtBetragZahlung2);
        label40.setLabelFor(txtDatumZahlung2);
        label41.setLabelFor(txtBetragZahlung3);
        label42.setLabelFor(txtDatumZahlung3);
