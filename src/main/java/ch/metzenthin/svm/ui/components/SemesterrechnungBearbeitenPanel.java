...
public class SemesterrechnungBearbeitenPanel {
  ...
  private void $$$setupUI$$$() {
    ...
    rechnungsempfaengerPanel.setLayout(
        new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1, true, false));
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 0;
    gbc.weightx = 1.0;
    ...
    rechnungsempfaengerPanel.setBorder(
        BorderFactory.createTitledBorder(
            ...
            this.$$$getFont$$$(null, Font.BOLD, -1, rechnungsempfaengerPanel.getFont()),
            null));
    final JPanel panel4 = new JPanel();
    panel4.setLayout(new GridBagLayout());
    rechnungsempfaengerPanel.add(
        panel4,
        new GridConstraints(
            0,
            0,
    ...
    schuelerKurseVorrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Schüler / Kurse vorhergehendes Semester (ohne Abmeldungen)",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, schuelerKurseVorrechnungPanel.getFont()),
            null));
    ...
    vorrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Vorrechnung",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, vorrechnungPanel.getFont()),
            null));
    final JPanel panel8 = new JPanel();
    panel8.setLayout(new GridBagLayout());
    vorrechnungPanel.add(
        panel8,
        new GridConstraints(
            0,
            0,
    ...
    Font lblRechnungsbetragVorrechnungFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, lblRechnungsbetragVorrechnung.getFont());
    ...
    schuelerKurseNachrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Schüler / Kurse aktuelles Semester",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, schuelerKurseNachrechnungPanel.getFont()),
            null));
    ...
    nachrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Nachrechnung",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, nachrechnungPanel.getFont()),
            null));
    final JPanel panel12 = new JPanel();
    panel12.setLayout(new GridBagLayout());
    nachrechnungPanel.add(
        panel12,
        new GridConstraints(
            0,
            0,
    ...
    Font lblRechnungsbetragNachrechnungFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, lblRechnungsbetragNachrechnung.getFont());
    ...
    zahlungenNachrechnungPanel.setLayout(
        new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1, true, false));
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 6;
    ...
    zahlungenNachrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Zahlungen Nachrechnung",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, zahlungenNachrechnungPanel.getFont()),
            null));
    final JPanel panel16 = new JPanel();
    panel16.setLayout(new GridBagLayout());
    zahlungenNachrechnungPanel.add(
        panel16,
        new GridConstraints(
            0,
            0,
    ...
    Font lblRestbetragNachrechnungFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, lblRestbetragNachrechnung.getFont());
    ...
    stipendiumGratiskindPanel.setLayout(
        new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1, true, false));
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 7;
    ...
    stipendiumGratiskindPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Code / Bemerkungen / Stipendium / Gratiskinder",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, stipendiumGratiskindPanel.getFont()),
            null));
    final JPanel panel18 = new JPanel();
    panel18.setLayout(new GridBagLayout());
    stipendiumGratiskindPanel.add(
        panel18,
        new GridConstraints(
            0,
            0,
    ...
    zahlungenVorrechnungPanel.setLayout(
        new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1, true, false));
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 3;
    ...
    zahlungenVorrechnungPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Zahlungen Vorrechnung",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, Font.BOLD, -1, zahlungenVorrechnungPanel.getFont()),
            null));
    final JPanel panel20 = new JPanel();
    panel20.setLayout(new GridBagLayout());
    zahlungenVorrechnungPanel.add(
        panel20,
        new GridConstraints(
            0,
            0,
    ...
    Font lblRestbetragVorrechnungFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, lblRestbetragVorrechnung.getFont());
