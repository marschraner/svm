...
public class CreateOrUpdateMitarbeiterView
  ...
  private final JComboBox<Anrede> anredeComboBox;
  ...
  public CreateOrUpdateMitarbeiterView(String title) {
    ...
    this.anredeComboBox = dialog.getComboBoxAnrede();
  ...
  public void setComboBoxAnredeValues(Anrede[] anreden) {
    anredeComboBox.setModel(new DefaultComboBoxModel<>(anreden));
  }

  public Anrede getComboBoxAnredeSelectedItem() {
    return (Anrede) anredeComboBox.getSelectedItem();
  }
