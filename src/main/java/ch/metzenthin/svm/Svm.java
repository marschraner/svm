...
public class Svm {
    ...
    private static void createAndShowGUI(SvmContext svmContext) {
        ...
        ((SwingExceptionHandler) Thread.getDefaultUncaughtExceptionHandler())
                .setSvmDesktop(svmDesktop);
    ...
    private static String loadLookAndFeel(String svmPropertyPreferredLookAndFeel) {
        ...
        String[] preferredLookAndFeels = new String[]{
                svmPropertyPreferredLookAndFeel, "Mac OS X", "GTK+", "Windows", "Nimbus"};
