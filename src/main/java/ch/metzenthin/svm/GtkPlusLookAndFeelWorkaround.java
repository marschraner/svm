...
public class GtkPlusLookAndFeelWorkaround {
   ...
   */
  /**
   * Swing menus are looking pretty bad on Linux when the GTK LaF is used (See bug #6925412). It
   * will most likely never be fixed anytime soon so this method provides a workaround for it. It
  ...
  public static void installGtkPopupBugWorkaround() {
    ...
    try {
      ...
      LOGGER.warn(
          "Um den GTK+-Look-And-Feel-Workaround zu verwenden, muss SVM mit "
  ...
  /**
   * Called internally by installGtkPopupBugWorkaround to fix the thickness of a GTK style field by
   * setting it to a minimum value of 1.
   *
