...
public class SvmProperties {
  ...
  public static final String SVM_PROPERTIES_FILE_NAME =
      getUserHomeSystemProperty() + File.separator + ".svm";
  ...
  public static final String KEY_ABSENZENLISTEN_TEMPLATE_GANZES_SEMESTER =
      "absenzenlisten_template_ganzes_semester";
  public static final String KEY_ABSENZENLISTEN_TEMPLATE_OKTOBER_FEBRUAR =
      "absenzenlisten_template_oktober_februar";
  public static final String KEY_SPEZIELLES_ABSENZENLISTEN_TEMPLATE =
      "spezielles_absenzenlisten_template";
  public static final String KEY_EMAIL_CLIENT_MULTIPLE_MAILS_SEPARATOR =
      "email_client_multiple_mails_separator";
  ...
  public static void createSvmPropertiesFileDefault() {
    ...
    try {
      ...
      String templateFilesPath =
          "<Schuljahr>" + File.separator + "Semester_<Semester>" + File.separator;
      ...
      prop.setProperty(
          KEY_TEMPLATES_DIRECTORY,
          userHomeSystemProperty + File.separator + "svm" + File.separator + "Listen-Templates");
      prop.setProperty(
          KEY_DEFAULT_OUTPUT_DIRECTORY, userHomeSystemProperty + File.separator + "Desktop");
      prop.setProperty(
          KEY_ABSENZENLISTEN_TEMPLATE_GANZES_SEMESTER,
          templateFilesPath + "Absenzenlisten-Template_<Schuljahr>_<Semester>_<Wochentag>.docx");
      prop.setProperty(
          KEY_ABSENZENLISTEN_TEMPLATE_OKTOBER_FEBRUAR,
          templateFilesPath
              + "Absenzenlisten-Template_Oktober-Februar_<Schuljahr>_<Semester>_<Wochentag>.docx");
      prop.setProperty(
          KEY_SPEZIELLES_ABSENZENLISTEN_TEMPLATE,
          templateFilesPath
              + "Spezielles_Absenzenlisten-Template_<Schuljahr>_<Semester>_<Wochentag>.docx");
