...
public class SvmListUtils {
   ...
   *
   * @param listToBeUpdated Original list, the elements of will be replaced by the elements of
   *     updatedSublist.
   * @param updatedSublist The elements of the original list will be replaced by the elements of
   *     this collection.
