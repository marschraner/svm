...
public enum Listentyp {
  ...
  ABSENZENLISTE_GANZES_SEMESTER(
      "Absenzenliste ganzes Semester",
      "Absenzenliste",
      Filetyp.DOCX,
      SvmProperties.KEY_ABSENZENLISTEN_TEMPLATE_GANZES_SEMESTER),
  ABSENZENLISTE_OKTOBER_FEBRUAR(
      "Absenzenliste Oktober - Februar",
      "Absenzenliste_Oktober-Februar",
      Filetyp.DOCX,
      SvmProperties.KEY_ABSENZENLISTEN_TEMPLATE_OKTOBER_FEBRUAR),
  SPEZIELLE_ABSENZENLISTE(
      "Spezielle Absenzenliste",
      "Absenzenliste",
      Filetyp.DOCX,
      SvmProperties.KEY_SPEZIELLES_ABSENZENLISTEN_TEMPLATE),
  ...
  RECHNUNGSEMPFAENGER_ADRESSETIKETTEN(
      "Rechnungsempfänger-Adressetiketten",
      "Rechnungsempfänger-Adressetiketten",
      Filetyp.CSV,
      null),
  MUTTER_ODER_VATER_ADRESSETIKETTEN(
      "Mutter- oder Vater-Adressetiketten",
      "Mutter-_oder_Vater-Adressetiketten",
      Filetyp.CSV,
      null),
  ELTERNMITHILFE_ADRESSETIKETTEN(
      "Eltern-Mithilfe-Adressetiketten", "Eltern-Mithilfe-Adressetiketten", Filetyp.CSV, null),
  ...
  MITARBEITER_ADRESSLISTE_MIT_GEBURTSDATUM(
      "Mitarbeiter-Adressliste mit Geburtsdatum", "Mitarbeiter-Adressliste", Filetyp.DOCX, null),
  MITARBEITER_ADRESSLISTE_OHNE_GEBURTSDATUM(
      "Mitarbeiter-Adressliste ohne Geburtsdatum", "Mitarbeiter-Adressliste", Filetyp.DOCX, null),
  MITARBEITER_ADRESSLISTE_MIT_GEBURTSDATUM_AHV_IBAN_VERTRETUNGSMOEGLICHKEITEN(
      "Mitarbeiter-Adressliste mit Geb.Datum, AHV-Nr., IBAN-Nr., Vertr.mögl.",
      "Mitarbeiter-Adressliste",
      Filetyp.DOCX,
      null),
  VERTRETUNGSLISTE("Vertretungsliste", "Vertretungsliste", Filetyp.DOCX, null),
  MITARBEITER_ADRESSETIKETTEN(
      "Mitarbeiter-Adressetiketten", "Mitarbeiter-Adressetiketten", Filetyp.CSV, null),
  ...
  NACHRECHNUNGEN_SERIENBRIEF(
      "Nachrechnungen-Serienbrief", "Nachrechnungen-Serienbrief", Filetyp.CSV, null),
  MAHNUNGEN_VORRECHNUNGEN_SERIENBRIEF(
      "Mahnungen Vorrechnungen-Serienbrief",
      "Mahnungen_Vorrechnungen-Serienbrief",
      Filetyp.CSV,
      null),
  MAHNUNGEN_NACHRECHNUNGEN_SERIENBRIEF(
      "Mahnungen Nachrechnungen-Serienbrief",
      "Mahnungen_Nachrechnungen-Serienbrief",
      Filetyp.CSV,
      null),
