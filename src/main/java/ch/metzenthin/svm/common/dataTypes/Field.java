...
public enum Field {
    ...
    WUENSCHT_EMAILS("Wünscht E-Mails"),
    ...
    FERIENBEGINN1("Ferienbeginn 1"),
    FERIENENDE1("Ferienende 1"),
    FERIENBEGINN2("Ferienbeginn 2"),
    FERIENENDE2("Ferienende 2"),
    ...
    SCHULGELD_VORRECHNUNG("Schulg. V"),
    ERMAESSIGUNG_STIPENDIUM_VORRECHNUNG("Stipend. V"),
    ...
    SCHULGELD_NACHRECHNUNG("Schulg. N"),
    ERMAESSIGUNG_STIPENDIUM_NACHRECHNUNG("Stipend. N"),
